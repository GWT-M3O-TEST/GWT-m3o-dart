...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(published_at: $published_at, broadcasting: $broadcasting, channel_title: $channel_title, description: $description, id: $id, channel_id: $channel_id, kind: $kind, title: $title, url: $url)';
  }
