...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, channel_title: $channel_title, id: $id, kind: $kind, published_at: $published_at, title: $title, url: $url, broadcasting: $broadcasting, description: $description)';
  }
...
abstract class _SearchResult implements SearchResult {
  const factory _SearchResult(
      ...
      String? url,
      String? broadcasting,
      String? description}) = _$_SearchResult;
