...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_title: $channel_title, id: $id, url: $url, broadcasting: $broadcasting, description: $description, kind: $kind, published_at: $published_at, title: $title, channel_id: $channel_id)';
  }
