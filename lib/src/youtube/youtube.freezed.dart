...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_title: $channel_title, description: $description, id: $id, kind: $kind, title: $title, url: $url, channel_id: $channel_id, published_at: $published_at, broadcasting: $broadcasting)';
  }
