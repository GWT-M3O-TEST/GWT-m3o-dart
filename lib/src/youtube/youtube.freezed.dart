...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, channel_id: $channel_id, channel_title: $channel_title, id: $id, kind: $kind, published_at: $published_at, title: $title, url: $url, broadcasting: $broadcasting)';
  }
