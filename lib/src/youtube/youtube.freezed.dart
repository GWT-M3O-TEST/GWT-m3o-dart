...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(id: $id, kind: $kind, published_at: $published_at, url: $url, broadcasting: $broadcasting, channel_id: $channel_id, channel_title: $channel_title, description: $description, title: $title)';
  }
