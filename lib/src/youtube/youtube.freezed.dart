...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(broadcasting: $broadcasting, channel_title: $channel_title, description: $description, id: $id, url: $url, channel_id: $channel_id, kind: $kind, published_at: $published_at, title: $title)';
  }
