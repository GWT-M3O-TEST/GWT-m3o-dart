...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(id: $id, title: $title, channel_id: $channel_id, channel_title: $channel_title, description: $description, url: $url, broadcasting: $broadcasting, kind: $kind, published_at: $published_at)';
  }
