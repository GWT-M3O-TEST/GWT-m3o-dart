...
abstract class EmbedResponseData implements EmbedResponse {
  const factory EmbedResponseData(
      ...
      String? long_url,
      String? short_url,
      String? embed_url}) = _$EmbedResponseData;
...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, id: $id, kind: $kind, url: $url, broadcasting: $broadcasting, channel_id: $channel_id, title: $title, channel_title: $channel_title, published_at: $published_at)';
  }
...
abstract class _SearchResult implements SearchResult {
  const factory _SearchResult(
      ...
      String? title,
      String? channel_title,
      String? published_at}) = _$_SearchResult;
