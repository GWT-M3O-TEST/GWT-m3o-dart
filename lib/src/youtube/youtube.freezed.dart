...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(published_at: $published_at, channel_id: $channel_id, channel_title: $channel_title, description: $description, kind: $kind, broadcasting: $broadcasting, id: $id, title: $title, url: $url)';
  }
