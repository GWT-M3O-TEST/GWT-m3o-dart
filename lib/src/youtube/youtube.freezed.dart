...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(kind: $kind, url: $url, channel_title: $channel_title, channel_id: $channel_id, description: $description, id: $id, published_at: $published_at, title: $title, broadcasting: $broadcasting)';
  }
