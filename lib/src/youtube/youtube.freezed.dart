...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(kind: $kind, published_at: $published_at, url: $url, description: $description, id: $id, channel_title: $channel_title, title: $title, broadcasting: $broadcasting, channel_id: $channel_id)';
  }
