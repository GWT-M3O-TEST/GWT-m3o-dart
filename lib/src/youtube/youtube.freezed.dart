...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(published_at: $published_at, channel_title: $channel_title, id: $id, description: $description, kind: $kind, title: $title, url: $url, broadcasting: $broadcasting, channel_id: $channel_id)';
  }
