...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(url: $url, channel_id: $channel_id, channel_title: $channel_title, description: $description, published_at: $published_at, title: $title, broadcasting: $broadcasting, id: $id, kind: $kind)';
  }
