...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(published_at: $published_at, url: $url, channel_id: $channel_id, channel_title: $channel_title, description: $description, title: $title, broadcasting: $broadcasting, id: $id, kind: $kind)';
  }
