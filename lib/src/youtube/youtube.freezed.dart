...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, channel_title: $channel_title, description: $description, id: $id, kind: $kind, url: $url, broadcasting: $broadcasting, published_at: $published_at, title: $title)';
  }
