...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, id: $id, published_at: $published_at, title: $title, url: $url, broadcasting: $broadcasting, channel_id: $channel_id, channel_title: $channel_title, kind: $kind)';
  }
