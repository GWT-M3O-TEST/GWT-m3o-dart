...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(published_at: $published_at, title: $title, url: $url, channel_id: $channel_id, channel_title: $channel_title, description: $description, id: $id, broadcasting: $broadcasting, kind: $kind)';
  }
