...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(kind: $kind, title: $title, url: $url, broadcasting: $broadcasting, channel_title: $channel_title, description: $description, id: $id, published_at: $published_at, channel_id: $channel_id)';
  }
...
abstract class _SearchResult implements SearchResult {
  const factory _SearchResult(
      ...
      String? id,
      String? published_at,
      String? channel_id}) = _$_SearchResult;
