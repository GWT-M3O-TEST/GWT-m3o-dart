...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_title: $channel_title, description: $description, id: $id, title: $title, broadcasting: $broadcasting, channel_id: $channel_id, kind: $kind, published_at: $published_at, url: $url)';
  }
