...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, channel_title: $channel_title, title: $title, published_at: $published_at, url: $url, broadcasting: $broadcasting, description: $description, id: $id, kind: $kind)';
  }
