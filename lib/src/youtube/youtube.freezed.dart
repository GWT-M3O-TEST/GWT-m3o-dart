...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(broadcasting: $broadcasting, title: $title, url: $url, channel_id: $channel_id, channel_title: $channel_title, description: $description, id: $id, kind: $kind, published_at: $published_at)';
  }
