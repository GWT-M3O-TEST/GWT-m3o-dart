...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(kind: $kind, published_at: $published_at, title: $title, url: $url, broadcasting: $broadcasting, channel_title: $channel_title, description: $description, id: $id, channel_id: $channel_id)';
  }
