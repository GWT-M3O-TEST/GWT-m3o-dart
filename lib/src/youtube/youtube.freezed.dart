...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(description: $description, channel_title: $channel_title, channel_id: $channel_id, id: $id, kind: $kind, published_at: $published_at, title: $title, url: $url, broadcasting: $broadcasting)';
  }
