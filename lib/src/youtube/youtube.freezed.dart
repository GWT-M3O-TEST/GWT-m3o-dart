...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(kind: $kind, published_at: $published_at, broadcasting: $broadcasting, description: $description, id: $id, title: $title, url: $url, channel_id: $channel_id, channel_title: $channel_title)';
  }
...
abstract class _SearchResult implements SearchResult {
  const factory _SearchResult(
      ...
      String? url,
      String? channel_id,
      String? channel_title}) = _$_SearchResult;
