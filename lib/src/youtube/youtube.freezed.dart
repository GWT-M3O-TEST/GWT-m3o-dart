...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(channel_id: $channel_id, url: $url, title: $title, broadcasting: $broadcasting, channel_title: $channel_title, description: $description, id: $id, kind: $kind, published_at: $published_at)';
  }
