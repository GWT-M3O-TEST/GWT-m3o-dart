...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, lat_lng: $lat_lng, location: $location, postcode: $postcode, town: $town, title: $title, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, country_id: $country_id, state_or_province: $state_or_province)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type_id: $connection_type_id, current: $current, level_id: $level_id, reference: $reference, amps: $amps, level: $level, power: $power, voltage: $voltage, connection_type: $connection_type)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, id: $id, title: $title, website: $website, contact_email: $contact_email, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, connections: $connections, operator_id: $operator_id, num_points: $num_points, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id, cost: $cost, data_provider_id: $data_provider_id, id: $id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, status_types: $status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, current_types: $current_types, data_providers: $data_providers, operators: $operators)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(location: $location, max_results: $max_results, min_power: $min_power, operators: $operators, usage_types: $usage_types, country_id: $country_id, connection_types: $connection_types, distance: $distance, levels: $levels, box: $box)';
  }
