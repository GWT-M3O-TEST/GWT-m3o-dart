...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_2: $address_line_2, country: $country, location: $location, postcode: $postcode, title: $title, access_comments: $access_comments, address_line_1: $address_line_1, country_id: $country_id, lat_lng: $lat_lng, state_or_province: $state_or_province, town: $town)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(contact_email: $contact_email, phone_primary: $phone_primary, phone_secondary: $phone_secondary, is_private_individual: $is_private_individual, title: $title, website: $website, comments: $comments, fault_report_email: $fault_report_email, id: $id)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(data_provider_id: $data_provider_id, num_points: $num_points, operator: $operator, operator_id: $operator_id, usage_type_id: $usage_type_id, address: $address, cost: $cost, usage_type: $usage_type, connections: $connections, id: $id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(checkin_status_types: $checkin_status_types, current_types: $current_types, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, connection_types: $connection_types, countries: $countries, data_providers: $data_providers, operators: $operators, status_types: $status_types, usage_types: $usage_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(location: $location, max_results: $max_results, min_power: $min_power, operators: $operators, box: $box, distance: $distance, levels: $levels, usage_types: $usage_types, connection_types: $connection_types, country_id: $country_id)';
  }
