...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(state_or_province: $state_or_province, title: $title, town: $town, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, country_id: $country_id, location: $location, access_comments: $access_comments, lat_lng: $lat_lng, postcode: $postcode)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(voltage: $voltage, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, power: $power, reference: $reference, amps: $amps, level: $level, level_id: $level_id)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, contact_email: $contact_email, id: $id, phone_secondary: $phone_secondary, title: $title, website: $website, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type: $usage_type, address: $address, operator: $operator, operator_id: $operator_id, id: $id, num_points: $num_points, usage_type_id: $usage_type_id, connections: $connections, cost: $cost, data_provider_id: $data_provider_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, countries: $countries, data_providers: $data_providers, operators: $operators, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, usage_types: $usage_types, current_types: $current_types, status_types: $status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(min_power: $min_power, usage_types: $usage_types, box: $box, distance: $distance, levels: $levels, max_results: $max_results, operators: $operators, connection_types: $connection_types, country_id: $country_id, location: $location)';
  }
