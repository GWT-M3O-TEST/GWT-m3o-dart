...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(state_or_province: $state_or_province, title: $title, address_line_1: $address_line_1, address_line_2: $address_line_2, location: $location, lat_lng: $lat_lng, postcode: $postcode, town: $town, access_comments: $access_comments, country: $country, country_id: $country_id)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, level: $level, power: $power, reference: $reference, amps: $amps, connection_type_id: $connection_type_id, level_id: $level_id, voltage: $voltage, connection_type: $connection_type)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary, title: $title, contact_email: $contact_email, fault_report_email: $fault_report_email, website: $website, comments: $comments, id: $id)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(id: $id, num_points: $num_points, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, cost: $cost, data_provider_id: $data_provider_id, operator_id: $operator_id, connections: $connections)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(submission_status_types: $submission_status_types, user_comment_types: $user_comment_types, connection_types: $connection_types, countries: $countries, data_providers: $data_providers, status_types: $status_types, usage_types: $usage_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, current_types: $current_types, operators: $operators)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(usage_types: $usage_types, country_id: $country_id, distance: $distance, operators: $operators, location: $location, max_results: $max_results, min_power: $min_power, box: $box, connection_types: $connection_types, levels: $levels)';
  }
