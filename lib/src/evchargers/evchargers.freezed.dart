...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(state_or_province: $state_or_province, access_comments: $access_comments, address_line_1: $address_line_1, country: $country, lat_lng: $lat_lng, postcode: $postcode, address_line_2: $address_line_2, country_id: $country_id, location: $location, title: $title, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level: $level, power: $power, voltage: $voltage, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, level_id: $level_id, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(contact_email: $contact_email, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, title: $title, website: $website, comments: $comments, fault_report_email: $fault_report_email, id: $id, phone_primary: $phone_primary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, operator_id: $operator_id, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, connections: $connections, data_provider_id: $data_provider_id, id: $id, num_points: $num_points, operator: $operator)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(checkin_status_types: $checkin_status_types, countries: $countries, data_providers: $data_providers, status_types: $status_types, usage_types: $usage_types, charger_types: $charger_types, connection_types: $connection_types, current_types: $current_types, operators: $operators, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(levels: $levels, location: $location, max_results: $max_results, min_power: $min_power, usage_types: $usage_types, connection_types: $connection_types, country_id: $country_id, distance: $distance, operators: $operators, box: $box)';
  }
