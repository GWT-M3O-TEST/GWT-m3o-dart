...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_2: $address_line_2, country_id: $country_id, location: $location, title: $title, town: $town, state_or_province: $state_or_province, access_comments: $access_comments, address_line_1: $address_line_1, country: $country, lat_lng: $lat_lng, postcode: $postcode)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, connection_type_id: $connection_type_id, level: $level, level_id: $level_id, power: $power, voltage: $voltage, amps: $amps, current: $current, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, title: $title, contact_email: $contact_email, id: $id, phone_primary: $phone_primary, website: $website, comments: $comments, fault_report_email: $fault_report_email)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(id: $id, num_points: $num_points, operator: $operator, operator_id: $operator_id, address: $address, cost: $cost, data_provider_id: $data_provider_id, connections: $connections, usage_type: $usage_type, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, current_types: $current_types, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, countries: $countries, data_providers: $data_providers, operators: $operators, status_types: $status_types, usage_types: $usage_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(levels: $levels, min_power: $min_power, operators: $operators, usage_types: $usage_types, box: $box, country_id: $country_id, location: $location, max_results: $max_results, connection_types: $connection_types, distance: $distance)';
  }
