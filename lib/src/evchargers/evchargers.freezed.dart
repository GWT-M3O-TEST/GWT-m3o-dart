...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_1: $address_line_1, address_line_2: $address_line_2, location: $location, title: $title, access_comments: $access_comments, country: $country, country_id: $country_id, lat_lng: $lat_lng, postcode: $postcode, state_or_province: $state_or_province, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level_id: $level_id, power: $power, voltage: $voltage, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, level: $level, reference: $reference, amps: $amps)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary, id: $id, title: $title, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(connections: $connections, cost: $cost, id: $id, num_points: $num_points, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, data_provider_id: $data_provider_id, operator_id: $operator_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(status_types: $status_types, usage_types: $usage_types, charger_types: $charger_types, operators: $operators, countries: $countries, current_types: $current_types, data_providers: $data_providers, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types)';
  }
...
abstract class ReferenceDataResponseData implements ReferenceDataResponse {
  const factory ReferenceDataResponseData(
      ...
      UserCommentType? user_comment_types,
      CheckinStatusType? checkin_status_types,
      ConnectionType? connection_types}) = _$ReferenceDataResponseData;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(max_results: $max_results, operators: $operators, usage_types: $usage_types, distance: $distance, location: $location, country_id: $country_id, levels: $levels, min_power: $min_power, box: $box, connection_types: $connection_types)';
  }
