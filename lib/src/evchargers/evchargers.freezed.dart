...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, address_line_2: $address_line_2, country: $country, state_or_province: $state_or_province, town: $town, address_line_1: $address_line_1, country_id: $country_id, lat_lng: $lat_lng, location: $location, postcode: $postcode, title: $title)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level: $level, reference: $reference, voltage: $voltage, current: $current, connection_type: $connection_type, connection_type_id: $connection_type_id, level_id: $level_id, power: $power, amps: $amps)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(website: $website, comments: $comments, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary, title: $title, contact_email: $contact_email, id: $id, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type: $usage_type, usage_type_id: $usage_type_id, connections: $connections, cost: $cost, data_provider_id: $data_provider_id, id: $id, operator: $operator, address: $address, num_points: $num_points, operator_id: $operator_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, countries: $countries, status_types: $status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, current_types: $current_types, data_providers: $data_providers, operators: $operators, submission_status_types: $submission_status_types, checkin_status_types: $checkin_status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, distance: $distance, levels: $levels, location: $location, min_power: $min_power, box: $box, connection_types: $connection_types, usage_types: $usage_types, max_results: $max_results, operators: $operators)';
  }
