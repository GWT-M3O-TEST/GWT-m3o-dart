...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(lat_lng: $lat_lng, location: $location, postcode: $postcode, state_or_province: $state_or_province, access_comments: $access_comments, address_line_2: $address_line_2, country: $country, country_id: $country_id, title: $title, town: $town, address_line_1: $address_line_1)';
  }
...
abstract class _Address implements Address {
  const factory _Address(
      ...
      String? title,
      String? town,
      String? address_line_1}) = _$_Address;
...
class _$BoundingBoxTearOff {
  ...
  _BoundingBox call({Coordinates? top_right, Coordinates? bottom_left}) {
    return _BoundingBox(
      top_right: top_right,
...
abstract class _BoundingBox implements BoundingBox {
  const factory _BoundingBox(
      {Coordinates? top_right, Coordinates? bottom_left}) = _$_BoundingBox;
...
class _$CheckinStatusTypeTearOff {
  ...
  _CheckinStatusType call(
      {bool? is_positive, String? title, String? id, bool? is_automated}) {
...
abstract class _CheckinStatusType implements CheckinStatusType {
  const factory _CheckinStatusType(
      ...
      String? title,
      String? id,
      bool? is_automated}) = _$_CheckinStatusType;
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(voltage: $voltage, connection_type_id: $connection_type_id, level: $level, level_id: $level_id, power: $power, amps: $amps, connection_type: $connection_type, current: $current, reference: $reference)';
  }
...
class _$CoordinatesTearOff {
  ...
  _Coordinates call({double? longitude, double? latitude}) {
    return _Coordinates(
      longitude: longitude,
      latitude: latitude,
    );
...
class _$_Coordinates implements _Coordinates {
  const _$_Coordinates({this.longitude, this.latitude});
...
abstract class _Coordinates implements Coordinates {
  const factory _Coordinates({double? longitude, double? latitude}) =
      _$_Coordinates;
...
class _$_DataProvider implements _DataProvider {
  ...
  @override
  String toString() {
    return 'DataProvider(id: $id, license: $license, title: $title, website: $website, comments: $comments, data_provider_status_type: $data_provider_status_type)';
  }
...
abstract class _DataProvider implements DataProvider {
  const factory _DataProvider(
      ...
      String? website,
      String? comments,
      DataProviderStatusType? data_provider_status_type}) = _$_DataProvider;
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(website: $website, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, id: $id, phone_primary: $phone_primary, phone_secondary: $phone_secondary, title: $title, comments: $comments, contact_email: $contact_email)';
  }
...
abstract class _Operator implements Operator {
  const factory _Operator(
      ...
      String? title,
      String? comments,
      String? contact_email}) = _$_Operator;
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, data_provider_id: $data_provider_id, id: $id, operator: $operator, usage_type: $usage_type, address: $address, connections: $connections, usage_type_id: $usage_type_id, num_points: $num_points, operator_id: $operator_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(data_providers: $data_providers, operators: $operators, usage_types: $usage_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, current_types: $current_types, status_types: $status_types, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types)';
  }
...
abstract class ReferenceDataResponseData implements ReferenceDataResponse {
  const factory ReferenceDataResponseData(
      ...
      StatusType? status_types,
      SubmissionStatusType? submission_status_types,
      UserCommentType? user_comment_types}) = _$ReferenceDataResponseData;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(min_power: $min_power, box: $box, connection_types: $connection_types, distance: $distance, levels: $levels, location: $location, country_id: $country_id, max_results: $max_results, operators: $operators, usage_types: $usage_types)';
  }
...
class _$_UsageType implements _UsageType {
  ...
  @override
  String toString() {
    return 'UsageType(is_membership_required: $is_membership_required, is_pay_at_location: $is_pay_at_location, title: $title, id: $id, is_access_key_required: $is_access_key_required)';
  }
...
abstract class _UsageType implements UsageType {
  const factory _UsageType(
      ...
      String? title,
      String? id,
      bool? is_access_key_required}) = _$_UsageType;
