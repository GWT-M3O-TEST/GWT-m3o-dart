...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country_id: $country_id, location: $location, postcode: $postcode, title: $title, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, town: $town, lat_lng: $lat_lng, state_or_province: $state_or_province)';
  }
...
abstract class _Address implements Address {
  const factory _Address(
      ...
      String? town,
      String? lat_lng,
      String? state_or_province}) = _$_Address;
...
class _$CheckinStatusTypeTearOff {
  ...
  _CheckinStatusType call(
      {String? title, String? id, bool? is_automated, bool? is_positive}) {
...
abstract class $CheckinStatusTypeCopyWith<$Res> {
  ...
  $Res call({String? title, String? id, bool? is_automated, bool? is_positive});
}
...
class _$_CheckinStatusType implements _CheckinStatusType {
  const _$_CheckinStatusType(
      {this.title, this.id, this.is_automated, this.is_positive});
  ...
  @override
  String toString() {
    return 'CheckinStatusType(title: $title, id: $id, is_automated: $is_automated, is_positive: $is_positive)';
  }
...
abstract class _CheckinStatusType implements CheckinStatusType {
  const factory _CheckinStatusType(
      ...
      String? id,
      bool? is_automated,
      bool? is_positive}) = _$_CheckinStatusType;
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level_id: $level_id, power: $power, reference: $reference, voltage: $voltage, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, level: $level, amps: $amps)';
  }
...
abstract class _ConnectionType implements ConnectionType {
  const factory _ConnectionType(
      ...
      bool? is_obsolete,
      String? title,
      String? formal_name}) = _$_ConnectionType;
...
class _$CountryTearOff {
  ...
  _Country call(
      {String? iso_code, String? title, String? continent_code, String? id}) {
    return _Country(
      iso_code: iso_code,
      title: title,
...
class _$_Country implements _Country {
  const _$_Country({this.iso_code, this.title, this.continent_code, this.id});
  ...
  @override
  String toString() {
    return 'Country(iso_code: $iso_code, title: $title, continent_code: $continent_code, id: $id)';
  }
...
class _$DataProviderStatusTypeTearOff {
  ...
  _DataProviderStatusType call(
      {String? title, String? id, bool? is_provider_enabled}) {
...
abstract class $DataProviderStatusTypeCopyWith<$Res> {
  ...
  $Res call({String? title, String? id, bool? is_provider_enabled});
}
...
class _$_DataProviderStatusType implements _DataProviderStatusType {
  const _$_DataProviderStatusType(
      {this.title, this.id, this.is_provider_enabled});
  ...
  @override
  String toString() {
    return 'DataProviderStatusType(title: $title, id: $id, is_provider_enabled: $is_provider_enabled)';
  }
...
abstract class _DataProviderStatusType implements DataProviderStatusType {
  const factory _DataProviderStatusType(
      {String? title,
      String? id,
      bool? is_provider_enabled}) = _$_DataProviderStatusType;
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, contact_email: $contact_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary, website: $website, fault_report_email: $fault_report_email, id: $id, phone_secondary: $phone_secondary, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(id: $id, operator: $operator, usage_type: $usage_type, data_provider_id: $data_provider_id, connections: $connections, cost: $cost, num_points: $num_points, operator_id: $operator_id, usage_type_id: $usage_type_id, address: $address)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(status_types: $status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, current_types: $current_types, data_providers: $data_providers, charger_types: $charger_types, countries: $countries, operators: $operators)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, country_id: $country_id, distance: $distance, min_power: $min_power, connection_types: $connection_types, levels: $levels, location: $location, max_results: $max_results, operators: $operators, usage_types: $usage_types)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          int? max_results,
      List<String>? operators,
      String? usage_types}) = _$_SearchRequest;
...
class _$StatusTypeTearOff {
  ...
  _StatusType call({String? title, String? id, bool? is_operational}) {
    return _StatusType(
      title: title,
      id: id,
...
abstract class _StatusType implements StatusType {
  const factory _StatusType({String? title, String? id, bool? is_operational}) =
      _$_StatusType;
...
abstract class _UsageType implements UsageType {
  const factory _UsageType(
      ...
      String? id,
      bool? is_access_key_required,
      bool? is_membership_required}) = _$_UsageType;
