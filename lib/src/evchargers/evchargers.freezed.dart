...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country_id: $country_id, lat_lng: $lat_lng, location: $location, state_or_province: $state_or_province, town: $town, access_comments: $access_comments, country: $country, postcode: $postcode, title: $title, address_line_1: $address_line_1, address_line_2: $address_line_2)';
  }
...
abstract class _Address implements Address {
  const factory _Address(
      ...
      String? title,
      String? address_line_1,
      String? address_line_2}) = _$_Address;
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type_id: $connection_type_id, connection_type: $connection_type, current: $current, level: $level, level_id: $level_id, power: $power, reference: $reference, voltage: $voltage, amps: $amps)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, website: $website, phone_primary: $phone_primary, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(connections: $connections, data_provider_id: $data_provider_id, num_points: $num_points, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, cost: $cost, id: $id, operator: $operator, operator_id: $operator_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, countries: $countries, current_types: $current_types, operators: $operators, charger_types: $charger_types, checkin_status_types: $checkin_status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, data_providers: $data_providers, status_types: $status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(min_power: $min_power, operators: $operators, box: $box, connection_types: $connection_types, country_id: $country_id, max_results: $max_results, distance: $distance, levels: $levels, location: $location, usage_types: $usage_types)';
  }
