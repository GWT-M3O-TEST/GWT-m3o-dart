...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(postcode: $postcode, access_comments: $access_comments, address_line_1: $address_line_1, country_id: $country_id, lat_lng: $lat_lng, location: $location, address_line_2: $address_line_2, country: $country, state_or_province: $state_or_province, title: $title, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(reference: $reference, voltage: $voltage, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, level: $level, power: $power, amps: $amps, level_id: $level_id)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, contact_email: $contact_email, id: $id, phone_primary: $phone_primary, phone_secondary: $phone_secondary, title: $title, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, operator: $operator, operator_id: $operator_id, usage_type_id: $usage_type_id, usage_type: $usage_type, address: $address, connections: $connections, data_provider_id: $data_provider_id, id: $id, num_points: $num_points)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, current_types: $current_types, operators: $operators, status_types: $status_types, data_providers: $data_providers, submission_status_types: $submission_status_types, usage_types: $usage_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, distance: $distance, levels: $levels, max_results: $max_results, min_power: $min_power, connection_types: $connection_types, location: $location, operators: $operators, usage_types: $usage_types, box: $box)';
  }
