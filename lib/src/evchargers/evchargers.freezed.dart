...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(location: $location, postcode: $postcode, address_line_1: $address_line_1, lat_lng: $lat_lng, country: $country, country_id: $country_id, state_or_province: $state_or_province, title: $title, town: $town, access_comments: $access_comments, address_line_2: $address_line_2)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, power: $power, voltage: $voltage, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, level: $level, level_id: $level_id, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, id: $id, phone_secondary: $phone_secondary, title: $title, comments: $comments, contact_email: $contact_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(connections: $connections, cost: $cost, data_provider_id: $data_provider_id, id: $id, num_points: $num_points, operator: $operator, usage_type_id: $usage_type_id, address: $address, operator_id: $operator_id, usage_type: $usage_type)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, checkin_status_types: $checkin_status_types, countries: $countries, current_types: $current_types, data_providers: $data_providers, connection_types: $connection_types, operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(levels: $levels, location: $location, max_results: $max_results, min_power: $min_power, operators: $operators, usage_types: $usage_types, box: $box, country_id: $country_id, connection_types: $connection_types, distance: $distance)';
  }
