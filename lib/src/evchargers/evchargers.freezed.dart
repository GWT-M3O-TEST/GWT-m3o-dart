...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(town: $town, country: $country, lat_lng: $lat_lng, location: $location, postcode: $postcode, title: $title, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, country_id: $country_id, state_or_province: $state_or_province)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, level_id: $level_id, reference: $reference, voltage: $voltage, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, level: $level, power: $power)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, title: $title, website: $website, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, connections: $connections, cost: $cost, id: $id, usage_type_id: $usage_type_id, data_provider_id: $data_provider_id, num_points: $num_points, operator: $operator, operator_id: $operator_id, usage_type: $usage_type)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(current_types: $current_types, status_types: $status_types, submission_status_types: $submission_status_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, countries: $countries, usage_types: $usage_types, user_comment_types: $user_comment_types, connection_types: $connection_types, data_providers: $data_providers, operators: $operators)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(min_power: $min_power, operators: $operators, usage_types: $usage_types, country_id: $country_id, levels: $levels, distance: $distance, location: $location, max_results: $max_results, box: $box, connection_types: $connection_types)';
  }
