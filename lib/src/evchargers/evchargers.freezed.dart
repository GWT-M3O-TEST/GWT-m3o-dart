...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(state_or_province: $state_or_province, title: $title, address_line_2: $address_line_2, country: $country, country_id: $country_id, lat_lng: $lat_lng, postcode: $postcode, access_comments: $access_comments, address_line_1: $address_line_1, location: $location, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, connection_type_id: $connection_type_id, level: $level, level_id: $level_id, power: $power, reference: $reference, amps: $amps, voltage: $voltage, current: $current)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(phone_primary: $phone_primary, website: $website, comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type_id: $usage_type_id, address: $address, cost: $cost, data_provider_id: $data_provider_id, id: $id, usage_type: $usage_type, connections: $connections, num_points: $num_points, operator: $operator, operator_id: $operator_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(current_types: $current_types, data_providers: $data_providers, status_types: $status_types, user_comment_types: $user_comment_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, operators: $operators, submission_status_types: $submission_status_types, usage_types: $usage_types, charger_types: $charger_types)';
  }
...
abstract class ReferenceDataResponseData implements ReferenceDataResponse {
  const factory ReferenceDataResponseData(
      ...
      SubmissionStatusType? submission_status_types,
      UsageType? usage_types,
      ChargerType? charger_types}) = _$ReferenceDataResponseData;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(distance: $distance, levels: $levels, location: $location, min_power: $min_power, operators: $operators, box: $box, connection_types: $connection_types, country_id: $country_id, usage_types: $usage_types, max_results: $max_results)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      String? usage_types,
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          int? max_results}) = _$_SearchRequest;
...
class _$StatusTypeTearOff {
  ...
  _StatusType call({bool? is_operational, String? title, String? id}) {
    return _StatusType(
...
abstract class _StatusType implements StatusType {
  const factory _StatusType({bool? is_operational, String? title, String? id}) =
      _$_StatusType;
