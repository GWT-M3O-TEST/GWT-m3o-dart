...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(town: $town, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, country_id: $country_id, postcode: $postcode, state_or_province: $state_or_province, title: $title, access_comments: $access_comments, lat_lng: $lat_lng, location: $location)';
  }
...
abstract class _Address implements Address {
  const factory _Address(
      ...
      String? access_comments,
      String? lat_lng,
      Coordinates? location}) = _$_Address;
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, current: $current, level: $level, reference: $reference, connection_type: $connection_type, connection_type_id: $connection_type_id, level_id: $level_id, power: $power, voltage: $voltage)';
  }
...
class _$_DataProvider implements _DataProvider {
  ...
  @override
  String toString() {
    return 'DataProvider(license: $license, title: $title, website: $website, comments: $comments, data_provider_status_type: $data_provider_status_type, id: $id)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, contact_email: $contact_email, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, title: $title, fault_report_email: $fault_report_email, id: $id, phone_primary: $phone_primary, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(operator_id: $operator_id, address: $address, connections: $connections, cost: $cost, data_provider_id: $data_provider_id, id: $id, num_points: $num_points, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, submission_status_types: $submission_status_types, usage_types: $usage_types, countries: $countries, current_types: $current_types, data_providers: $data_providers, operators: $operators, status_types: $status_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, distance: $distance, levels: $levels, box: $box, location: $location, max_results: $max_results, min_power: $min_power, operators: $operators, usage_types: $usage_types, connection_types: $connection_types)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      List<String>? operators,
      List<String>? usage_types,
      List<String>? connection_types}) = _$_SearchRequest;
