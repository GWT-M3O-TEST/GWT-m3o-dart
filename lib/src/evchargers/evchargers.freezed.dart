...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_2: $address_line_2, country: $country, postcode: $postcode, lat_lng: $lat_lng, location: $location, state_or_province: $state_or_province, title: $title, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, country_id: $country_id)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, connection_type_id: $connection_type_id, level: $level, reference: $reference, voltage: $voltage, amps: $amps, current: $current, level_id: $level_id, power: $power)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, is_private_individual: $is_private_individual, title: $title, website: $website, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, phone_primary: $phone_primary, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, connections: $connections, num_points: $num_points, operator: $operator, operator_id: $operator_id, usage_type: $usage_type, usage_type_id: $usage_type_id, cost: $cost, data_provider_id: $data_provider_id, id: $id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(data_providers: $data_providers, submission_status_types: $submission_status_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, current_types: $current_types, operators: $operators, status_types: $status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, connection_types: $connection_types, countries: $countries)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, operators: $operators, min_power: $min_power, usage_types: $usage_types, connection_types: $connection_types, country_id: $country_id, distance: $distance, levels: $levels, location: $location, max_results: $max_results)';
  }
