...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(postcode: $postcode, state_or_province: $state_or_province, title: $title, access_comments: $access_comments, country_id: $country_id, lat_lng: $lat_lng, location: $location, town: $town, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, connection_type_id: $connection_type_id, level: $level, level_id: $level_id, reference: $reference, voltage: $voltage, amps: $amps, current: $current, power: $power)';
  }
...
class _$CurrentTypeTearOff {
  ...
  _CurrentType call({String? title, String? description, String? id}) {
    return _CurrentType(
      title: title,
...
abstract class _CurrentType implements CurrentType {
  const factory _CurrentType({String? title, String? description, String? id}) =
      _$_CurrentType;
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, id: $id, phone_secondary: $phone_secondary, phone_primary: $phone_primary, title: $title, website: $website, contact_email: $contact_email, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, cost: $cost, data_provider_id: $data_provider_id, id: $id, operator_id: $operator_id, usage_type: $usage_type, connections: $connections, num_points: $num_points, operator: $operator, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, countries: $countries, status_types: $status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, current_types: $current_types, data_providers: $data_providers, operators: $operators, submission_status_types: $submission_status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, connection_types: $connection_types, location: $location, min_power: $min_power, operators: $operators, usage_types: $usage_types, country_id: $country_id, distance: $distance, levels: $levels, max_results: $max_results)';
  }
