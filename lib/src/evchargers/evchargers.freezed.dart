...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, address_line_2: $address_line_2, country: $country, lat_lng: $lat_lng, location: $location, postcode: $postcode, address_line_1: $address_line_1, country_id: $country_id, state_or_province: $state_or_province, title: $title, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, current: $current, reference: $reference, voltage: $voltage, connection_type: $connection_type, connection_type_id: $connection_type_id, level: $level, level_id: $level_id, power: $power)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary, title: $title, website: $website, comments: $comments, contact_email: $contact_email, id: $id, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(id: $id, operator_id: $operator_id, usage_type_id: $usage_type_id, usage_type: $usage_type, address: $address, connections: $connections, cost: $cost, data_provider_id: $data_provider_id, num_points: $num_points, operator: $operator)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(checkin_status_types: $checkin_status_types, countries: $countries, operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types, charger_types: $charger_types, connection_types: $connection_types, current_types: $current_types, data_providers: $data_providers, usage_types: $usage_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, country_id: $country_id, distance: $distance, levels: $levels, location: $location, min_power: $min_power, operators: $operators, usage_types: $usage_types, connection_types: $connection_types, max_results: $max_results)';
  }
...
class _$SubmissionStatusTypeTearOff {
  ...
  _SubmissionStatusType call({bool? is_live, String? title, String? id}) {
...
abstract class _SubmissionStatusType implements SubmissionStatusType {
  const factory _SubmissionStatusType(
      {bool? is_live, String? title, String? id}) = _$_SubmissionStatusType;
