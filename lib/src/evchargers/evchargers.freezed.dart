...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(location: $location, state_or_province: $state_or_province, title: $title, access_comments: $access_comments, address_line_2: $address_line_2, country_id: $country_id, lat_lng: $lat_lng, address_line_1: $address_line_1, country: $country, postcode: $postcode, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, level: $level, level_id: $level_id, power: $power, reference: $reference, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, phone_secondary: $phone_secondary, website: $website, comments: $comments, contact_email: $contact_email, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, data_provider_id: $data_provider_id, id: $id, num_points: $num_points, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, connections: $connections, operator_id: $operator_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(current_types: $current_types, operators: $operators, user_comment_types: $user_comment_types, charger_types: $charger_types, countries: $countries, data_providers: $data_providers, status_types: $status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, distance: $distance, location: $location, max_results: $max_results, min_power: $min_power, usage_types: $usage_types, box: $box, connection_types: $connection_types, levels: $levels, operators: $operators)';
  }
