...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, address_line_2: $address_line_2, location: $location, postcode: $postcode, title: $title, address_line_1: $address_line_1, country: $country, country_id: $country_id, lat_lng: $lat_lng, state_or_province: $state_or_province, town: $town)';
  }
...
class _$CheckinStatusTypeTearOff {
  ...
  _CheckinStatusType call(
      {bool? is_automated, bool? is_positive, String? title, String? id}) {
...
abstract class _CheckinStatusType implements CheckinStatusType {
  const factory _CheckinStatusType(
      ...
      bool? is_positive,
      String? title,
      String? id}) = _$_CheckinStatusType;
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, reference: $reference, amps: $amps, level: $level, level_id: $level_id, power: $power, voltage: $voltage)';
  }
...
class _$CurrentTypeTearOff {
  ...
  _CurrentType call({String? id, String? title, String? description}) {
    return _CurrentType(
      id: id,
      title: title,
...
class _$_CurrentType implements _CurrentType {
  const _$_CurrentType({this.id, this.title, this.description});
  ...
  @override
  String toString() {
    return 'CurrentType(id: $id, title: $title, description: $description)';
  }
...
abstract class _CurrentType implements CurrentType {
  const factory _CurrentType({String? id, String? title, String? description}) =
      _$_CurrentType;
...
class _$DataProviderStatusTypeTearOff {
  ...
  _DataProviderStatusType call(
      {bool? is_provider_enabled, String? title, String? id}) {
...
abstract class $DataProviderStatusTypeCopyWith<$Res> {
  ...
  $Res call({bool? is_provider_enabled, String? title, String? id});
}
...
class _$_DataProviderStatusType implements _DataProviderStatusType {
  const _$_DataProviderStatusType(
      {this.is_provider_enabled, this.title, this.id});
  ...
  @override
  String toString() {
    return 'DataProviderStatusType(is_provider_enabled: $is_provider_enabled, title: $title, id: $id)';
  }
...
abstract class _DataProviderStatusType implements DataProviderStatusType {
  const factory _DataProviderStatusType(
      ...
      String? title,
      String? id}) = _$_DataProviderStatusType;
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(phone_primary: $phone_primary, title: $title, website: $website, comments: $comments, is_private_individual: $is_private_individual, id: $id, phone_secondary: $phone_secondary, contact_email: $contact_email, fault_report_email: $fault_report_email)';
  }
...
abstract class _Operator implements Operator {
  const factory _Operator(
      ...
      String? phone_secondary,
      String? contact_email,
      String? fault_report_email}) = _$_Operator;
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, data_provider_id: $data_provider_id, num_points: $num_points, operator: $operator, connections: $connections, cost: $cost, id: $id, operator_id: $operator_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(submission_status_types: $submission_status_types, user_comment_types: $user_comment_types, checkin_status_types: $checkin_status_types, countries: $countries, current_types: $current_types, operators: $operators, status_types: $status_types, charger_types: $charger_types, connection_types: $connection_types, data_providers: $data_providers, usage_types: $usage_types)';
  }
...
abstract class ReferenceDataResponseData implements ReferenceDataResponse {
  const factory ReferenceDataResponseData(
      ...
      List<ConnectionType>? connection_types,
      List<DataProvider>? data_providers,
      List<UsageType>? usage_types}) = _$ReferenceDataResponseData;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(location: $location, max_results: $max_results, operators: $operators, usage_types: $usage_types, connection_types: $connection_types, country_id: $country_id, levels: $levels, min_power: $min_power, box: $box, distance: $distance)';
  }
...
class _$_UsageType implements _UsageType {
  ...
  @override
  String toString() {
    return 'UsageType(title: $title, id: $id, is_access_key_required: $is_access_key_required, is_membership_required: $is_membership_required, is_pay_at_location: $is_pay_at_location)';
  }
...
abstract class _UsageType implements UsageType {
  const factory _UsageType(
      ...
      bool? is_access_key_required,
      bool? is_membership_required,
      bool? is_pay_at_location}) = _$_UsageType;
