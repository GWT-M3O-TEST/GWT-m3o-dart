...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(state_or_province: $state_or_province, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, country_id: $country_id, lat_lng: $lat_lng, postcode: $postcode, address_line_2: $address_line_2, country: $country, location: $location, title: $title)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, connection_type_id: $connection_type_id, level_id: $level_id, power: $power, reference: $reference, connection_type: $connection_type, current: $current, level: $level, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, phone_primary: $phone_primary, title: $title, comments: $comments, contact_email: $contact_email, phone_secondary: $phone_secondary, website: $website, id: $id, is_private_individual: $is_private_individual)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(connections: $connections, cost: $cost, id: $id, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, data_provider_id: $data_provider_id, num_points: $num_points, operator_id: $operator_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(data_providers: $data_providers, submission_status_types: $submission_status_types, usage_types: $usage_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, current_types: $current_types, status_types: $status_types, user_comment_types: $user_comment_types, connection_types: $connection_types, countries: $countries, operators: $operators)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(distance: $distance, location: $location, min_power: $min_power, connection_types: $connection_types, country_id: $country_id, max_results: $max_results, operators: $operators, usage_types: $usage_types, box: $box, levels: $levels)';
  }
