...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(lat_lng: $lat_lng, location: $location, state_or_province: $state_or_province, title: $title, address_line_2: $address_line_2, country: $country, country_id: $country_id, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, postcode: $postcode)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level_id: $level_id, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, reference: $reference, voltage: $voltage, amps: $amps, level: $level, power: $power)';
  }
...
class _$_DataProvider implements _DataProvider {
  ...
  @override
  String toString() {
    return 'DataProvider(title: $title, website: $website, comments: $comments, data_provider_status_type: $data_provider_status_type, id: $id, license: $license)';
  }
...
abstract class _DataProvider implements DataProvider {
  const factory _DataProvider(
      ...
      DataProviderStatusType? data_provider_status_type,
      String? id,
      String? license}) = _$_DataProvider;
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, phone_primary: $phone_primary, phone_secondary: $phone_secondary, title: $title, comments: $comments, contact_email: $contact_email, id: $id, is_private_individual: $is_private_individual, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, data_provider_id: $data_provider_id, id: $id, operator: $operator, operator_id: $operator_id, connections: $connections, cost: $cost, num_points: $num_points, usage_type: $usage_type, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, connection_types: $connection_types, current_types: $current_types, operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, checkin_status_types: $checkin_status_types, countries: $countries, data_providers: $data_providers, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, min_power: $min_power, operators: $operators, box: $box, distance: $distance, levels: $levels, location: $location, max_results: $max_results, usage_types: $usage_types, connection_types: $connection_types)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          int? max_results,
      String? usage_types,
      String? connection_types}) = _$_SearchRequest;
