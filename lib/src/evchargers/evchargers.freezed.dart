...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_1: $address_line_1, country: $country, country_id: $country_id, location: $location, title: $title, access_comments: $access_comments, address_line_2: $address_line_2, lat_lng: $lat_lng, postcode: $postcode, state_or_province: $state_or_province, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, connection_type_id: $connection_type_id, reference: $reference, amps: $amps, current: $current, level: $level, level_id: $level_id, power: $power, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(title: $title, website: $website, comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, phone_primary: $phone_primary, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, cost: $cost, num_points: $num_points, operator: $operator, usage_type_id: $usage_type_id, connections: $connections, data_provider_id: $data_provider_id, id: $id, operator_id: $operator_id, usage_type: $usage_type)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, current_types: $current_types, operators: $operators, countries: $countries, data_providers: $data_providers, status_types: $status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(operators: $operators, location: $location, connection_types: $connection_types, country_id: $country_id, distance: $distance, levels: $levels, max_results: $max_results, min_power: $min_power, usage_types: $usage_types, box: $box)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          int? min_power,
      String? usage_types,
      BoundingBox? box}) = _$_SearchRequest;
