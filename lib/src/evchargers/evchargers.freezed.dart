...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(town: $town, address_line_1: $address_line_1, country_id: $country_id, lat_lng: $lat_lng, location: $location, postcode: $postcode, access_comments: $access_comments, address_line_2: $address_line_2, country: $country, state_or_province: $state_or_province, title: $title)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level_id: $level_id, reference: $reference, connection_type: $connection_type, connection_type_id: $connection_type_id, level: $level, voltage: $voltage, amps: $amps, current: $current, power: $power)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(id: $id, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, phone_primary: $phone_primary, title: $title, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, connections: $connections, id: $id, num_points: $num_points, usage_type_id: $usage_type_id, cost: $cost, data_provider_id: $data_provider_id, operator: $operator, operator_id: $operator_id, usage_type: $usage_type)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, data_providers: $data_providers, usage_types: $usage_types, connection_types: $connection_types, countries: $countries, current_types: $current_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(location: $location, max_results: $max_results, operators: $operators, country_id: $country_id, connection_types: $connection_types, distance: $distance, levels: $levels, min_power: $min_power, usage_types: $usage_types, box: $box)';
  }
