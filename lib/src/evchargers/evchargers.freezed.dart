...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(state_or_province: $state_or_province, access_comments: $access_comments, address_line_1: $address_line_1, country: $country, country_id: $country_id, lat_lng: $lat_lng, postcode: $postcode, address_line_2: $address_line_2, location: $location, title: $title, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type_id: $connection_type_id, current: $current, power: $power, reference: $reference, amps: $amps, connection_type: $connection_type, level: $level, level_id: $level_id, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(phone_secondary: $phone_secondary, title: $title, website: $website, comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, id: $id, usage_type_id: $usage_type_id, num_points: $num_points, operator: $operator, operator_id: $operator_id, usage_type: $usage_type, connections: $connections, cost: $cost, data_provider_id: $data_provider_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(current_types: $current_types, operators: $operators, status_types: $status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, data_providers: $data_providers, submission_status_types: $submission_status_types, usage_types: $usage_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, connection_types: $connection_types, levels: $levels, location: $location, usage_types: $usage_types, country_id: $country_id, distance: $distance, max_results: $max_results, min_power: $min_power, operators: $operators)';
  }
