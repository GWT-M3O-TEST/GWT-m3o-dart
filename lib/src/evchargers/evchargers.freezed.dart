...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, country_id: $country_id, location: $location, postcode: $postcode, town: $town, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, lat_lng: $lat_lng, state_or_province: $state_or_province, title: $title)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, level_id: $level_id, connection_type: $connection_type, connection_type_id: $connection_type_id, power: $power, reference: $reference, voltage: $voltage, amps: $amps, level: $level)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, id: $id, phone_secondary: $phone_secondary, title: $title, comments: $comments, is_private_individual: $is_private_individual, phone_primary: $phone_primary, website: $website, contact_email: $contact_email)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(connections: $connections, cost: $cost, data_provider_id: $data_provider_id, num_points: $num_points, address: $address, operator: $operator, operator_id: $operator_id, usage_type: $usage_type, usage_type_id: $usage_type_id, id: $id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(submission_status_types: $submission_status_types, usage_types: $usage_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, countries: $countries, data_providers: $data_providers, operators: $operators, connection_types: $connection_types, current_types: $current_types, status_types: $status_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(operators: $operators, country_id: $country_id, distance: $distance, levels: $levels, location: $location, min_power: $min_power, box: $box, connection_types: $connection_types, max_results: $max_results, usage_types: $usage_types)';
  }
