...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(state_or_province: $state_or_province, title: $title, town: $town, address_line_1: $address_line_1, address_line_2: $address_line_2, country_id: $country_id, location: $location, access_comments: $access_comments, country: $country, lat_lng: $lat_lng, postcode: $postcode)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary, title: $title, website: $website, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(num_points: $num_points, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, connections: $connections, cost: $cost, data_provider_id: $data_provider_id, id: $id, operator_id: $operator_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, current_types: $current_types, data_providers: $data_providers, operators: $operators, submission_status_types: $submission_status_types, charger_types: $charger_types, status_types: $status_types, usage_types: $usage_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(levels: $levels, max_results: $max_results, min_power: $min_power, operators: $operators, usage_types: $usage_types, box: $box, connection_types: $connection_types, country_id: $country_id, distance: $distance, location: $location)';
  }
