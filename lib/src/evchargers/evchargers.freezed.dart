...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(town: $town, access_comments: $access_comments, country: $country, country_id: $country_id, location: $location, state_or_province: $state_or_province, title: $title, address_line_1: $address_line_1, address_line_2: $address_line_2, lat_lng: $lat_lng, postcode: $postcode)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, connection_type: $connection_type, level_id: $level_id, power: $power, voltage: $voltage, connection_type_id: $connection_type_id, current: $current, level: $level, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary, website: $website, comments: $comments, contact_email: $contact_email, id: $id, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(operator_id: $operator_id, usage_type: $usage_type, address: $address, cost: $cost, data_provider_id: $data_provider_id, id: $id, num_points: $num_points, connections: $connections, operator: $operator, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(current_types: $current_types, data_providers: $data_providers, status_types: $status_types, submission_status_types: $submission_status_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, usage_types: $usage_types, user_comment_types: $user_comment_types, operators: $operators)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(connection_types: $connection_types, distance: $distance, min_power: $min_power, usage_types: $usage_types, max_results: $max_results, operators: $operators, box: $box, country_id: $country_id, levels: $levels, location: $location)';
  }
