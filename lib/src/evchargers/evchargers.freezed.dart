...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country_id: $country_id, state_or_province: $state_or_province, title: $title, town: $town, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, postcode: $postcode, access_comments: $access_comments, lat_lng: $lat_lng, location: $location)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(power: $power, voltage: $voltage, connection_type: $connection_type, connection_type_id: $connection_type_id, level: $level, level_id: $level_id, amps: $amps, current: $current, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(phone_primary: $phone_primary, phone_secondary: $phone_secondary, title: $title, website: $website, contact_email: $contact_email, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, comments: $comments, id: $id)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, operator_id: $operator_id, usage_type: $usage_type, address: $address, connections: $connections, data_provider_id: $data_provider_id, id: $id, num_points: $num_points, operator: $operator, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, countries: $countries, current_types: $current_types, data_providers: $data_providers, operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, usage_types: $usage_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, country_id: $country_id, max_results: $max_results, usage_types: $usage_types, connection_types: $connection_types, distance: $distance, levels: $levels, location: $location, min_power: $min_power, operators: $operators)';
  }
