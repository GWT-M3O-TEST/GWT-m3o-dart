...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country_id: $country_id, postcode: $postcode, town: $town, address_line_2: $address_line_2, country: $country, lat_lng: $lat_lng, location: $location, state_or_province: $state_or_province, title: $title, access_comments: $access_comments, address_line_1: $address_line_1)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, level: $level, level_id: $level_id, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, power: $power, reference: $reference, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary, website: $website, contact_email: $contact_email, fault_report_email: $fault_report_email, phone_secondary: $phone_secondary, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(connections: $connections, id: $id, num_points: $num_points, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, data_provider_id: $data_provider_id, operator_id: $operator_id, cost: $cost)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(usage_types: $usage_types, user_comment_types: $user_comment_types, connection_types: $connection_types, current_types: $current_types, data_providers: $data_providers, operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, countries: $countries)';
  }
...
abstract class ReferenceDataResponseData implements ReferenceDataResponse {
  const factory ReferenceDataResponseData(
      ...
      List<ChargerType>? charger_types,
      List<CheckinStatusType>? checkin_status_types,
      List<Country>? countries}) = _$ReferenceDataResponseData;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(operators: $operators, usage_types: $usage_types, box: $box, connection_types: $connection_types, country_id: $country_id, location: $location, max_results: $max_results, distance: $distance, levels: $levels, min_power: $min_power)';
  }
