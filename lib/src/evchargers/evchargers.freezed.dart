...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(state_or_province: $state_or_province, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, lat_lng: $lat_lng, location: $location, postcode: $postcode, title: $title, address_line_2: $address_line_2, country: $country, country_id: $country_id)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level: $level, level_id: $level_id, reference: $reference, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, amps: $amps, power: $power, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary, title: $title, comments: $comments, contact_email: $contact_email, phone_secondary: $phone_secondary, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, data_provider_id: $data_provider_id, num_points: $num_points, usage_type_id: $usage_type_id, address: $address, connections: $connections, id: $id, operator: $operator, operator_id: $operator_id, usage_type: $usage_type)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(operators: $operators, submission_status_types: $submission_status_types, countries: $countries, data_providers: $data_providers, connection_types: $connection_types, current_types: $current_types, status_types: $status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(connection_types: $connection_types, country_id: $country_id, max_results: $max_results, box: $box, levels: $levels, location: $location, min_power: $min_power, operators: $operators, usage_types: $usage_types, distance: $distance)';
  }
