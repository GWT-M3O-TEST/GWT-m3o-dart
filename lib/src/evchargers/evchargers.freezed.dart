...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, address_line_1: $address_line_1, country: $country, lat_lng: $lat_lng, postcode: $postcode, state_or_province: $state_or_province, title: $title, address_line_2: $address_line_2, country_id: $country_id, location: $location, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, current: $current, level_id: $level_id, voltage: $voltage, connection_type: $connection_type, connection_type_id: $connection_type_id, level: $level, power: $power, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(website: $website, comments: $comments, contact_email: $contact_email, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary, fault_report_email: $fault_report_email, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(connections: $connections, data_provider_id: $data_provider_id, id: $id, operator_id: $operator_id, address: $address, cost: $cost, num_points: $num_points, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, countries: $countries, operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types, connection_types: $connection_types, current_types: $current_types, data_providers: $data_providers)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(max_results: $max_results, operators: $operators, usage_types: $usage_types, box: $box, connection_types: $connection_types, levels: $levels, location: $location, country_id: $country_id, distance: $distance, min_power: $min_power)';
  }
