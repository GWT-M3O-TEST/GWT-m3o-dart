...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, address_line_1: $address_line_1, country: $country, country_id: $country_id, lat_lng: $lat_lng, location: $location, postcode: $postcode, state_or_province: $state_or_province, title: $title, address_line_2: $address_line_2, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, power: $power, current: $current, level: $level, level_id: $level_id, reference: $reference, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(title: $title, comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary, id: $id, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, connections: $connections, data_provider_id: $data_provider_id, id: $id, operator_id: $operator_id, usage_type_id: $usage_type_id, cost: $cost, num_points: $num_points, operator: $operator, usage_type: $usage_type)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, status_types: $status_types, user_comment_types: $user_comment_types, data_providers: $data_providers, operators: $operators, submission_status_types: $submission_status_types, usage_types: $usage_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, countries: $countries, current_types: $current_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(connection_types: $connection_types, country_id: $country_id, levels: $levels, location: $location, box: $box, distance: $distance, max_results: $max_results, min_power: $min_power, operators: $operators, usage_types: $usage_types)';
  }
