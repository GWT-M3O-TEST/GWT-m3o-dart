...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(lat_lng: $lat_lng, location: $location, postcode: $postcode, title: $title, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, country_id: $country_id, state_or_province: $state_or_province, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, level: $level, level_id: $level_id, power: $power, voltage: $voltage, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(title: $title, website: $website, id: $id, contact_email: $contact_email, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary, comments: $comments)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(num_points: $num_points, operator: $operator, operator_id: $operator_id, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, id: $id, data_provider_id: $data_provider_id, connections: $connections, cost: $cost)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, countries: $countries, operators: $operators, status_types: $status_types, charger_types: $charger_types, current_types: $current_types, data_providers: $data_providers, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, checkin_status_types: $checkin_status_types)';
  }
...
abstract class ReferenceDataResponseData implements ReferenceDataResponse {
  const factory ReferenceDataResponseData(
      ...
      UsageType? usage_types,
      UserCommentType? user_comment_types,
      CheckinStatusType? checkin_status_types}) = _$ReferenceDataResponseData;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(max_results: $max_results, min_power: $min_power, usage_types: $usage_types, connection_types: $connection_types, country_id: $country_id, distance: $distance, operators: $operators, box: $box, levels: $levels, location: $location)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      BoundingBox? box,
      List<String>? levels,
      Coordinates? location}) = _$_SearchRequest;
