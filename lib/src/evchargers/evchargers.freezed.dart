...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(location: $location, postcode: $postcode, title: $title, access_comments: $access_comments, address_line_1: $address_line_1, country: $country, state_or_province: $state_or_province, town: $town, address_line_2: $address_line_2, country_id: $country_id, lat_lng: $lat_lng)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(power: $power, connection_type_id: $connection_type_id, level_id: $level_id, current: $current, level: $level, reference: $reference, voltage: $voltage, amps: $amps, connection_type: $connection_type)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary, contact_email: $contact_email, fault_report_email: $fault_report_email, title: $title, website: $website, comments: $comments, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(connections: $connections, cost: $cost, data_provider_id: $data_provider_id, id: $id, operator_id: $operator_id, usage_type_id: $usage_type_id, address: $address, num_points: $num_points, operator: $operator, usage_type: $usage_type)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(countries: $countries, operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types, usage_types: $usage_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, current_types: $current_types, data_providers: $data_providers)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(usage_types: $usage_types, box: $box, connection_types: $connection_types, country_id: $country_id, max_results: $max_results, operators: $operators, distance: $distance, levels: $levels, location: $location, min_power: $min_power)';
  }
