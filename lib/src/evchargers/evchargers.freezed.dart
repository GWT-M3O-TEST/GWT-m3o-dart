...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, address_line_1: $address_line_1, lat_lng: $lat_lng, location: $location, title: $title, address_line_2: $address_line_2, country: $country, country_id: $country_id, postcode: $postcode, state_or_province: $state_or_province, town: $town)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, reference: $reference, voltage: $voltage, level: $level, level_id: $level_id, power: $power, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current)';
  }
...
class _$CountryTearOff {
  ...
  _Country call(
      {String? id, String? iso_code, String? title, String? continent_code}) {
    return _Country(
      id: id,
      iso_code: iso_code,
      title: title,
...
class _$_Country implements _Country {
  const _$_Country({this.id, this.iso_code, this.title, this.continent_code});
  ...
  @override
  String toString() {
    return 'Country(id: $id, iso_code: $iso_code, title: $title, continent_code: $continent_code)';
  }
...
abstract class _Country implements Country {
  const factory _Country(
      ...
      String? iso_code,
      String? title,
      String? continent_code}) = _$_Country;
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, phone_primary: $phone_primary, phone_secondary: $phone_secondary, website: $website, comments: $comments, contact_email: $contact_email, id: $id, is_private_individual: $is_private_individual, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type_id: $usage_type_id, address: $address, connections: $connections, operator: $operator, num_points: $num_points, operator_id: $operator_id, usage_type: $usage_type, cost: $cost, data_provider_id: $data_provider_id, id: $id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(usage_types: $usage_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, submission_status_types: $submission_status_types, status_types: $status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, current_types: $current_types, data_providers: $data_providers, operators: $operators)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, country_id: $country_id, location: $location, operators: $operators, usage_types: $usage_types, connection_types: $connection_types, distance: $distance, levels: $levels, max_results: $max_results, min_power: $min_power)';
  }
