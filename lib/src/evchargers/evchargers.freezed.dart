...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(postcode: $postcode, state_or_province: $state_or_province, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, country: $country, lat_lng: $lat_lng, location: $location, address_line_2: $address_line_2, country_id: $country_id, title: $title)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, current: $current, level: $level, reference: $reference, voltage: $voltage, connection_type: $connection_type, connection_type_id: $connection_type_id, level_id: $level_id, power: $power)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, phone_primary: $phone_primary, title: $title, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(id: $id, num_points: $num_points, operator_id: $operator_id, address: $address, cost: $cost, operator: $operator, usage_type: $usage_type, usage_type_id: $usage_type_id, connections: $connections, data_provider_id: $data_provider_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(checkin_status_types: $checkin_status_types, connection_types: $connection_types, current_types: $current_types, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, countries: $countries, data_providers: $data_providers, operators: $operators, status_types: $status_types)';
  }
...
abstract class ReferenceDataResponseData implements ReferenceDataResponse {
  const factory ReferenceDataResponseData(
      ...
      List<DataProvider>? data_providers,
      List<Operator>? operators,
      List<StatusType>? status_types}) = _$ReferenceDataResponseData;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, location: $location, max_results: $max_results, operators: $operators, box: $box, connection_types: $connection_types, distance: $distance, levels: $levels, min_power: $min_power, usage_types: $usage_types)';
  }
