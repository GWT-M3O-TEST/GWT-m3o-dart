...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, location: $location, title: $title, town: $town, access_comments: $access_comments, country_id: $country_id, lat_lng: $lat_lng, postcode: $postcode, state_or_province: $state_or_province)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, connection_type_id: $connection_type_id, current: $current, level: $level, power: $power, reference: $reference, connection_type: $connection_type, level_id: $level_id, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary, website: $website, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, comments: $comments, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, num_points: $num_points, operator_id: $operator_id, usage_type: $usage_type, address: $address, connections: $connections, operator: $operator, usage_type_id: $usage_type_id, data_provider_id: $data_provider_id, id: $id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(countries: $countries, data_providers: $data_providers, status_types: $status_types, usage_types: $usage_types, operators: $operators, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, current_types: $current_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, distance: $distance, max_results: $max_results, operators: $operators, usage_types: $usage_types, box: $box, levels: $levels, location: $location, min_power: $min_power, connection_types: $connection_types)';
  }
