...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country: $country, lat_lng: $lat_lng, postcode: $postcode, title: $title, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, country_id: $country_id, location: $location, state_or_province: $state_or_province)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, voltage: $voltage, level: $level, level_id: $level_id, power: $power, reference: $reference, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id)';
  }
...
abstract class _Connection implements Connection {
  const factory _Connection(
      ...
      double? amps,
      ConnectionType? connection_type,
      String? connection_type_id}) = _$_Connection;
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(id: $id, phone_primary: $phone_primary, title: $title, fault_report_email: $fault_report_email, contact_email: $contact_email, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary, website: $website, comments: $comments)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(data_provider_id: $data_provider_id, operator: $operator, operator_id: $operator_id, usage_type_id: $usage_type_id, address: $address, connections: $connections, cost: $cost, id: $id, num_points: $num_points, usage_type: $usage_type)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(user_comment_types: $user_comment_types, charger_types: $charger_types, connection_types: $connection_types, data_providers: $data_providers, status_types: $status_types, submission_status_types: $submission_status_types, checkin_status_types: $checkin_status_types, countries: $countries, current_types: $current_types, operators: $operators, usage_types: $usage_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(max_results: $max_results, min_power: $min_power, operators: $operators, box: $box, connection_types: $connection_types, levels: $levels, location: $location, usage_types: $usage_types, country_id: $country_id, distance: $distance)';
  }
