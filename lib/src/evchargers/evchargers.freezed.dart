...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, country: $country, country_id: $country_id, location: $location, postcode: $postcode, address_line_1: $address_line_1, address_line_2: $address_line_2, lat_lng: $lat_lng, state_or_province: $state_or_province, title: $title, town: $town)';
  }
...
class _$_ChargerType implements _ChargerType {
  const _$_ChargerType(
      {this.is_fast_charge_capable, this.title, this.comments, this.id});
  ...
  @override
  String toString() {
    return 'ChargerType(is_fast_charge_capable: $is_fast_charge_capable, title: $title, comments: $comments, id: $id)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, connection_type: $connection_type, level: $level, voltage: $voltage, connection_type_id: $connection_type_id, current: $current, level_id: $level_id, power: $power, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(title: $title, website: $website, comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type: $usage_type, connections: $connections, cost: $cost, num_points: $num_points, operator_id: $operator_id, usage_type_id: $usage_type_id, address: $address, data_provider_id: $data_provider_id, id: $id, operator: $operator)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, countries: $countries, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, current_types: $current_types, data_providers: $data_providers, operators: $operators, status_types: $status_types, submission_status_types: $submission_status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, country_id: $country_id, levels: $levels, location: $location, min_power: $min_power, usage_types: $usage_types, connection_types: $connection_types, distance: $distance, max_results: $max_results, operators: $operators)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          int? max_results,
      List<String>? operators}) = _$_SearchRequest;
