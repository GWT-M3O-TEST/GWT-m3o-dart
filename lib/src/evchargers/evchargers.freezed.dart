...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country: $country, country_id: $country_id, lat_lng: $lat_lng, title: $title, address_line_2: $address_line_2, address_line_1: $address_line_1, location: $location, postcode: $postcode, state_or_province: $state_or_province, town: $town, access_comments: $access_comments)';
  }
...
abstract class _Address implements Address {
  const factory _Address(
      ...
      String? state_or_province,
      String? town,
      String? access_comments}) = _$_Address;
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, current: $current, reference: $reference, voltage: $voltage, amps: $amps, connection_type_id: $connection_type_id, level: $level, level_id: $level_id, power: $power)';
  }
...
abstract class _ConnectionType implements ConnectionType {
  const factory _ConnectionType(
      ...
      String? id,
      bool? is_discontinued,
      bool? is_obsolete}) = _$_ConnectionType;
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(phone_secondary: $phone_secondary, title: $title, website: $website, comments: $comments, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, contact_email: $contact_email, id: $id, phone_primary: $phone_primary)';
  }
...
abstract class _Operator implements Operator {
  const factory _Operator(
      ...
      String? contact_email,
      String? id,
      String? phone_primary}) = _$_Operator;
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(id: $id, num_points: $num_points, operator_id: $operator_id, usage_type: $usage_type, operator: $operator, usage_type_id: $usage_type_id, address: $address, connections: $connections, cost: $cost, data_provider_id: $data_provider_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, data_providers: $data_providers, operators: $operators, submission_status_types: $submission_status_types, usage_types: $usage_types, connection_types: $connection_types, countries: $countries, current_types: $current_types, status_types: $status_types)';
  }
...
abstract class ReferenceDataResponseData implements ReferenceDataResponse {
  const factory ReferenceDataResponseData(
      ...
      List<Country>? countries,
      CurrentType? current_types,
      StatusType? status_types}) = _$ReferenceDataResponseData;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(location: $location, operators: $operators, usage_types: $usage_types, box: $box, connection_types: $connection_types, country_id: $country_id, distance: $distance, levels: $levels, max_results: $max_results, min_power: $min_power)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          int? max_results,
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          int? min_power}) = _$_SearchRequest;
...
class _$UserCommentTypeTearOff {
  ...
  _UserCommentType call({String? title, String? id}) {
...
abstract class _UserCommentType implements UserCommentType {
  const factory _UserCommentType({String? title, String? id}) =
      _$_UserCommentType;
