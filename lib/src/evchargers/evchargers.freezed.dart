...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country: $country, country_id: $country_id, lat_lng: $lat_lng, postcode: $postcode, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, location: $location, state_or_province: $state_or_province, title: $title)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level_id: $level_id, power: $power, reference: $reference, voltage: $voltage, current: $current, level: $level, connection_type_id: $connection_type_id, amps: $amps, connection_type: $connection_type)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(comments: $comments, contact_email: $contact_email, id: $id, phone_primary: $phone_primary, title: $title, website: $website, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type_id: $usage_type_id, address: $address, connections: $connections, cost: $cost, operator_id: $operator_id, usage_type: $usage_type, data_provider_id: $data_provider_id, id: $id, num_points: $num_points, operator: $operator)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(checkin_status_types: $checkin_status_types, connection_types: $connection_types, countries: $countries, data_providers: $data_providers, status_types: $status_types, submission_status_types: $submission_status_types, charger_types: $charger_types, current_types: $current_types, operators: $operators, usage_types: $usage_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(levels: $levels, min_power: $min_power, operators: $operators, connection_types: $connection_types, country_id: $country_id, distance: $distance, usage_types: $usage_types, box: $box, location: $location, max_results: $max_results)';
  }
