...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(country: $country, country_id: $country_id, title: $title, access_comments: $access_comments, address_line_1: $address_line_1, location: $location, postcode: $postcode, state_or_province: $state_or_province, town: $town, address_line_2: $address_line_2, lat_lng: $lat_lng)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, level: $level, power: $power, reference: $reference, voltage: $voltage, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, level_id: $level_id)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(phone_primary: $phone_primary, phone_secondary: $phone_secondary, website: $website, is_private_individual: $is_private_individual, title: $title, comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(cost: $cost, id: $id, operator_id: $operator_id, usage_type: $usage_type, address: $address, connections: $connections, data_provider_id: $data_provider_id, num_points: $num_points, operator: $operator, usage_type_id: $usage_type_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, current_types: $current_types, data_providers: $data_providers, status_types: $status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, countries: $countries, operators: $operators, submission_status_types: $submission_status_types)';
  }
