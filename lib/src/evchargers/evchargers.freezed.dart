...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, address_line_2: $address_line_2, postcode: $postcode, title: $title, state_or_province: $state_or_province, town: $town, address_line_1: $address_line_1, country: $country, country_id: $country_id, lat_lng: $lat_lng, location: $location)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, level_id: $level_id, power: $power, reference: $reference, voltage: $voltage, amps: $amps, level: $level)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(contact_email: $contact_email, id: $id, phone_primary: $phone_primary, phone_secondary: $phone_secondary, website: $website, comments: $comments, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(id: $id, operator: $operator, operator_id: $operator_id, usage_type: $usage_type, address: $address, cost: $cost, num_points: $num_points, usage_type_id: $usage_type_id, connections: $connections, data_provider_id: $data_provider_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(usage_types: $usage_types, checkin_status_types: $checkin_status_types, connection_types: $connection_types, data_providers: $data_providers, operators: $operators, submission_status_types: $submission_status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, countries: $countries, current_types: $current_types, status_types: $status_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(box: $box, country_id: $country_id, distance: $distance, usage_types: $usage_types, operators: $operators, connection_types: $connection_types, levels: $levels, location: $location, max_results: $max_results, min_power: $min_power)';
  }
