...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(postcode: $postcode, country: $country, country_id: $country_id, lat_lng: $lat_lng, location: $location, title: $title, town: $town, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, state_or_province: $state_or_province)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(amps: $amps, level: $level, level_id: $level_id, reference: $reference, voltage: $voltage, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, power: $power)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, id: $id, phone_primary: $phone_primary, phone_secondary: $phone_secondary, website: $website, comments: $comments, contact_email: $contact_email, is_private_individual: $is_private_individual, title: $title)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(connections: $connections, cost: $cost, id: $id, num_points: $num_points, usage_type: $usage_type, usage_type_id: $usage_type_id, address: $address, operator: $operator, operator_id: $operator_id, data_provider_id: $data_provider_id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(charger_types: $charger_types, countries: $countries, current_types: $current_types, operators: $operators, checkin_status_types: $checkin_status_types, connection_types: $connection_types, data_providers: $data_providers, status_types: $status_types, submission_status_types: $submission_status_types, usage_types: $usage_types, user_comment_types: $user_comment_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(location: $location, max_results: $max_results, min_power: $min_power, usage_types: $usage_types, connection_types: $connection_types, country_id: $country_id, distance: $distance, box: $box, levels: $levels, operators: $operators)';
  }
