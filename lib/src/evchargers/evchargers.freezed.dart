...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(lat_lng: $lat_lng, state_or_province: $state_or_province, title: $title, address_line_2: $address_line_2, country: $country, country_id: $country_id, location: $location, postcode: $postcode, town: $town, access_comments: $access_comments, address_line_1: $address_line_1)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(level: $level, level_id: $level_id, voltage: $voltage, amps: $amps, connection_type: $connection_type, connection_type_id: $connection_type_id, current: $current, power: $power, reference: $reference)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(website: $website, comments: $comments, contact_email: $contact_email, fault_report_email: $fault_report_email, id: $id, phone_primary: $phone_primary, title: $title, is_private_individual: $is_private_individual, phone_secondary: $phone_secondary)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(usage_type: $usage_type, usage_type_id: $usage_type_id, connections: $connections, cost: $cost, operator_id: $operator_id, num_points: $num_points, operator: $operator, address: $address, data_provider_id: $data_provider_id, id: $id)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(connection_types: $connection_types, current_types: $current_types, data_providers: $data_providers, operators: $operators, status_types: $status_types, user_comment_types: $user_comment_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, countries: $countries, submission_status_types: $submission_status_types, usage_types: $usage_types)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(country_id: $country_id, location: $location, max_results: $max_results, min_power: $min_power, operators: $operators, connection_types: $connection_types, distance: $distance, levels: $levels, usage_types: $usage_types, box: $box)';
  }
