...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(access_comments: $access_comments, address_line_1: $address_line_1, state_or_province: $state_or_province, title: $title, town: $town, address_line_2: $address_line_2, country: $country, country_id: $country_id, lat_lng: $lat_lng, location: $location, postcode: $postcode)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(connection_type_id: $connection_type_id, current: $current, level: $level, level_id: $level_id, power: $power, reference: $reference, amps: $amps, connection_type: $connection_type, voltage: $voltage)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(phone_secondary: $phone_secondary, title: $title, comments: $comments, contact_email: $contact_email, id: $id, phone_primary: $phone_primary, fault_report_email: $fault_report_email, is_private_individual: $is_private_individual, website: $website)';
  }
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(address: $address, connections: $connections, data_provider_id: $data_provider_id, id: $id, operator: $operator, operator_id: $operator_id, usage_type_id: $usage_type_id, cost: $cost, num_points: $num_points, usage_type: $usage_type)';
  }
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(current_types: $current_types, status_types: $status_types, usage_types: $usage_types, user_comment_types: $user_comment_types, charger_types: $charger_types, connection_types: $connection_types, countries: $countries, submission_status_types: $submission_status_types, checkin_status_types: $checkin_status_types, data_providers: $data_providers, operators: $operators)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(distance: $distance, levels: $levels, max_results: $max_results, min_power: $min_power, operators: $operators, usage_types: $usage_types, box: $box, connection_types: $connection_types, country_id: $country_id, location: $location)';
  }
