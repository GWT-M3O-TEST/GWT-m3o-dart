...
class _$_Address implements _Address {
  ...
  @override
  String toString() {
    return 'Address(lat_lng: $lat_lng, location: $location, title: $title, town: $town, state_or_province: $state_or_province, access_comments: $access_comments, address_line_1: $address_line_1, address_line_2: $address_line_2, country: $country, country_id: $country_id, postcode: $postcode)';
  }
...
class _$_Connection implements _Connection {
  ...
  @override
  String toString() {
    return 'Connection(current: $current, level_id: $level_id, reference: $reference, connection_type: $connection_type, connection_type_id: $connection_type_id, power: $power, voltage: $voltage, amps: $amps, level: $level)';
  }
...
class _$_Operator implements _Operator {
  ...
  @override
  String toString() {
    return 'Operator(fault_report_email: $fault_report_email, id: $id, title: $title, website: $website, comments: $comments, contact_email: $contact_email, is_private_individual: $is_private_individual, phone_primary: $phone_primary, phone_secondary: $phone_secondary)';
  }
...
abstract class _Operator implements Operator {
  const factory _Operator(
      ...
      bool? is_private_individual,
      String? phone_primary,
      String? phone_secondary}) = _$_Operator;
...
class _$_Poi implements _Poi {
  ...
  @override
  String toString() {
    return 'Poi(id: $id, address: $address, connections: $connections, num_points: $num_points, operator: $operator, operator_id: $operator_id, usage_type: $usage_type, usage_type_id: $usage_type_id, cost: $cost, data_provider_id: $data_provider_id)';
  }
...
abstract class _Poi implements Poi {
  const factory _Poi(
      ...
      String? usage_type_id,
      String? cost,
      String? data_provider_id}) = _$_Poi;
...
class _$ReferenceDataResponseData implements ReferenceDataResponseData {
  ...
  @override
  String toString() {
    return 'ReferenceDataResponse(submission_status_types: $submission_status_types, charger_types: $charger_types, checkin_status_types: $checkin_status_types, current_types: $current_types, data_providers: $data_providers, operators: $operators, status_types: $status_types, connection_types: $connection_types, countries: $countries, usage_types: $usage_types, user_comment_types: $user_comment_types)';
  }
...
abstract class ReferenceDataResponseData implements ReferenceDataResponse {
  const factory ReferenceDataResponseData(
      ...
      List<Country>? countries,
      List<UsageType>? usage_types,
      List<UserCommentType>? user_comment_types}) = _$ReferenceDataResponseData;
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(connection_types: $connection_types, min_power: $min_power, operators: $operators, usage_types: $usage_types, box: $box, distance: $distance, levels: $levels, location: $location, max_results: $max_results, country_id: $country_id)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      @JsonKey(fromJson: int64FromString, toJson: int64ToString)
          int? max_results,
      String? country_id}) = _$_SearchRequest;
