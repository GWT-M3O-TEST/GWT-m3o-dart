...
class _$AddRequestTearOff {
  ...
  _AddRequest call({String? name, String? url, String? category}) {
    return _AddRequest(
      name: name,
      url: url,
      category: category,
...
abstract class $AddRequestCopyWith<$Res> {
  ...
  $Res call({String? name, String? url, String? category});
}
...
class _$_AddRequest implements _AddRequest {
  const _$_AddRequest({this.name, this.url, this.category});
  ...
  @override
  String toString() {
    return 'AddRequest(name: $name, url: $url, category: $category)';
  }
...
abstract class _AddRequest implements AddRequest {
  const factory _AddRequest({String? name, String? url, String? category}) =
      _$_AddRequest;
...
class _$_Entry implements _Entry {
  ...
  @override
  String toString() {
    return 'Entry(link: $link, summary: $summary, title: $title, content: $content, date: $date, feed: $feed, id: $id)';
  }
...
class _$FeedTearOff {
  ...
  _Feed call({String? category, String? id, String? name, String? url}) {
    return _Feed(
      category: category,
      id: id,
      name: name,
...
abstract class _Feed implements Feed {
  const factory _Feed(
      {String? category, String? id, String? name, String? url}) = _$_Feed;
...
class _$FeedRequestTearOff {
  ...
  _FeedRequest call({int? limit, String? name, int? offset}) {
    return _FeedRequest(
      limit: limit,
      name: name,
      offset: offset,
...
abstract class $FeedRequestCopyWith<$Res> {
  ...
  $Res call({int? limit, String? name, int? offset});
}
...
class _$_FeedRequest implements _FeedRequest {
  const _$_FeedRequest({this.limit, this.name, this.offset});
...
abstract class _FeedRequest implements FeedRequest {
  const factory _FeedRequest({int? limit, String? name, int? offset}) =
      _$_FeedRequest;
