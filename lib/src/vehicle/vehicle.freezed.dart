...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, colour: $colour, make: $make, mot_status: $mot_status, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, registration: $registration, wheelplan: $wheelplan, last_v5_issued: $last_v5_issued, logo_url: $logo_url, tax_due_date: $tax_due_date, type_approval: $type_approval, engine_capacity: $engine_capacity, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture)';
  }
