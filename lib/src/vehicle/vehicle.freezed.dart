...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(registration: $registration, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, logo_url: $logo_url, mot_status: $mot_status, tax_due_date: $tax_due_date, colour: $colour, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, fuel_type: $fuel_type, mot_expiry: $mot_expiry, tax_status: $tax_status, type_approval: $type_approval, make: $make)';
  }
