...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(logo_url: $logo_url, make: $make, month_of_first_registration: $month_of_first_registration, wheelplan: $wheelplan, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, tax_due_date: $tax_due_date, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, mot_status: $mot_status, colour: $colour, registration: $registration, tax_status: $tax_status)';
  }
