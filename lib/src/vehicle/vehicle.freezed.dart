...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(tax_status: $tax_status, type_approval: $type_approval, colour: $colour, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, wheelplan: $wheelplan, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, logo_url: $logo_url, make: $make, mot_status: $mot_status, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, registration: $registration, tax_due_date: $tax_due_date)';
  }
