...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_status: $mot_status, type_approval: $type_approval, wheelplan: $wheelplan, month_of_first_registration: $month_of_first_registration, fuel_type: $fuel_type, colour: $colour, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, logo_url: $logo_url, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, make: $make, registration: $registration, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions)';
  }
