...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(wheelplan: $wheelplan, colour: $colour, mot_status: $mot_status, tax_status: $tax_status, registration: $registration, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, make: $make, month_of_first_registration: $month_of_first_registration, co2_emissions: $co2_emissions, logo_url: $logo_url, tax_due_date: $tax_due_date, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry)';
  }
