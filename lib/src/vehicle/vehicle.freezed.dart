...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, registration: $registration, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, logo_url: $logo_url, make: $make, mot_expiry: $mot_expiry, last_v5_issued: $last_v5_issued, tax_due_date: $tax_due_date, tax_status: $tax_status, type_approval: $type_approval, fuel_type: $fuel_type, wheelplan: $wheelplan)';
  }
