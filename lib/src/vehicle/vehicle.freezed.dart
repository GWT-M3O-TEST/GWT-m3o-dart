...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, last_v5_issued: $last_v5_issued, make: $make, mot_status: $mot_status, type_approval: $type_approval, tax_due_date: $tax_due_date, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, logo_url: $logo_url, mot_expiry: $mot_expiry, registration: $registration, month_of_first_registration: $month_of_first_registration, fuel_type: $fuel_type, wheelplan: $wheelplan)';
  }
