...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_expiry: $mot_expiry, year_of_manufacture: $year_of_manufacture, last_v5_issued: $last_v5_issued, wheelplan: $wheelplan, colour: $colour, logo_url: $logo_url, type_approval: $type_approval, fuel_type: $fuel_type, engine_capacity: $engine_capacity, make: $make, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, registration: $registration, tax_due_date: $tax_due_date, tax_status: $tax_status, co2_emissions: $co2_emissions)';
  }
