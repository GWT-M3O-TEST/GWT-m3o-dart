...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(make: $make, registration: $registration, tax_status: $tax_status, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, colour: $colour, mot_status: $mot_status, type_approval: $type_approval, co2_emissions: $co2_emissions, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      String? last_v5_issued,
      String? mot_expiry,
      String? tax_due_date}) = _$LookupResponseData;
