...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, year_of_manufacture: $year_of_manufacture, colour: $colour, make: $make, tax_status: $tax_status, type_approval: $type_approval, wheelplan: $wheelplan, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, mot_status: $mot_status, registration: $registration, tax_due_date: $tax_due_date, last_v5_issued: $last_v5_issued, logo_url: $logo_url)';
  }
