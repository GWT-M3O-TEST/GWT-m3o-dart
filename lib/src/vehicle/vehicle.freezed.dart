...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(make: $make, tax_due_date: $tax_due_date, wheelplan: $wheelplan, co2_emissions: $co2_emissions, colour: $colour, last_v5_issued: $last_v5_issued, logo_url: $logo_url, registration: $registration, type_approval: $type_approval, fuel_type: $fuel_type, mot_status: $mot_status, engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture)';
  }
