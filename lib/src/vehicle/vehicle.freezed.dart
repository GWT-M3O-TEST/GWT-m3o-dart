...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, last_v5_issued: $last_v5_issued, year_of_manufacture: $year_of_manufacture, make: $make, mot_expiry: $mot_expiry, registration: $registration, fuel_type: $fuel_type, tax_due_date: $tax_due_date, type_approval: $type_approval, mot_status: $mot_status, tax_status: $tax_status, wheelplan: $wheelplan, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration)';
  }
