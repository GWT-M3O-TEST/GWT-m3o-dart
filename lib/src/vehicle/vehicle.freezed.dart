...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, tax_status: $tax_status, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, make: $make, year_of_manufacture: $year_of_manufacture, fuel_type: $fuel_type, logo_url: $logo_url, mot_status: $mot_status, registration: $registration, wheelplan: $wheelplan, colour: $colour, tax_due_date: $tax_due_date, type_approval: $type_approval)';
  }
