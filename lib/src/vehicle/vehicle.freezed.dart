...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, colour: $colour, logo_url: $logo_url, mot_status: $mot_status, registration: $registration, tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, make: $make, tax_status: $tax_status, type_approval: $type_approval, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, wheelplan: $wheelplan)';
  }
