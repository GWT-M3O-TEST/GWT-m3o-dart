...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, tax_status: $tax_status, type_approval: $type_approval, colour: $colour, fuel_type: $fuel_type, mot_status: $mot_status, tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, make: $make, wheelplan: $wheelplan, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, logo_url: $logo_url, registration: $registration)';
  }
