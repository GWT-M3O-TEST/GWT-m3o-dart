...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url, tax_due_date: $tax_due_date, tax_status: $tax_status, co2_emissions: $co2_emissions, colour: $colour, engine_capacity: $engine_capacity, mot_status: $mot_status, registration: $registration, fuel_type: $fuel_type, make: $make, month_of_first_registration: $month_of_first_registration, wheelplan: $wheelplan)';
  }
