...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, tax_due_date: $tax_due_date, tax_status: $tax_status, wheelplan: $wheelplan, colour: $colour, make: $make, mot_expiry: $mot_expiry, mot_status: $mot_status, registration: $registration, engine_capacity: $engine_capacity, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture)';
  }
