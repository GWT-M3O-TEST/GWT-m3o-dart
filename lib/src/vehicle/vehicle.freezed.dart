...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, mot_status: $mot_status, year_of_manufacture: $year_of_manufacture, colour: $colour, engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, registration: $registration, tax_due_date: $tax_due_date, logo_url: $logo_url, type_approval: $type_approval, wheelplan: $wheelplan, co2_emissions: $co2_emissions, fuel_type: $fuel_type, make: $make, mot_expiry: $mot_expiry, tax_status: $tax_status)';
  }
