...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, make: $make, tax_due_date: $tax_due_date, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, colour: $colour, engine_capacity: $engine_capacity, fuel_type: $fuel_type, logo_url: $logo_url, mot_expiry: $mot_expiry, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, mot_status: $mot_status, registration: $registration, wheelplan: $wheelplan)';
  }
