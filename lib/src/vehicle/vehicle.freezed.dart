...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, make: $make, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, tax_status: $tax_status, wheelplan: $wheelplan, co2_emissions: $co2_emissions, mot_status: $mot_status, colour: $colour, last_v5_issued: $last_v5_issued, logo_url: $logo_url, registration: $registration, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture)';
  }
