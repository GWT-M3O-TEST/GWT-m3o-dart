...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, colour: $colour, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, make: $make, tax_due_date: $tax_due_date, wheelplan: $wheelplan, engine_capacity: $engine_capacity, logo_url: $logo_url, mot_expiry: $mot_expiry, registration: $registration, tax_status: $tax_status, co2_emissions: $co2_emissions, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      double? co2_emissions,
      String? month_of_first_registration,
      String? mot_status}) = _$LookupResponseData;
