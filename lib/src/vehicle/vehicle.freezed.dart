...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(registration: $registration, type_approval: $type_approval, wheelplan: $wheelplan, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, mot_status: $mot_status, co2_emissions: $co2_emissions, colour: $colour, logo_url: $logo_url, make: $make, mot_expiry: $mot_expiry, tax_status: $tax_status, year_of_manufacture: $year_of_manufacture)';
  }
