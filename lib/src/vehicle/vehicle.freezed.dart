...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, registration: $registration, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_due_date: $tax_due_date, type_approval: $type_approval, colour: $colour, fuel_type: $fuel_type, make: $make, tax_status: $tax_status, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url)';
  }
