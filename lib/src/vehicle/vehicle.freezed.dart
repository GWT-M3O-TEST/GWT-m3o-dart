...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(logo_url: $logo_url, registration: $registration, tax_due_date: $tax_due_date, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, last_v5_issued: $last_v5_issued, month_of_first_registration: $month_of_first_registration, colour: $colour, engine_capacity: $engine_capacity, fuel_type: $fuel_type, make: $make, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_status: $tax_status, type_approval: $type_approval, co2_emissions: $co2_emissions)';
  }
