...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, month_of_first_registration: $month_of_first_registration, type_approval: $type_approval, colour: $colour, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, year_of_manufacture: $year_of_manufacture, logo_url: $logo_url, make: $make, mot_status: $mot_status, tax_due_date: $tax_due_date, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, registration: $registration, tax_status: $tax_status, wheelplan: $wheelplan)';
  }
