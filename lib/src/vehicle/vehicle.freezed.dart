...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, mot_status: $mot_status, year_of_manufacture: $year_of_manufacture, tax_due_date: $tax_due_date, type_approval: $type_approval, co2_emissions: $co2_emissions, colour: $colour, engine_capacity: $engine_capacity, fuel_type: $fuel_type, make: $make, registration: $registration, tax_status: $tax_status, wheelplan: $wheelplan)';
  }
