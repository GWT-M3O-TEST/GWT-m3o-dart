...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, colour: $colour, fuel_type: $fuel_type, make: $make, registration: $registration, tax_due_date: $tax_due_date, tax_status: $tax_status, wheelplan: $wheelplan, engine_capacity: $engine_capacity, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, mot_status: $mot_status, type_approval: $type_approval)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      String? mot_expiry,
      String? mot_status,
      String? type_approval}) = _$LookupResponseData;
