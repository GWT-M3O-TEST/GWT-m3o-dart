...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_status: $mot_status, tax_due_date: $tax_due_date, tax_status: $tax_status, type_approval: $type_approval, co2_emissions: $co2_emissions, month_of_first_registration: $month_of_first_registration, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, make: $make, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, fuel_type: $fuel_type, logo_url: $logo_url, registration: $registration, colour: $colour, engine_capacity: $engine_capacity)';
  }
