...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, mot_status: $mot_status, colour: $colour, last_v5_issued: $last_v5_issued, tax_status: $tax_status, type_approval: $type_approval, engine_capacity: $engine_capacity, fuel_type: $fuel_type, make: $make, registration: $registration, logo_url: $logo_url, tax_due_date: $tax_due_date)';
  }
