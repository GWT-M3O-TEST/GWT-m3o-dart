...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, type_approval: $type_approval, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_due_date: $tax_due_date, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, logo_url: $logo_url, make: $make, registration: $registration)';
  }
