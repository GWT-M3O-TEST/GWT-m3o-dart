...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(make: $make, mot_status: $mot_status, colour: $colour, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, year_of_manufacture: $year_of_manufacture, registration: $registration, tax_due_date: $tax_due_date, type_approval: $type_approval, wheelplan: $wheelplan, co2_emissions: $co2_emissions, logo_url: $logo_url, mot_expiry: $mot_expiry, tax_status: $tax_status, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration)';
  }
