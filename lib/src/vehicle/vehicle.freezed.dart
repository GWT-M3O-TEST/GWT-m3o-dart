...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, make: $make, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, logo_url: $logo_url, mot_status: $mot_status, tax_status: $tax_status, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, colour: $colour, engine_capacity: $engine_capacity, fuel_type: $fuel_type, mot_expiry: $mot_expiry, registration: $registration, co2_emissions: $co2_emissions, type_approval: $type_approval)';
  }
