...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, mot_expiry: $mot_expiry, tax_status: $tax_status, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, registration: $registration, type_approval: $type_approval, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, colour: $colour, engine_capacity: $engine_capacity, make: $make, mot_status: $mot_status, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, tax_due_date: $tax_due_date)';
  }
