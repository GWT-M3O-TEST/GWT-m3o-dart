...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, mot_status: $mot_status, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, colour: $colour, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, tax_status: $tax_status, wheelplan: $wheelplan, make: $make, registration: $registration)';
  }
