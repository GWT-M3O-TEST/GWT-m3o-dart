...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, colour: $colour, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, tax_status: $tax_status, type_approval: $type_approval, mot_status: $mot_status, co2_emissions: $co2_emissions, logo_url: $logo_url, make: $make, tax_due_date: $tax_due_date, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, registration: $registration)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      String? month_of_first_registration,
      String? mot_expiry,
      String? registration}) = _$LookupResponseData;
