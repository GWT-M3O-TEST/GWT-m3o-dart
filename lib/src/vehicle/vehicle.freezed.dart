...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(colour: $colour, fuel_type: $fuel_type, year_of_manufacture: $year_of_manufacture, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date, wheelplan: $wheelplan, co2_emissions: $co2_emissions, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, registration: $registration, tax_status: $tax_status, engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, make: $make, mot_status: $mot_status, type_approval: $type_approval)';
  }
