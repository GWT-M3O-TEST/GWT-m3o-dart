...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_status: $mot_status, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, fuel_type: $fuel_type, make: $make, tax_status: $tax_status, colour: $colour, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, registration: $registration, tax_due_date: $tax_due_date, wheelplan: $wheelplan, co2_emissions: $co2_emissions, last_v5_issued: $last_v5_issued, mot_expiry: $mot_expiry, type_approval: $type_approval)';
  }
