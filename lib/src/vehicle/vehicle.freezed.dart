...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(make: $make, mot_status: $mot_status, last_v5_issued: $last_v5_issued, logo_url: $logo_url, type_approval: $type_approval, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, registration: $registration, tax_status: $tax_status, colour: $colour, engine_capacity: $engine_capacity, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, tax_due_date: $tax_due_date)';
  }
