...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(mot_status: $mot_status, tax_due_date: $tax_due_date, tax_status: $tax_status, co2_emissions: $co2_emissions, colour: $colour, mot_expiry: $mot_expiry, year_of_manufacture: $year_of_manufacture, type_approval: $type_approval, engine_capacity: $engine_capacity, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, make: $make, month_of_first_registration: $month_of_first_registration, registration: $registration, logo_url: $logo_url, wheelplan: $wheelplan)';
  }
