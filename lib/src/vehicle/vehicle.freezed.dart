...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(logo_url: $logo_url, mot_expiry: $mot_expiry, tax_status: $tax_status, co2_emissions: $co2_emissions, colour: $colour, fuel_type: $fuel_type, last_v5_issued: $last_v5_issued, engine_capacity: $engine_capacity, registration: $registration, tax_due_date: $tax_due_date, type_approval: $type_approval, make: $make, mot_status: $mot_status, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, month_of_first_registration: $month_of_first_registration)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      String? wheelplan,
      int? year_of_manufacture,
      String? month_of_first_registration}) = _$LookupResponseData;
