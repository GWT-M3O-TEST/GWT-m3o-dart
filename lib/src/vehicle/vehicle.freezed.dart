...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(engine_capacity: $engine_capacity, last_v5_issued: $last_v5_issued, make: $make, tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, colour: $colour, fuel_type: $fuel_type, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, tax_status: $tax_status, mot_status: $mot_status, registration: $registration, type_approval: $type_approval, co2_emissions: $co2_emissions, wheelplan: $wheelplan)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      String? type_approval,
      double? co2_emissions,
      String? wheelplan}) = _$LookupResponseData;
