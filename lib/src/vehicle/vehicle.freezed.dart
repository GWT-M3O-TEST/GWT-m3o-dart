...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, last_v5_issued: $last_v5_issued, logo_url: $logo_url, mot_status: $mot_status, co2_emissions: $co2_emissions, colour: $colour, engine_capacity: $engine_capacity, tax_due_date: $tax_due_date, wheelplan: $wheelplan, fuel_type: $fuel_type, make: $make, registration: $registration, tax_status: $tax_status, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture)';
  }
