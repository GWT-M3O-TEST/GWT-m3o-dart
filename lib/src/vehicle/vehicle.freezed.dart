...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(logo_url: $logo_url, make: $make, co2_emissions: $co2_emissions, engine_capacity: $engine_capacity, month_of_first_registration: $month_of_first_registration, registration: $registration, tax_status: $tax_status, fuel_type: $fuel_type, mot_expiry: $mot_expiry, mot_status: $mot_status, tax_due_date: $tax_due_date, wheelplan: $wheelplan, colour: $colour, last_v5_issued: $last_v5_issued, type_approval: $type_approval, year_of_manufacture: $year_of_manufacture)';
  }
