...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(month_of_first_registration: $month_of_first_registration, mot_expiry: $mot_expiry, tax_status: $tax_status, co2_emissions: $co2_emissions, colour: $colour, engine_capacity: $engine_capacity, make: $make, fuel_type: $fuel_type, logo_url: $logo_url, type_approval: $type_approval, wheelplan: $wheelplan, year_of_manufacture: $year_of_manufacture, last_v5_issued: $last_v5_issued, mot_status: $mot_status, registration: $registration, tax_due_date: $tax_due_date)';
  }
