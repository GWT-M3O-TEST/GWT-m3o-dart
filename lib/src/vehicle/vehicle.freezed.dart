...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, tax_due_date: $tax_due_date, type_approval: $type_approval, wheelplan: $wheelplan, last_v5_issued: $last_v5_issued, make: $make, year_of_manufacture: $year_of_manufacture, colour: $colour, engine_capacity: $engine_capacity, logo_url: $logo_url, mot_expiry: $mot_expiry, mot_status: $mot_status, registration: $registration, fuel_type: $fuel_type, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status)';
  }
