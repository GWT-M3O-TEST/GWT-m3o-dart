...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(last_v5_issued: $last_v5_issued, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, tax_due_date: $tax_due_date, tax_status: $tax_status, type_approval: $type_approval, fuel_type: $fuel_type, mot_expiry: $mot_expiry, mot_status: $mot_status, registration: $registration, make: $make, colour: $colour, year_of_manufacture: $year_of_manufacture, co2_emissions: $co2_emissions, wheelplan: $wheelplan, engine_capacity: $engine_capacity)';
  }
...
abstract class LookupResponseData implements LookupResponse {
  const factory LookupResponseData(
      ...
      double? co2_emissions,
      String? wheelplan,
      int? engine_capacity}) = _$LookupResponseData;
