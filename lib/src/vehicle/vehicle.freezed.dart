...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(make: $make, mot_status: $mot_status, year_of_manufacture: $year_of_manufacture, last_v5_issued: $last_v5_issued, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration, tax_status: $tax_status, type_approval: $type_approval, wheelplan: $wheelplan, fuel_type: $fuel_type, tax_due_date: $tax_due_date, co2_emissions: $co2_emissions, colour: $colour, engine_capacity: $engine_capacity, mot_expiry: $mot_expiry, registration: $registration)';
  }
