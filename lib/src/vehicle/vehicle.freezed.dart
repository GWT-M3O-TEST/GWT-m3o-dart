...
class _$LookupResponseData implements LookupResponseData {
  ...
  @override
  String toString() {
    return 'LookupResponse(co2_emissions: $co2_emissions, mot_status: $mot_status, wheelplan: $wheelplan, colour: $colour, make: $make, tax_status: $tax_status, tax_due_date: $tax_due_date, year_of_manufacture: $year_of_manufacture, engine_capacity: $engine_capacity, fuel_type: $fuel_type, mot_expiry: $mot_expiry, registration: $registration, type_approval: $type_approval, last_v5_issued: $last_v5_issued, logo_url: $logo_url, month_of_first_registration: $month_of_first_registration)';
  }
