...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, sunset: $sunset, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, sunrise: $sunrise, avg_temp_c: $avg_temp_c, date: $date, icon_url: $icon_url)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(region: $region, temp_c: $temp_c, wind_kph: $wind_kph, feels_like_f: $feels_like_f, location: $location, wind_direction: $wind_direction, cloud: $cloud, daytime: $daytime, latitude: $latitude, local_time: $local_time, timezone: $timezone, humidity: $humidity, icon_url: $icon_url, feels_like_c: $feels_like_c, longitude: $longitude, temp_f: $temp_f, wind_degree: $wind_degree, wind_mph: $wind_mph, condition: $condition, country: $country)';
  }
