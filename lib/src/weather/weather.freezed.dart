...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, date: $date, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, latitude: $latitude, temp_c: $temp_c, temp_f: $temp_f, wind_kph: $wind_kph, wind_mph: $wind_mph, cloud: $cloud, feels_like_c: $feels_like_c, local_time: $local_time, timezone: $timezone, condition: $condition, country: $country, feels_like_f: $feels_like_f, icon_url: $icon_url, longitude: $longitude, region: $region, wind_degree: $wind_degree, daytime: $daytime, location: $location, wind_direction: $wind_direction)';
  }
