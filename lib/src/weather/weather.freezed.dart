...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, icon_url: $icon_url, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, sunrise: $sunrise, avg_temp_c: $avg_temp_c, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c, sunset: $sunset, avg_temp_f: $avg_temp_f, condition: $condition, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(daytime: $daytime, wind_degree: $wind_degree, wind_direction: $wind_direction, local_time: $local_time, location: $location, temp_c: $temp_c, condition: $condition, country: $country, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, temp_f: $temp_f, wind_mph: $wind_mph, icon_url: $icon_url, region: $region, cloud: $cloud, latitude: $latitude, longitude: $longitude, timezone: $timezone, wind_kph: $wind_kph)';
  }
