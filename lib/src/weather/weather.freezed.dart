...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_f: $max_temp_f, sunset: $sunset, sunrise: $sunrise, will_it_rain: $will_it_rain, date: $date, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, wind_kph: $wind_kph, country: $country, icon_url: $icon_url, local_time: $local_time, timezone: $timezone, wind_mph: $wind_mph, cloud: $cloud, daytime: $daytime, humidity: $humidity, location: $location, longitude: $longitude, temp_f: $temp_f, wind_degree: $wind_degree, wind_direction: $wind_direction, latitude: $latitude, region: $region, temp_c: $temp_c)';
  }
