...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunrise: $sunrise, condition: $condition, date: $date, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, icon_url: $icon_url, max_wind_mph: $max_wind_mph, avg_temp_f: $avg_temp_f, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, sunset: $sunset, chance_of_rain: $chance_of_rain, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, feels_like_c: $feels_like_c, humidity: $humidity, latitude: $latitude, cloud: $cloud, daytime: $daytime, location: $location, temp_f: $temp_f, timezone: $timezone, wind_direction: $wind_direction, condition: $condition, icon_url: $icon_url, local_time: $local_time, wind_degree: $wind_degree, wind_mph: $wind_mph, feels_like_f: $feels_like_f, region: $region, temp_c: $temp_c, wind_kph: $wind_kph, longitude: $longitude)';
  }
