...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_c: $min_temp_c, sunrise: $sunrise, min_temp_f: $min_temp_f, sunset: $sunset, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_f: $max_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, date: $date)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(latitude: $latitude, local_time: $local_time, region: $region, temp_f: $temp_f, wind_degree: $wind_degree, cloud: $cloud, daytime: $daytime, longitude: $longitude, wind_mph: $wind_mph, feels_like_f: $feels_like_f, icon_url: $icon_url, temp_c: $temp_c, wind_direction: $wind_direction, wind_kph: $wind_kph, condition: $condition, country: $country, feels_like_c: $feels_like_c, humidity: $humidity, location: $location, timezone: $timezone)';
  }
