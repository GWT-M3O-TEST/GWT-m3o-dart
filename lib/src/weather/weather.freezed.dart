...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, condition: $condition, max_wind_kph: $max_wind_kph, date: $date, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, sunset: $sunset, will_it_rain: $will_it_rain, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(condition: $condition, latitude: $latitude, location: $location, temp_f: $temp_f, wind_direction: $wind_direction, wind_kph: $wind_kph, icon_url: $icon_url, local_time: $local_time, cloud: $cloud, country: $country, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, humidity: $humidity, longitude: $longitude, timezone: $timezone, daytime: $daytime, region: $region, temp_c: $temp_c, wind_degree: $wind_degree, wind_mph: $wind_mph)';
  }
