...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, sunset: $sunset, avg_temp_c: $avg_temp_c, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, date: $date, sunrise: $sunrise, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, min_temp_c: $min_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(icon_url: $icon_url, latitude: $latitude, wind_direction: $wind_direction, wind_mph: $wind_mph, humidity: $humidity, daytime: $daytime, feels_like_c: $feels_like_c, longitude: $longitude, region: $region, temp_c: $temp_c, temp_f: $temp_f, timezone: $timezone, condition: $condition, feels_like_f: $feels_like_f, local_time: $local_time, wind_kph: $wind_kph, cloud: $cloud, location: $location, wind_degree: $wind_degree, country: $country)';
  }
