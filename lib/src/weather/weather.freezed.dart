...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, condition: $condition, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, sunrise: $sunrise, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, sunset: $sunset, chance_of_rain: $chance_of_rain)';
  }
...
abstract class _Forecast implements Forecast {
  const factory _Forecast(
      ...
      double? max_wind_mph,
      String? sunset,
      int? chance_of_rain}) = _$_Forecast;
...
abstract class ForecastResponseData implements ForecastResponse {
  const factory ForecastResponseData(
      ...
      String? local_time,
      String? location,
      double? longitude}) = _$ForecastResponseData;
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, local_time: $local_time, temp_c: $temp_c, cloud: $cloud, country: $country, feels_like_f: $feels_like_f, icon_url: $icon_url, timezone: $timezone, condition: $condition, location: $location, region: $region, temp_f: $temp_f, wind_direction: $wind_direction, wind_kph: $wind_kph, feels_like_c: $feels_like_c, latitude: $latitude, longitude: $longitude, wind_degree: $wind_degree, wind_mph: $wind_mph, daytime: $daytime)';
  }
...
abstract class NowResponseData implements NowResponse {
  const factory NowResponseData(
      ...
      int? wind_degree,
      double? wind_mph,
      bool? daytime}) = _$NowResponseData;
