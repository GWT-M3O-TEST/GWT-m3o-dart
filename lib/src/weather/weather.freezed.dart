...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, date: $date, max_temp_f: $max_temp_f, condition: $condition, max_temp_c: $max_temp_c, sunrise: $sunrise, sunset: $sunset, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, region: $region, temp_f: $temp_f, wind_mph: $wind_mph, country: $country, icon_url: $icon_url, longitude: $longitude, cloud: $cloud, feels_like_c: $feels_like_c, latitude: $latitude, local_time: $local_time, location: $location, temp_c: $temp_c, timezone: $timezone, wind_direction: $wind_direction, condition: $condition, feels_like_f: $feels_like_f, wind_degree: $wind_degree, wind_kph: $wind_kph, daytime: $daytime)';
  }
