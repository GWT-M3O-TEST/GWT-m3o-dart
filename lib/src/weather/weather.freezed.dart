...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, sunrise: $sunrise, will_it_rain: $will_it_rain, icon_url: $icon_url, condition: $condition, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, sunset: $sunset, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, date: $date, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, location: $location, longitude: $longitude, temp_f: $temp_f, timezone: $timezone, wind_kph: $wind_kph, wind_mph: $wind_mph, condition: $condition, feels_like_c: $feels_like_c, daytime: $daytime, region: $region, temp_c: $temp_c, wind_degree: $wind_degree, country: $country, latitude: $latitude, local_time: $local_time, wind_direction: $wind_direction)';
  }
