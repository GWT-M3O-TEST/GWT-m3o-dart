...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, condition: $condition, max_wind_kph: $max_wind_kph, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c, sunrise: $sunrise, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_mph: $wind_mph, longitude: $longitude, temp_c: $temp_c, temp_f: $temp_f, wind_kph: $wind_kph, wind_degree: $wind_degree, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, location: $location, region: $region, latitude: $latitude, timezone: $timezone, wind_direction: $wind_direction, cloud: $cloud, condition: $condition, country: $country, humidity: $humidity, daytime: $daytime, icon_url: $icon_url, local_time: $local_time)';
  }
...
abstract class NowResponseData implements NowResponse {
  const factory NowResponseData(
      ...
      bool? daytime,
      String? icon_url,
      String? local_time}) = _$NowResponseData;
