...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(min_temp_f: $min_temp_f, sunrise: $sunrise, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, max_temp_f: $max_temp_f, sunset: $sunset, date: $date, max_temp_c: $max_temp_c, chance_of_rain: $chance_of_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, condition: $condition, icon_url: $icon_url)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(local_time: $local_time, temp_f: $temp_f, wind_degree: $wind_degree, condition: $condition, humidity: $humidity, latitude: $latitude, timezone: $timezone, wind_direction: $wind_direction, wind_kph: $wind_kph, daytime: $daytime, feels_like_f: $feels_like_f, icon_url: $icon_url, longitude: $longitude, region: $region, wind_mph: $wind_mph, cloud: $cloud, country: $country, feels_like_c: $feels_like_c, location: $location, temp_c: $temp_c)';
  }
