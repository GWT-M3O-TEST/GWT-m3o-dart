...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunrise: $sunrise, avg_temp_c: $avg_temp_c, condition: $condition, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunset: $sunset, chance_of_rain: $chance_of_rain, date: $date)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(region: $region, temp_c: $temp_c, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_mph: $wind_mph, cloud: $cloud, icon_url: $icon_url, location: $location, wind_kph: $wind_kph, country: $country, local_time: $local_time, feels_like_c: $feels_like_c, latitude: $latitude, temp_f: $temp_f, condition: $condition, daytime: $daytime, longitude: $longitude, timezone: $timezone, feels_like_f: $feels_like_f, humidity: $humidity)';
  }
