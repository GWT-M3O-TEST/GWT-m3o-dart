...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, sunrise: $sunrise, date: $date, max_temp_c: $max_temp_c, min_temp_f: $min_temp_f, min_temp_c: $min_temp_c, sunset: $sunset, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, condition: $condition)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, region: $region, location: $location, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_kph: $wind_kph, cloud: $cloud, condition: $condition, daytime: $daytime, longitude: $longitude, temp_f: $temp_f, wind_mph: $wind_mph, country: $country, humidity: $humidity, icon_url: $icon_url, timezone: $timezone, latitude: $latitude, local_time: $local_time, temp_c: $temp_c)';
  }
