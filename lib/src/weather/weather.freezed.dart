...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, max_temp_c: $max_temp_c, min_temp_f: $min_temp_f, sunrise: $sunrise, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, date: $date, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, condition: $condition, max_wind_mph: $max_wind_mph, avg_temp_c: $avg_temp_c, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_degree: $wind_degree, feels_like_f: $feels_like_f, latitude: $latitude, longitude: $longitude, temp_c: $temp_c, wind_kph: $wind_kph, wind_mph: $wind_mph, feels_like_c: $feels_like_c, icon_url: $icon_url, region: $region, wind_direction: $wind_direction, cloud: $cloud, country: $country, location: $location, timezone: $timezone, temp_f: $temp_f, condition: $condition, daytime: $daytime, humidity: $humidity, local_time: $local_time)';
  }
