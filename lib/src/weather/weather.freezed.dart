...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_c: $max_temp_c, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, sunrise: $sunrise, will_it_rain: $will_it_rain, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunset: $sunset, chance_of_rain: $chance_of_rain, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, condition: $condition, date: $date)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, feels_like_c: $feels_like_c, local_time: $local_time, temp_f: $temp_f, humidity: $humidity, latitude: $latitude, longitude: $longitude, region: $region, wind_direction: $wind_direction, cloud: $cloud, condition: $condition, daytime: $daytime, feels_like_f: $feels_like_f, icon_url: $icon_url, location: $location, timezone: $timezone, wind_mph: $wind_mph, temp_c: $temp_c, wind_degree: $wind_degree, wind_kph: $wind_kph)';
  }
...
abstract class NowResponseData implements NowResponse {
  const factory NowResponseData(
      ...
      double? temp_c,
      int? wind_degree,
      double? wind_kph}) = _$NowResponseData;
