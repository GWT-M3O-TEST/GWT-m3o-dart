...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, chance_of_rain: $chance_of_rain, min_temp_f: $min_temp_f, sunrise: $sunrise, date: $date, sunset: $sunset, avg_temp_f: $avg_temp_f, condition: $condition, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c)';
  }
...
abstract class ForecastResponseData implements ForecastResponse {
  const factory ForecastResponseData(
      ...
      String? location,
      double? longitude,
      String? region}) = _$ForecastResponseData;
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(location: $location, region: $region, temp_c: $temp_c, wind_direction: $wind_direction, cloud: $cloud, icon_url: $icon_url, longitude: $longitude, timezone: $timezone, wind_mph: $wind_mph, daytime: $daytime, humidity: $humidity, local_time: $local_time, temp_f: $temp_f, condition: $condition, feels_like_f: $feels_like_f, latitude: $latitude, wind_degree: $wind_degree, wind_kph: $wind_kph, country: $country, feels_like_c: $feels_like_c)';
  }
...
abstract class NowResponseData implements NowResponse {
  const factory NowResponseData(
      ...
      double? wind_kph,
      String? country,
      double? feels_like_c}) = _$NowResponseData;
