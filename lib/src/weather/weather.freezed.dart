...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, icon_url: $icon_url, min_temp_c: $min_temp_c, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, date: $date, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, will_it_rain: $will_it_rain, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, sunrise: $sunrise, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_degree: $wind_degree, cloud: $cloud, condition: $condition, country: $country, humidity: $humidity, latitude: $latitude, local_time: $local_time, temp_f: $temp_f, daytime: $daytime, longitude: $longitude, wind_kph: $wind_kph, feels_like_f: $feels_like_f, location: $location, temp_c: $temp_c, timezone: $timezone, wind_direction: $wind_direction, feels_like_c: $feels_like_c, icon_url: $icon_url, region: $region, wind_mph: $wind_mph)';
  }
