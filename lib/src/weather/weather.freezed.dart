...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(icon_url: $icon_url, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, condition: $condition, avg_temp_f: $avg_temp_f, date: $date, max_wind_kph: $max_wind_kph, avg_temp_c: $avg_temp_c, sunrise: $sunrise, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunset: $sunset, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_degree: $wind_degree, country: $country, feels_like_c: $feels_like_c, humidity: $humidity, icon_url: $icon_url, longitude: $longitude, timezone: $timezone, daytime: $daytime, region: $region, temp_f: $temp_f, wind_direction: $wind_direction, wind_kph: $wind_kph, wind_mph: $wind_mph, condition: $condition, feels_like_f: $feels_like_f, local_time: $local_time, location: $location, temp_c: $temp_c, cloud: $cloud, latitude: $latitude)';
  }
