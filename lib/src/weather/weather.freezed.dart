...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, date: $date, max_wind_kph: $max_wind_kph, condition: $condition, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, sunset: $sunset, avg_temp_c: $avg_temp_c, icon_url: $icon_url, sunrise: $sunrise, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(humidity: $humidity, local_time: $local_time, region: $region, wind_direction: $wind_direction, wind_kph: $wind_kph, condition: $condition, feels_like_c: $feels_like_c, icon_url: $icon_url, location: $location, temp_c: $temp_c, timezone: $timezone, wind_degree: $wind_degree, country: $country, wind_mph: $wind_mph, cloud: $cloud, daytime: $daytime, feels_like_f: $feels_like_f, latitude: $latitude, longitude: $longitude, temp_f: $temp_f)';
  }
