...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunrise: $sunrise, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, min_temp_c: $min_temp_c, sunset: $sunset, condition: $condition, date: $date, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_mph: $wind_mph, cloud: $cloud, feels_like_c: $feels_like_c, humidity: $humidity, location: $location, timezone: $timezone, wind_kph: $wind_kph, daytime: $daytime, feels_like_f: $feels_like_f, longitude: $longitude, temp_c: $temp_c, latitude: $latitude, temp_f: $temp_f, wind_direction: $wind_direction, condition: $condition, country: $country, icon_url: $icon_url, local_time: $local_time, region: $region, wind_degree: $wind_degree)';
  }
