...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, sunrise: $sunrise, condition: $condition, min_temp_f: $min_temp_f, will_it_rain: $will_it_rain, max_wind_mph: $max_wind_mph, chance_of_rain: $chance_of_rain, avg_temp_c: $avg_temp_c, icon_url: $icon_url, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, sunset: $sunset, avg_temp_f: $avg_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(local_time: $local_time, location: $location, longitude: $longitude, region: $region, temp_c: $temp_c, timezone: $timezone, wind_mph: $wind_mph, country: $country, icon_url: $icon_url, temp_f: $temp_f, wind_kph: $wind_kph, cloud: $cloud, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, condition: $condition, daytime: $daytime, humidity: $humidity, latitude: $latitude, wind_degree: $wind_degree, wind_direction: $wind_direction)';
  }
