...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunrise: $sunrise, avg_temp_f: $avg_temp_f, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, sunset: $sunset, avg_temp_c: $avg_temp_c, date: $date, icon_url: $icon_url, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, country: $country, feels_like_f: $feels_like_f, icon_url: $icon_url, temp_c: $temp_c, wind_kph: $wind_kph, daytime: $daytime, feels_like_c: $feels_like_c, local_time: $local_time, temp_f: $temp_f, condition: $condition, region: $region, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_mph: $wind_mph, humidity: $humidity, latitude: $latitude, location: $location, longitude: $longitude, timezone: $timezone)';
  }
