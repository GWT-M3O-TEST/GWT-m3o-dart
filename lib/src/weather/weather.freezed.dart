...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain, condition: $condition, chance_of_rain: $chance_of_rain, date: $date, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, avg_temp_f: $avg_temp_f, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, feels_like_f: $feels_like_f, local_time: $local_time, wind_kph: $wind_kph, region: $region, condition: $condition, daytime: $daytime, humidity: $humidity, icon_url: $icon_url, latitude: $latitude, location: $location, longitude: $longitude, temp_c: $temp_c, timezone: $timezone, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_mph: $wind_mph, country: $country, feels_like_c: $feels_like_c, temp_f: $temp_f)';
  }
