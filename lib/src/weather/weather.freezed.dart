...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, sunset: $sunset, condition: $condition, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f, avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, date: $date, icon_url: $icon_url, sunrise: $sunrise)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(timezone: $timezone, wind_degree: $wind_degree, feels_like_c: $feels_like_c, latitude: $latitude, region: $region, wind_direction: $wind_direction, wind_kph: $wind_kph, wind_mph: $wind_mph, country: $country, daytime: $daytime, local_time: $local_time, location: $location, temp_f: $temp_f, cloud: $cloud, condition: $condition, feels_like_f: $feels_like_f, humidity: $humidity, icon_url: $icon_url, longitude: $longitude, temp_c: $temp_c)';
  }
