...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(condition: $condition, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, sunset: $sunset, avg_temp_c: $avg_temp_c, min_temp_c: $min_temp_c, chance_of_rain: $chance_of_rain, max_temp_c: $max_temp_c, sunrise: $sunrise, will_it_rain: $will_it_rain, date: $date)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(local_time: $local_time, timezone: $timezone, cloud: $cloud, country: $country, icon_url: $icon_url, temp_c: $temp_c, temp_f: $temp_f, wind_mph: $wind_mph, condition: $condition, daytime: $daytime, latitude: $latitude, longitude: $longitude, region: $region, wind_degree: $wind_degree, wind_direction: $wind_direction, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, wind_kph: $wind_kph, humidity: $humidity, location: $location)';
  }
...
abstract class NowResponseData implements NowResponse {
  const factory NowResponseData(
      ...
      double? wind_kph,
      int? humidity,
      String? location}) = _$NowResponseData;
