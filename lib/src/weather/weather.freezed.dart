...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, date: $date, max_temp_c: $max_temp_c, max_wind_mph: $max_wind_mph, sunrise: $sunrise, will_it_rain: $will_it_rain, min_temp_f: $min_temp_f, avg_temp_f: $avg_temp_f, condition: $condition, max_temp_f: $max_temp_f, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(cloud: $cloud, feels_like_f: $feels_like_f, temp_c: $temp_c, wind_degree: $wind_degree, wind_direction: $wind_direction, wind_kph: $wind_kph, wind_mph: $wind_mph, country: $country, local_time: $local_time, temp_f: $temp_f, condition: $condition, daytime: $daytime, feels_like_c: $feels_like_c, humidity: $humidity, latitude: $latitude, longitude: $longitude, icon_url: $icon_url, location: $location, region: $region, timezone: $timezone)';
  }
