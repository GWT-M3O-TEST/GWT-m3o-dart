...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_temp_f: $max_temp_f, min_temp_c: $min_temp_c, sunrise: $sunrise, date: $date, icon_url: $icon_url, sunset: $sunset, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(local_time: $local_time, temp_c: $temp_c, wind_degree: $wind_degree, feels_like_f: $feels_like_f, icon_url: $icon_url, location: $location, wind_mph: $wind_mph, cloud: $cloud, country: $country, feels_like_c: $feels_like_c, latitude: $latitude, temp_f: $temp_f, timezone: $timezone, wind_direction: $wind_direction, condition: $condition, daytime: $daytime, humidity: $humidity, longitude: $longitude, region: $region, wind_kph: $wind_kph)';
  }
