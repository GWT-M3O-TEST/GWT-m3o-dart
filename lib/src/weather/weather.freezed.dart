...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(max_wind_kph: $max_wind_kph, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, chance_of_rain: $chance_of_rain, icon_url: $icon_url, min_temp_c: $min_temp_c, avg_temp_c: $avg_temp_c, date: $date, sunrise: $sunrise, sunset: $sunset, avg_temp_f: $avg_temp_f, condition: $condition, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(daytime: $daytime, longitude: $longitude, region: $region, humidity: $humidity, icon_url: $icon_url, wind_mph: $wind_mph, wind_direction: $wind_direction, wind_kph: $wind_kph, cloud: $cloud, location: $location, temp_f: $temp_f, timezone: $timezone, wind_degree: $wind_degree, local_time: $local_time, temp_c: $temp_c, condition: $condition, country: $country, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, latitude: $latitude)';
  }
