...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(date: $date, avg_temp_c: $avg_temp_c, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_temp_c: $max_temp_c, min_temp_f: $min_temp_f, avg_temp_f: $avg_temp_f, condition: $condition, max_wind_kph: $max_wind_kph, sunrise: $sunrise, sunset: $sunset, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(wind_direction: $wind_direction, cloud: $cloud, feels_like_f: $feels_like_f, local_time: $local_time, location: $location, temp_c: $temp_c, timezone: $timezone, wind_degree: $wind_degree, wind_kph: $wind_kph, feels_like_c: $feels_like_c, humidity: $humidity, latitude: $latitude, region: $region, wind_mph: $wind_mph, condition: $condition, daytime: $daytime, icon_url: $icon_url, temp_f: $temp_f, country: $country, longitude: $longitude)';
  }
