...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, condition: $condition, max_temp_f: $max_temp_f, sunrise: $sunrise, avg_temp_f: $avg_temp_f, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, sunset: $sunset, will_it_rain: $will_it_rain, avg_temp_c: $avg_temp_c, icon_url: $icon_url, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, date: $date, min_temp_f: $min_temp_f)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, humidity: $humidity, latitude: $latitude, region: $region, wind_direction: $wind_direction, wind_kph: $wind_kph, condition: $condition, local_time: $local_time, temp_f: $temp_f, timezone: $timezone, wind_mph: $wind_mph, cloud: $cloud, daytime: $daytime, feels_like_c: $feels_like_c, icon_url: $icon_url, location: $location, longitude: $longitude, wind_degree: $wind_degree, feels_like_f: $feels_like_f, temp_c: $temp_c)';
  }
