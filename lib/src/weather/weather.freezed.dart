...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(chance_of_rain: $chance_of_rain, icon_url: $icon_url, max_wind_mph: $max_wind_mph, avg_temp_c: $avg_temp_c, min_temp_f: $min_temp_f, max_temp_c: $max_temp_c, max_wind_kph: $max_wind_kph, min_temp_c: $min_temp_c, will_it_rain: $will_it_rain, avg_temp_f: $avg_temp_f, condition: $condition, date: $date, max_temp_f: $max_temp_f, sunrise: $sunrise, sunset: $sunset)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(country: $country, humidity: $humidity, wind_degree: $wind_degree, wind_kph: $wind_kph, cloud: $cloud, condition: $condition, icon_url: $icon_url, local_time: $local_time, temp_f: $temp_f, daytime: $daytime, location: $location, temp_c: $temp_c, wind_mph: $wind_mph, feels_like_c: $feels_like_c, feels_like_f: $feels_like_f, latitude: $latitude, longitude: $longitude, region: $region, timezone: $timezone, wind_direction: $wind_direction)';
  }
