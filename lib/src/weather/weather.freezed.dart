...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunset: $sunset, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_mph: $max_wind_mph, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, condition: $condition, max_temp_c: $max_temp_c, min_temp_c: $min_temp_c, sunrise: $sunrise, avg_temp_c: $avg_temp_c, date: $date, max_wind_kph: $max_wind_kph, will_it_rain: $will_it_rain)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(daytime: $daytime, latitude: $latitude, local_time: $local_time, location: $location, longitude: $longitude, temp_f: $temp_f, wind_kph: $wind_kph, wind_mph: $wind_mph, country: $country, feels_like_f: $feels_like_f, region: $region, temp_c: $temp_c, timezone: $timezone, cloud: $cloud, condition: $condition, icon_url: $icon_url, wind_direction: $wind_direction, feels_like_c: $feels_like_c, humidity: $humidity, wind_degree: $wind_degree)';
  }
