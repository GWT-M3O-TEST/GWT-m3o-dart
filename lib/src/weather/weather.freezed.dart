...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(avg_temp_c: $avg_temp_c, chance_of_rain: $chance_of_rain, condition: $condition, max_wind_mph: $max_wind_mph, will_it_rain: $will_it_rain, min_temp_c: $min_temp_c, sunset: $sunset, icon_url: $icon_url, max_temp_f: $max_temp_f, max_wind_kph: $max_wind_kph, min_temp_f: $min_temp_f, sunrise: $sunrise, avg_temp_f: $avg_temp_f, date: $date, max_temp_c: $max_temp_c)';
  }
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(icon_url: $icon_url, wind_direction: $wind_direction, condition: $condition, country: $country, feels_like_c: $feels_like_c, timezone: $timezone, latitude: $latitude, local_time: $local_time, location: $location, temp_c: $temp_c, wind_kph: $wind_kph, wind_mph: $wind_mph, daytime: $daytime, feels_like_f: $feels_like_f, longitude: $longitude, region: $region, temp_f: $temp_f, wind_degree: $wind_degree, cloud: $cloud, humidity: $humidity)';
  }
...
abstract class NowResponseData implements NowResponse {
  const factory NowResponseData(
      ...
      int? wind_degree,
      int? cloud,
      int? humidity}) = _$NowResponseData;
