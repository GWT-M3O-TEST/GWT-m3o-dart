...
class _$_Forecast implements _Forecast {
  ...
  @override
  String toString() {
    return 'Forecast(sunset: $sunset, avg_temp_c: $avg_temp_c, avg_temp_f: $avg_temp_f, icon_url: $icon_url, max_temp_c: $max_temp_c, max_temp_f: $max_temp_f, sunrise: $sunrise, will_it_rain: $will_it_rain, condition: $condition, max_wind_mph: $max_wind_mph, min_temp_c: $min_temp_c, min_temp_f: $min_temp_f, chance_of_rain: $chance_of_rain, date: $date, max_wind_kph: $max_wind_kph)';
  }
...
abstract class _Forecast implements Forecast {
  const factory _Forecast(
      ...
      int? chance_of_rain,
      String? date,
      double? max_wind_kph}) = _$_Forecast;
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(temp_f: $temp_f, wind_direction: $wind_direction, condition: $condition, temp_c: $temp_c, feels_like_f: $feels_like_f, icon_url: $icon_url, region: $region, wind_degree: $wind_degree, wind_mph: $wind_mph, country: $country, feels_like_c: $feels_like_c, latitude: $latitude, local_time: $local_time, longitude: $longitude, wind_kph: $wind_kph, cloud: $cloud, daytime: $daytime, timezone: $timezone, humidity: $humidity, location: $location)';
  }
