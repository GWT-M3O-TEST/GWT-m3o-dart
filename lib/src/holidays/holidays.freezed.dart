...
class _$ListRequestTearOff {
  ...
  _ListRequest call({int? year, String? country_code}) {
    return _ListRequest(
      year: year,
      country_code: country_code,
    );
...
abstract class $ListRequestCopyWith<$Res> {
  ...
  $Res call({int? year, String? country_code});
}
...
class _$_ListRequest implements _ListRequest {
  const _$_ListRequest({this.year, this.country_code});
...
abstract class _ListRequest implements ListRequest {
  const factory _ListRequest({int? year, String? country_code}) =
      _$_ListRequest;
