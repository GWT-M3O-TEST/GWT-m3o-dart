...
class _$ListRequestTearOff {
  ...
  _ListRequest call({String? country_code, int? year}) {
    return _ListRequest(
      country_code: country_code,
      year: year,
    );
...
abstract class $ListRequestCopyWith<$Res> {
  ...
  $Res call({String? country_code, int? year});
}
...
class _$_ListRequest implements _ListRequest {
  const _$_ListRequest({this.country_code, this.year});
...
abstract class _ListRequest implements ListRequest {
  const factory _ListRequest({String? country_code, int? year}) =
      _$_ListRequest;
