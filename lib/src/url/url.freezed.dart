...
class _$URLPairTearOff {
  ...
  _URLPair call({String? shortURL, String? created, String? destinationURL}) {
    return _URLPair(
      shortURL: shortURL,
      created: created,
      destinationURL: destinationURL,
...
abstract class $URLPairCopyWith<$Res> {
  ...
  $Res call({String? shortURL, String? created, String? destinationURL});
}
...
class _$_URLPair implements _URLPair {
  const _$_URLPair({this.shortURL, this.created, this.destinationURL});
  ...
  @override
  String toString() {
    return 'URLPair(shortURL: $shortURL, created: $created, destinationURL: $destinationURL)';
  }
...
abstract class _URLPair implements URLPair {
  const factory _URLPair(
      {String? shortURL, String? created, String? destinationURL}) = _$_URLPair;
