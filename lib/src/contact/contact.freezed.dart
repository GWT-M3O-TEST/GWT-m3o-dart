...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(updated_at: $updated_at, addresses: $addresses, created_at: $created_at, note: $note, links: $links, name: $name, phones: $phones, social_medias: $social_medias, birthday: $birthday, emails: $emails, id: $id)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, emails: $emails, id: $id, name: $name, phones: $phones, social_medias: $social_medias, birthday: $birthday, links: $links, note: $note)';
  }
