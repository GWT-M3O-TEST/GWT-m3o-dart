...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(name: $name, phones: $phones, social_medias: $social_medias, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, links: $links, note: $note, updated_at: $updated_at, addresses: $addresses)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, id: $id, note: $note, birthday: $birthday, emails: $emails, links: $links, name: $name, phones: $phones, social_medias: $social_medias)';
  }
