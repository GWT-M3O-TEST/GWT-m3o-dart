...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, name: $name, phones: $phones, addresses: $addresses, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, note: $note, social_medias: $social_medias, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, id: $id, links: $links, note: $note, addresses: $addresses, emails: $emails, name: $name, phones: $phones, social_medias: $social_medias)';
  }
