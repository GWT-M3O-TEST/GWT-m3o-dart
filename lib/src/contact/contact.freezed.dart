...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(updated_at: $updated_at, addresses: $addresses, created_at: $created_at, id: $id, links: $links, name: $name, birthday: $birthday, emails: $emails, note: $note, phones: $phones, social_medias: $social_medias)';
  }
...
abstract class _ContactInfo implements ContactInfo {
  const factory _ContactInfo(
      ...
      String? note,
      List<Phone>? phones,
      List<SocialMedia>? social_medias}) = _$_ContactInfo;
...
class _$_CreateRequest implements _CreateRequest {
  ...
  @override
  String toString() {
    return 'CreateRequest(social_medias: $social_medias, addresses: $addresses, birthday: $birthday, emails: $emails, links: $links, name: $name, note: $note, phones: $phones)';
  }
...
abstract class _CreateRequest implements CreateRequest {
  const factory _CreateRequest(
      ...
      String? name,
      String? note,
      List<Phone>? phones}) = _$_CreateRequest;
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(name: $name, note: $note, addresses: $addresses, birthday: $birthday, links: $links, phones: $phones, social_medias: $social_medias, emails: $emails, id: $id)';
  }
