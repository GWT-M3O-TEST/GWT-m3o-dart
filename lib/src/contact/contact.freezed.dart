...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(updated_at: $updated_at, created_at: $created_at, links: $links, name: $name, note: $note, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, emails: $emails, id: $id, phones: $phones)';
  }
...
abstract class _ContactInfo implements ContactInfo {
  const factory _ContactInfo(
      ...
      List<Email>? emails,
      String? id,
      List<Phone>? phones}) = _$_ContactInfo;
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, emails: $emails, note: $note, phones: $phones, social_medias: $social_medias, birthday: $birthday, id: $id, links: $links, name: $name)';
  }
