...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, note: $note, social_medias: $social_medias, created_at: $created_at, emails: $emails, id: $id, name: $name, phones: $phones, updated_at: $updated_at, addresses: $addresses, birthday: $birthday)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(social_medias: $social_medias, emails: $emails, id: $id, links: $links, name: $name, note: $note, phones: $phones, addresses: $addresses, birthday: $birthday)';
  }
