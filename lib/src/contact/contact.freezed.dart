...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(phones: $phones, social_medias: $social_medias, updated_at: $updated_at, birthday: $birthday, created_at: $created_at, id: $id, links: $links, addresses: $addresses, emails: $emails, name: $name, note: $note)';
  }
...
class _$_CreateRequest implements _CreateRequest {
  ...
  @override
  String toString() {
    return 'CreateRequest(name: $name, note: $note, phones: $phones, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, emails: $emails, links: $links)';
  }
...
abstract class _CreateRequest implements CreateRequest {
  const factory _CreateRequest(
      ...
      String? birthday,
      List<Email>? emails,
      List<Link>? links}) = _$_CreateRequest;
...
class _$SocialMediaTearOff {
  ...
  _SocialMedia call({String? username, String? label}) {
    return _SocialMedia(
      username: username,
      label: label,
    );
...
abstract class _SocialMedia implements SocialMedia {
  const factory _SocialMedia({String? username, String? label}) =
      _$_SocialMedia;
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, name: $name, addresses: $addresses, emails: $emails, id: $id, social_medias: $social_medias, birthday: $birthday, note: $note, phones: $phones)';
  }
...
abstract class _UpdateRequest implements UpdateRequest {
  const factory _UpdateRequest(
      ...
      String? birthday,
      String? note,
      List<Phone>? phones}) = _$_UpdateRequest;
