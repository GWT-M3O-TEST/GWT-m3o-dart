...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, id: $id, emails: $emails, links: $links, name: $name, note: $note, phones: $phones, social_medias: $social_medias, birthday: $birthday, created_at: $created_at, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(name: $name, note: $note, phones: $phones, emails: $emails, id: $id, links: $links, addresses: $addresses, birthday: $birthday, social_medias: $social_medias)';
  }
