...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(social_medias: $social_medias, addresses: $addresses, created_at: $created_at, id: $id, name: $name, phones: $phones, birthday: $birthday, emails: $emails, links: $links, note: $note, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(emails: $emails, social_medias: $social_medias, links: $links, name: $name, note: $note, phones: $phones, addresses: $addresses, birthday: $birthday, id: $id)';
  }
