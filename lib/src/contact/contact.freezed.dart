...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, created_at: $created_at, emails: $emails, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, id: $id, links: $links, name: $name, note: $note)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(note: $note, id: $id, links: $links, emails: $emails, name: $name, phones: $phones, social_medias: $social_medias, addresses: $addresses, birthday: $birthday)';
  }
