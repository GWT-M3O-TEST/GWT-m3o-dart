...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, created_at: $created_at, links: $links, phones: $phones, note: $note, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, emails: $emails, id: $id, name: $name)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(id: $id, links: $links, note: $note, addresses: $addresses, birthday: $birthday, emails: $emails, name: $name, phones: $phones, social_medias: $social_medias)';
  }
