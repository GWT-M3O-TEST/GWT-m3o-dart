...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(name: $name, phones: $phones, addresses: $addresses, created_at: $created_at, id: $id, links: $links, note: $note, social_medias: $social_medias, updated_at: $updated_at, birthday: $birthday, emails: $emails)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(social_medias: $social_medias, addresses: $addresses, birthday: $birthday, emails: $emails, id: $id, note: $note, phones: $phones, links: $links, name: $name)';
  }
