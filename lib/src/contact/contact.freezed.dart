...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, emails: $emails, links: $links, note: $note, updated_at: $updated_at, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, id: $id, name: $name, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, emails: $emails, links: $links, phones: $phones, id: $id, name: $name, note: $note, social_medias: $social_medias)';
  }
