...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(name: $name, phones: $phones, addresses: $addresses, birthday: $birthday, emails: $emails, id: $id, links: $links, created_at: $created_at, note: $note, social_medias: $social_medias, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, emails: $emails, id: $id, name: $name, birthday: $birthday, links: $links, note: $note, phones: $phones, social_medias: $social_medias)';
  }
