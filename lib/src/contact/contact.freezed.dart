...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, birthday: $birthday, created_at: $created_at, id: $id, links: $links, phones: $phones, updated_at: $updated_at, emails: $emails, name: $name, note: $note, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, links: $links, social_medias: $social_medias, name: $name, note: $note, phones: $phones, addresses: $addresses, emails: $emails, id: $id)';
  }
