...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, emails: $emails, name: $name, note: $note, phones: $phones, social_medias: $social_medias, birthday: $birthday, id: $id, links: $links)';
  }
