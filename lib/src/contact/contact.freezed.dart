...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, name: $name, updated_at: $updated_at, social_medias: $social_medias, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, links: $links, note: $note, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, note: $note, social_medias: $social_medias, birthday: $birthday, emails: $emails, id: $id, links: $links, name: $name, phones: $phones)';
  }
