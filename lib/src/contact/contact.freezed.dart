...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, created_at: $created_at, id: $id, links: $links, name: $name, note: $note, phones: $phones, birthday: $birthday, emails: $emails, social_medias: $social_medias, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, links: $links, note: $note, phones: $phones, addresses: $addresses, id: $id, name: $name, social_medias: $social_medias, emails: $emails)';
  }
