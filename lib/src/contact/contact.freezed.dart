...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(id: $id, links: $links, social_medias: $social_medias, created_at: $created_at, emails: $emails, name: $name, note: $note, phones: $phones, updated_at: $updated_at, addresses: $addresses, birthday: $birthday)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, phones: $phones, birthday: $birthday, emails: $emails, name: $name, note: $note, social_medias: $social_medias, addresses: $addresses, id: $id)';
  }
