...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, name: $name, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, created_at: $created_at, id: $id, emails: $emails, note: $note, addresses: $addresses, birthday: $birthday)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(note: $note, phones: $phones, social_medias: $social_medias, emails: $emails, id: $id, links: $links, name: $name, addresses: $addresses, birthday: $birthday)';
  }
