...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, created_at: $created_at, emails: $emails, id: $id, social_medias: $social_medias, updated_at: $updated_at, birthday: $birthday, links: $links, name: $name, note: $note, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, note: $note, social_medias: $social_medias, emails: $emails, id: $id, links: $links, name: $name, phones: $phones)';
  }
