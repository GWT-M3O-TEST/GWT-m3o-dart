...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(note: $note, social_medias: $social_medias, emails: $emails, id: $id, links: $links, name: $name, phones: $phones, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, created_at: $created_at)';
  }
...
abstract class _ContactInfo implements ContactInfo {
  const factory _ContactInfo(
      ...
      List<Address>? addresses,
      String? birthday,
      String? created_at}) = _$_ContactInfo;
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(phones: $phones, social_medias: $social_medias, emails: $emails, id: $id, links: $links, name: $name, note: $note, addresses: $addresses, birthday: $birthday)';
  }
...
abstract class _UpdateRequest implements UpdateRequest {
  const factory _UpdateRequest(
      ...
      String? note,
      List<Address>? addresses,
      String? birthday}) = _$_UpdateRequest;
