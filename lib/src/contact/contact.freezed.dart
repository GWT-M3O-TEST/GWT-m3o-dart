...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(emails: $emails, id: $id, social_medias: $social_medias, birthday: $birthday, created_at: $created_at, links: $links, name: $name, note: $note, phones: $phones, updated_at: $updated_at, addresses: $addresses)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, emails: $emails, links: $links, name: $name, phones: $phones, social_medias: $social_medias, addresses: $addresses, id: $id, note: $note)';
  }
