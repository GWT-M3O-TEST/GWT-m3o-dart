...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, created_at: $created_at, id: $id, links: $links, name: $name, phones: $phones, addresses: $addresses, emails: $emails, note: $note, social_medias: $social_medias, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, emails: $emails, id: $id, links: $links, name: $name, note: $note, phones: $phones, social_medias: $social_medias)';
  }
