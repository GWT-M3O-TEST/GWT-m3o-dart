...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(phones: $phones, social_medias: $social_medias, birthday: $birthday, emails: $emails, id: $id, links: $links, name: $name, note: $note, addresses: $addresses, created_at: $created_at, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(social_medias: $social_medias, emails: $emails, id: $id, name: $name, phones: $phones, addresses: $addresses, birthday: $birthday, links: $links, note: $note)';
  }
