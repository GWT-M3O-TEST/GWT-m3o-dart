...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, emails: $emails, links: $links, note: $note, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, id: $id, name: $name, phones: $phones, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, id: $id, links: $links, name: $name, note: $note, phones: $phones, social_medias: $social_medias, addresses: $addresses, emails: $emails)';
  }
