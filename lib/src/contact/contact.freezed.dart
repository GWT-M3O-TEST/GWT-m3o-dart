...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, links: $links, name: $name, note: $note, phones: $phones, social_medias: $social_medias, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, note: $note, addresses: $addresses, emails: $emails, name: $name, phones: $phones, social_medias: $social_medias, birthday: $birthday, id: $id)';
  }
