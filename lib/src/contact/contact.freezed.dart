...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(phones: $phones, birthday: $birthday, emails: $emails, id: $id, name: $name, note: $note, addresses: $addresses, created_at: $created_at, links: $links, social_medias: $social_medias, updated_at: $updated_at)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(id: $id, links: $links, note: $note, phones: $phones, addresses: $addresses, birthday: $birthday, emails: $emails, name: $name, social_medias: $social_medias)';
  }
