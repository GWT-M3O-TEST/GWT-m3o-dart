...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(emails: $emails, name: $name, phones: $phones, social_medias: $social_medias, birthday: $birthday, created_at: $created_at, links: $links, note: $note, updated_at: $updated_at, addresses: $addresses, id: $id)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, emails: $emails, note: $note, phones: $phones, addresses: $addresses, id: $id, links: $links, name: $name, social_medias: $social_medias)';
  }
