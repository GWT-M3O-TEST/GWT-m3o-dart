...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(note: $note, social_medias: $social_medias, updated_at: $updated_at, created_at: $created_at, emails: $emails, name: $name, links: $links, phones: $phones, addresses: $addresses, birthday: $birthday, id: $id)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, phones: $phones, id: $id, links: $links, name: $name, note: $note, social_medias: $social_medias, addresses: $addresses, emails: $emails)';
  }
