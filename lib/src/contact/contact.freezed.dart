...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(created_at: $created_at, emails: $emails, name: $name, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, note: $note, id: $id, links: $links)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(id: $id, links: $links, name: $name, phones: $phones, addresses: $addresses, emails: $emails, social_medias: $social_medias, birthday: $birthday, note: $note)';
  }
