...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(phones: $phones, social_medias: $social_medias, addresses: $addresses, emails: $emails, id: $id, name: $name, updated_at: $updated_at, birthday: $birthday, created_at: $created_at, links: $links, note: $note)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, emails: $emails, social_medias: $social_medias, name: $name, note: $note, phones: $phones, birthday: $birthday, id: $id, links: $links)';
  }
