...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(emails: $emails, links: $links, name: $name, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, birthday: $birthday, created_at: $created_at, id: $id, note: $note, addresses: $addresses)';
  }
...
abstract class _ContactInfo implements ContactInfo {
  const factory _ContactInfo(
      ...
      String? id,
      String? note,
      List<Address>? addresses}) = _$_ContactInfo;
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, links: $links, emails: $emails, id: $id, name: $name, note: $note, phones: $phones, social_medias: $social_medias)';
  }
