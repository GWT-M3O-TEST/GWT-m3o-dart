...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(links: $links, name: $name, note: $note, phones: $phones, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, created_at: $created_at, emails: $emails, id: $id, social_medias: $social_medias)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, name: $name, note: $note, social_medias: $social_medias, addresses: $addresses, birthday: $birthday, emails: $emails, id: $id, phones: $phones)';
  }
