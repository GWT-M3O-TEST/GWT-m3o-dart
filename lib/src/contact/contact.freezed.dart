...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, links: $links, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, emails: $emails, id: $id, name: $name, note: $note)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(birthday: $birthday, note: $note, phones: $phones, social_medias: $social_medias, addresses: $addresses, emails: $emails, id: $id, links: $links, name: $name)';
  }
