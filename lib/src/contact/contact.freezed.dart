...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(note: $note, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, birthday: $birthday, emails: $emails, id: $id, created_at: $created_at, links: $links, name: $name, phones: $phones)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(emails: $emails, name: $name, social_medias: $social_medias, phones: $phones, addresses: $addresses, birthday: $birthday, id: $id, links: $links, note: $note)';
  }
