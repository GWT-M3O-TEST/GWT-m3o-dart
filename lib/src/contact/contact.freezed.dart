...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(birthday: $birthday, id: $id, phones: $phones, social_medias: $social_medias, updated_at: $updated_at, addresses: $addresses, created_at: $created_at, emails: $emails, links: $links, name: $name, note: $note)';
  }
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(links: $links, name: $name, social_medias: $social_medias, note: $note, phones: $phones, addresses: $addresses, birthday: $birthday, emails: $emails, id: $id)';
  }
