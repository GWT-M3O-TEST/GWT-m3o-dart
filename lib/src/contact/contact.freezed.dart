...
class _$_ContactInfo implements _ContactInfo {
  ...
  @override
  String toString() {
    return 'ContactInfo(addresses: $addresses, birthday: $birthday, created_at: $created_at, emails: $emails, phones: $phones, updated_at: $updated_at, id: $id, links: $links, name: $name, note: $note, social_medias: $social_medias)';
  }
...
class _$PhoneTearOff {
  ...
  _Phone call({String? number, String? label}) {
    return _Phone(
      number: number,
      label: label,
    );
...
abstract class _Phone implements Phone {
  const factory _Phone({String? number, String? label}) = _$_Phone;
...
class _$_UpdateRequest implements _UpdateRequest {
  ...
  @override
  String toString() {
    return 'UpdateRequest(addresses: $addresses, birthday: $birthday, id: $id, name: $name, note: $note, phones: $phones, emails: $emails, links: $links, social_medias: $social_medias)';
  }
