...
class _$GenerateRequestTearOff {
  ...
  _GenerateRequest call({int? expiry, String? id, int? size}) {
...
abstract class $GenerateRequestCopyWith<$Res> {
  ...
  $Res call({int? expiry, String? id, int? size});
}
...
class _$_GenerateRequest implements _GenerateRequest {
  const _$_GenerateRequest({this.expiry, this.id, this.size});
...
abstract class _GenerateRequest implements GenerateRequest {
  const factory _GenerateRequest({int? expiry, String? id, int? size}) =
      _$_GenerateRequest;
