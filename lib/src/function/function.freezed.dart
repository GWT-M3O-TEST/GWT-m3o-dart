...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, runtime: $runtime, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, source: $source, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, repo: $repo, source: $source, entrypoint: $entrypoint, name: $name, status: $status, branch: $branch, created: $created, runtime: $runtime, subfolder: $subfolder, updated: $updated, url: $url, env_vars: $env_vars, id: $id)';
  }
