...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(status: $status, subfolder: $subfolder, updated: $updated, branch: $branch, entrypoint: $entrypoint, id: $id, repo: $repo, runtime: $runtime, created: $created, env_vars: $env_vars, name: $name, region: $region, url: $url)';
  }
