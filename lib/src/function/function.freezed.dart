...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, created: $created, env_vars: $env_vars, name: $name, region: $region, runtime: $runtime, updated: $updated, entrypoint: $entrypoint, id: $id, repo: $repo, status: $status, subfolder: $subfolder, url: $url)';
  }
