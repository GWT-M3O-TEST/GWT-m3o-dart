...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, id: $id, region: $region, repo: $repo, runtime: $runtime, status: $status, created: $created, env_vars: $env_vars, name: $name, updated: $updated, url: $url)';
  }
