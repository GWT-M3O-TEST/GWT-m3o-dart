...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, env_vars: $env_vars, region: $region, name: $name, runtime: $runtime, source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, updated: $updated, branch: $branch, subfolder: $subfolder, source: $source, runtime: $runtime, id: $id, repo: $repo, status: $status, url: $url, created: $created)';
  }
