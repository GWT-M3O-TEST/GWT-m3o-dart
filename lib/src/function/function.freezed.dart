...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, env_vars: $env_vars, region: $region, repo: $repo, runtime: $runtime, status: $status, subfolder: $subfolder, branch: $branch, created: $created, id: $id, name: $name, updated: $updated, url: $url)';
  }
