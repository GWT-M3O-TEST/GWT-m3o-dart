...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(repo: $repo, branch: $branch, id: $id, env_vars: $env_vars, name: $name, region: $region, runtime: $runtime, status: $status, subfolder: $subfolder, created: $created, entrypoint: $entrypoint, updated: $updated, url: $url)';
  }
