...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, id: $id, region: $region, repo: $repo, runtime: $runtime, updated: $updated, branch: $branch, created: $created, status: $status, subfolder: $subfolder, url: $url, entrypoint: $entrypoint, name: $name)';
  }
