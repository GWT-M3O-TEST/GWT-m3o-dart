...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, env_vars: $env_vars, id: $id, name: $name, repo: $repo, runtime: $runtime, branch: $branch, created: $created, url: $url, status: $status, subfolder: $subfolder, region: $region, updated: $updated)';
  }
