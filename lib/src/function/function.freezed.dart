...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, region: $region, repo: $repo, runtime: $runtime, status: $status, subfolder: $subfolder, branch: $branch, created: $created, url: $url, name: $name, updated: $updated, env_vars: $env_vars, id: $id)';
  }
