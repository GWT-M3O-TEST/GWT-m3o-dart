...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, repo: $repo, updated: $updated, url: $url, branch: $branch, created: $created, id: $id, name: $name, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, runtime: $runtime, status: $status)';
  }
