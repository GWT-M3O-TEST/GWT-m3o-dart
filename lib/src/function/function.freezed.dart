...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(runtime: $runtime, branch: $branch, created: $created, env_vars: $env_vars, id: $id, region: $region, repo: $repo, entrypoint: $entrypoint, name: $name, status: $status, subfolder: $subfolder, updated: $updated, url: $url)';
  }
