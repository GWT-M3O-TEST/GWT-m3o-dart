...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, region: $region, subfolder: $subfolder, env_vars: $env_vars, name: $name, repo: $repo, runtime: $runtime, source: $source)';
  }
...
abstract class _DeployRequest implements DeployRequest {
  const factory _DeployRequest(
      ...
      String? repo,
      String? runtime,
      String? source}) = _$_DeployRequest;
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(repo: $repo, updated: $updated, entrypoint: $entrypoint, id: $id, region: $region, env_vars: $env_vars, source: $source, subfolder: $subfolder, runtime: $runtime, status: $status, url: $url, branch: $branch, created: $created, name: $name)';
  }
