...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, repo: $repo, runtime: $runtime)';
  }
...
abstract class _DeployRequest implements DeployRequest {
  const factory _DeployRequest(
      ...
      String? region,
      String? repo,
      String? runtime}) = _$_DeployRequest;
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, env_vars: $env_vars, region: $region, repo: $repo, subfolder: $subfolder, updated: $updated, url: $url, branch: $branch, entrypoint: $entrypoint, id: $id, name: $name, runtime: $runtime, status: $status)';
  }
