...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, runtime: $runtime, status: $status, subfolder: $subfolder, url: $url, updated: $updated, branch: $branch, created: $created, entrypoint: $entrypoint, env_vars: $env_vars, id: $id, region: $region, repo: $repo)';
  }
