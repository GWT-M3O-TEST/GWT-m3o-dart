...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(runtime: $runtime, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, repo: $repo, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(entrypoint: $entrypoint, env_vars: $env_vars, runtime: $runtime, subfolder: $subfolder, updated: $updated, branch: $branch, created: $created, region: $region, name: $name, status: $status, id: $id, repo: $repo, source: $source, url: $url)';
  }
