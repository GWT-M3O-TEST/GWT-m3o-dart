...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, runtime: $runtime, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region)';
  }
...
abstract class _DeployRequest implements DeployRequest {
  const factory _DeployRequest(
      ...
      Map<String, String>? env_vars,
      String? name,
      String? region}) = _$_DeployRequest;
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(repo: $repo, runtime: $runtime, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, region: $region, updated: $updated, created: $created, id: $id, status: $status, url: $url)';
  }
