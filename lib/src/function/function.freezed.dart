...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, env_vars: $env_vars, region: $region, repo: $repo, runtime: $runtime, source: $source, entrypoint: $entrypoint, name: $name, subfolder: $subfolder)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, repo: $repo, subfolder: $subfolder, entrypoint: $entrypoint, id: $id, source: $source, url: $url, created: $created, branch: $branch, env_vars: $env_vars, region: $region, runtime: $runtime, status: $status, updated: $updated)';
  }
