...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, region: $region, repo: $repo, runtime: $runtime, subfolder: $subfolder, name: $name, source: $source)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(subfolder: $subfolder, branch: $branch, created: $created, region: $region, repo: $repo, status: $status, entrypoint: $entrypoint, id: $id, url: $url, env_vars: $env_vars, name: $name, runtime: $runtime, source: $source, updated: $updated)';
  }
