...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, repo: $repo, runtime: $runtime, env_vars: $env_vars, name: $name, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, runtime: $runtime, subfolder: $subfolder, created: $created, url: $url, source: $source, name: $name, repo: $repo, updated: $updated, id: $id, entrypoint: $entrypoint, region: $region, status: $status, branch: $branch)';
  }
