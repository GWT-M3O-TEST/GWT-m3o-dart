...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(repo: $repo, runtime: $runtime, status: $status, branch: $branch, created: $created, entrypoint: $entrypoint, env_vars: $env_vars, updated: $updated, url: $url, id: $id, name: $name, region: $region, subfolder: $subfolder)';
  }
