...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(repo: $repo, source: $source, subfolder: $subfolder, env_vars: $env_vars, entrypoint: $entrypoint, name: $name, region: $region, runtime: $runtime, branch: $branch)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(env_vars: $env_vars, name: $name, subfolder: $subfolder, url: $url, created: $created, id: $id, source: $source, branch: $branch, entrypoint: $entrypoint, status: $status, updated: $updated, region: $region, repo: $repo, runtime: $runtime)';
  }
