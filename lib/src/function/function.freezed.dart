...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(source: $source, subfolder: $subfolder, repo: $repo, runtime: $runtime, env_vars: $env_vars, name: $name, region: $region, branch: $branch, entrypoint: $entrypoint)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(updated: $updated, name: $name, source: $source, status: $status, branch: $branch, entrypoint: $entrypoint, url: $url, id: $id, repo: $repo, subfolder: $subfolder, runtime: $runtime, created: $created, env_vars: $env_vars, region: $region)';
  }
