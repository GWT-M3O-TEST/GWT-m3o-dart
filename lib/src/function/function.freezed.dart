...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, region: $region, repo: $repo, runtime: $runtime, source: $source, subfolder: $subfolder, entrypoint: $entrypoint, env_vars: $env_vars, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, branch: $branch, created: $created, entrypoint: $entrypoint, status: $status, url: $url, env_vars: $env_vars, id: $id, repo: $repo, subfolder: $subfolder, updated: $updated, name: $name, runtime: $runtime, source: $source)';
  }
