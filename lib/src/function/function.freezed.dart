...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(branch: $branch, entrypoint: $entrypoint, region: $region, repo: $repo, source: $source, subfolder: $subfolder, env_vars: $env_vars, name: $name, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(name: $name, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, id: $id, region: $region, source: $source, updated: $updated, created: $created, status: $status, url: $url, repo: $repo, runtime: $runtime)';
  }
