...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(env_vars: $env_vars, repo: $repo, source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, runtime: $runtime, name: $name, region: $region)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(region: $region, repo: $repo, url: $url, id: $id, runtime: $runtime, subfolder: $subfolder, status: $status, source: $source, updated: $updated, branch: $branch, created: $created, entrypoint: $entrypoint, env_vars: $env_vars, name: $name)';
  }
