...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(url: $url, entrypoint: $entrypoint, name: $name, region: $region, status: $status, subfolder: $subfolder, runtime: $runtime, updated: $updated, branch: $branch, created: $created, env_vars: $env_vars, id: $id, repo: $repo)';
  }
