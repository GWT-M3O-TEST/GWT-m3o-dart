...
class _$CallRequestTearOff {
  ...
  _CallRequest call({Map<String, dynamic>? request, String? name}) {
    return _CallRequest(
      request: request,
      name: name,
    );
...
class _$_CallRequest implements _CallRequest {
  const _$_CallRequest({this.request, this.name});
...
abstract class _CallRequest implements CallRequest {
  const factory _CallRequest({Map<String, dynamic>? request, String? name}) =
      _$_CallRequest;
...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, runtime: $runtime, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, entrypoint: $entrypoint, runtime: $runtime, status: $status, url: $url, branch: $branch, id: $id, name: $name, region: $region, repo: $repo, subfolder: $subfolder, updated: $updated, env_vars: $env_vars)';
  }
...
abstract class _Func implements Func {
  const factory _Func(
      ...
      String? subfolder,
      String? updated,
      Map<String, String>? env_vars}) = _$_Func;
...
class _$UpdateRequestTearOff {
  ...
  _UpdateRequest call({String? name}) {
...
class _$_UpdateRequest implements _UpdateRequest {
  const _$_UpdateRequest({this.name});
...
abstract class _UpdateRequest implements UpdateRequest {
  const factory _UpdateRequest({String? name}) = _$_UpdateRequest;
