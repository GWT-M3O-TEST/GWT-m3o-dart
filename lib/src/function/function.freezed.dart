...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, entrypoint: $entrypoint, runtime: $runtime, region: $region, repo: $repo, status: $status, subfolder: $subfolder, created: $created, env_vars: $env_vars, id: $id, name: $name, updated: $updated, url: $url)';
  }
