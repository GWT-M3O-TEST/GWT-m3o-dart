...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(entrypoint: $entrypoint, region: $region, repo: $repo, subfolder: $subfolder, source: $source, branch: $branch, env_vars: $env_vars, name: $name, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(created: $created, entrypoint: $entrypoint, id: $id, name: $name, subfolder: $subfolder, env_vars: $env_vars, repo: $repo, runtime: $runtime, status: $status, branch: $branch, region: $region, source: $source, updated: $updated, url: $url)';
  }
