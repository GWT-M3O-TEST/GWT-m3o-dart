...
class _$_DeployRequest implements _DeployRequest {
  ...
  @override
  String toString() {
    return 'DeployRequest(region: $region, repo: $repo, source: $source, subfolder: $subfolder, branch: $branch, entrypoint: $entrypoint, env_vars: $env_vars, name: $name, runtime: $runtime)';
  }
...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(updated: $updated, url: $url, created: $created, entrypoint: $entrypoint, runtime: $runtime, subfolder: $subfolder, id: $id, status: $status, name: $name, region: $region, repo: $repo, branch: $branch, env_vars: $env_vars, source: $source)';
  }
