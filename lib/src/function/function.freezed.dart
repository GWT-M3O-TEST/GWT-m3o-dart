...
class _$_Func implements _Func {
  ...
  @override
  String toString() {
    return 'Func(branch: $branch, name: $name, repo: $repo, runtime: $runtime, subfolder: $subfolder, updated: $updated, created: $created, entrypoint: $entrypoint, env_vars: $env_vars, id: $id, region: $region, status: $status, url: $url)';
  }
