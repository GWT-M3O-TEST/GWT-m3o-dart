...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(owner: $owner, traits: $traits, listing_date: $listing_date, contract: $contract, creator: $creator, image_url: $image_url, last_sale: $last_sale, name: $name, permalink: $permalink, collection: $collection, presale: $presale, id: $id, sales: $sales, token_id: $token_id, description: $description)';
  }
...
class _$_AssetsRequest implements _AssetsRequest {
  ...
  @override
  String toString() {
    return 'AssetsRequest(cursor: $cursor, limit: $limit, offset: $offset, order: $order, order_by: $order_by, collection: $collection)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, description: $description, external_link: $external_link, stats: $stats, traits: $traits, image_url: $image_url, name: $name, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, banner_image_url: $banner_image_url, editors: $editors, payout_address: $payout_address, safelist_request_status: $safelist_request_status, payment_tokens: $payment_tokens, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, type: $type, address: $address, owner: $owner, payout_address: $payout_address, schema: $schema, created_at: $created_at, description: $description, name: $name, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, transaction: $transaction, asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, total_price: $total_price, asset_token_id: $asset_token_id)';
  }
