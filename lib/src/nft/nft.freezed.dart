...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(traits: $traits, creator: $creator, description: $description, id: $id, last_sale: $last_sale, listing_date: $listing_date, presale: $presale, sales: $sales, contract: $contract, image_url: $image_url, permalink: $permalink, collection: $collection, owner: $owner, token_id: $token_id, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, name: $name, primary_asset_contracts: $primary_asset_contracts, payout_address: $payout_address, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, stats: $stats, traits: $traits, editors: $editors, external_link: $external_link, image_url: $image_url, payment_tokens: $payment_tokens, created_at: $created_at, description: $description, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, schema: $schema, description: $description, name: $name, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, created_at: $created_at, event_type: $event_type, transaction: $transaction, asset_token_id: $asset_token_id)';
  }
