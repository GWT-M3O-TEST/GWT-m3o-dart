...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, creator: $creator, sales: $sales, permalink: $permalink, contract: $contract, last_sale: $last_sale, name: $name, owner: $owner, presale: $presale, traits: $traits, description: $description, id: $id, image_url: $image_url, listing_date: $listing_date, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(slug: $slug, external_link: $external_link, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, banner_image_url: $banner_image_url, editors: $editors, stats: $stats, created_at: $created_at, image_url: $image_url, traits: $traits, description: $description, name: $name, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, schema: $schema, type: $type, created_at: $created_at, description: $description, name: $name, symbol: $symbol, address: $address, payout_address: $payout_address, seller_fees: $seller_fees)';
  }
