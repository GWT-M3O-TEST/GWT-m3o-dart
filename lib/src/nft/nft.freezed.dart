...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, last_sale: $last_sale, presale: $presale, creator: $creator, image_url: $image_url, name: $name, token_id: $token_id, traits: $traits, collection: $collection, description: $description, owner: $owner, id: $id, listing_date: $listing_date, permalink: $permalink, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, description: $description, editors: $editors, image_url: $image_url, seller_fees: $seller_fees, traits: $traits, created_at: $created_at, external_link: $external_link, name: $name, stats: $stats, payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, payout_address: $payout_address, schema: $schema, type: $type, symbol: $symbol, address: $address, created_at: $created_at, name: $name, owner: $owner, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, created_at: $created_at)';
  }
