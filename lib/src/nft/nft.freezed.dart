...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(sales: $sales, creator: $creator, last_sale: $last_sale, owner: $owner, id: $id, listing_date: $listing_date, token_id: $token_id, contract: $contract, permalink: $permalink, name: $name, presale: $presale, collection: $collection, description: $description, image_url: $image_url)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, image_url: $image_url, name: $name, payout_address: $payout_address, slug: $slug, created_at: $created_at)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, created_at: $created_at, name: $name, description: $description, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id)';
  }
