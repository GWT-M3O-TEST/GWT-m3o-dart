...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, creator: $creator, id: $id, image_url: $image_url, last_sale: $last_sale, presale: $presale, owner: $owner, traits: $traits, token_id: $token_id, contract: $contract, description: $description, listing_date: $listing_date, name: $name, permalink: $permalink, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, editors: $editors, external_link: $external_link, payment_tokens: $payment_tokens, traits: $traits, banner_image_url: $banner_image_url, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, stats: $stats, description: $description, image_url: $image_url, seller_fees: $seller_fees, name: $name, payout_address: $payout_address, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, address: $address, name: $name, seller_fees: $seller_fees, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, quantity: $quantity, transaction: $transaction, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, total_price: $total_price)';
  }
