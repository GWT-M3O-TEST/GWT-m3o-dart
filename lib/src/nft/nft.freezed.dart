...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(name: $name, presale: $presale, sales: $sales, creator: $creator, image_url: $image_url, id: $id, token_id: $token_id, traits: $traits, collection: $collection, contract: $contract, owner: $owner, permalink: $permalink, last_sale: $last_sale, listing_date: $listing_date, description: $description)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, primary_asset_contracts: $primary_asset_contracts, traits: $traits, created_at: $created_at, safelist_request_status: $safelist_request_status, stats: $stats, description: $description, external_link: $external_link, image_url: $image_url, payout_address: $payout_address, seller_fees: $seller_fees, slug: $slug, banner_image_url: $banner_image_url, editors: $editors, payment_tokens: $payment_tokens)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      String? banner_image_url,
      List<String>? editors,
      List<Token>? payment_tokens}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, seller_fees: $seller_fees, address: $address, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, created_at: $created_at, quantity: $quantity, transaction: $transaction)';
  }
