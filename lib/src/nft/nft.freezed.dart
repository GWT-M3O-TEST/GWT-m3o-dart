...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, creator: $creator, image_url: $image_url, sales: $sales, contract: $contract, description: $description, name: $name, permalink: $permalink, id: $id, last_sale: $last_sale, listing_date: $listing_date, owner: $owner, presale: $presale, token_id: $token_id)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, address: $address, description: $description, name: $name, owner: $owner, schema: $schema, seller_fees: $seller_fees, created_at: $created_at, payout_address: $payout_address, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price)';
  }
