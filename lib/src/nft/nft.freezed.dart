...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(presale: $presale, traits: $traits, contract: $contract, id: $id, last_sale: $last_sale, name: $name, token_id: $token_id, sales: $sales, collection: $collection, description: $description, owner: $owner, permalink: $permalink, creator: $creator, image_url: $image_url, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, description: $description, editors: $editors, external_link: $external_link, name: $name, payment_tokens: $payment_tokens, image_url: $image_url, safelist_request_status: $safelist_request_status, slug: $slug, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, payout_address: $payout_address, seller_fees: $seller_fees, description: $description, name: $name, owner: $owner, schema: $schema, symbol: $symbol, address: $address, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, event_type: $event_type, quantity: $quantity)';
  }
