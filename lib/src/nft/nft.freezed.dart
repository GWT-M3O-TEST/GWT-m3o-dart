...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(image_url: $image_url, sales: $sales, contract: $contract, last_sale: $last_sale, traits: $traits, collection: $collection, creator: $creator, name: $name, presale: $presale, permalink: $permalink, token_id: $token_id, description: $description, id: $id, listing_date: $listing_date, owner: $owner)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(slug: $slug, stats: $stats, traits: $traits, banner_image_url: $banner_image_url, description: $description, editors: $editors, external_link: $external_link, image_url: $image_url, created_at: $created_at, payout_address: $payout_address, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, name: $name, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, type: $type, created_at: $created_at, name: $name, schema: $schema, address: $address, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(transaction: $transaction, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type)';
  }
