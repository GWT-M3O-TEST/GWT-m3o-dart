...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(name: $name, description: $description, id: $id, last_sale: $last_sale, owner: $owner, traits: $traits, collection: $collection, contract: $contract, creator: $creator, listing_date: $listing_date, permalink: $permalink, sales: $sales, image_url: $image_url, presale: $presale, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, primary_asset_contracts: $primary_asset_contracts, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, editors: $editors, image_url: $image_url, description: $description, safelist_request_status: $safelist_request_status, slug: $slug, stats: $stats, external_link: $external_link, payment_tokens: $payment_tokens, payout_address: $payout_address, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, address: $address, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, quantity: $quantity, total_price: $total_price, transaction: $transaction)';
  }
