...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(traits: $traits, image_url: $image_url, name: $name, presale: $presale, sales: $sales, creator: $creator, description: $description, last_sale: $last_sale, permalink: $permalink, collection: $collection, listing_date: $listing_date, owner: $owner, token_id: $token_id, contract: $contract, id: $id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, traits: $traits, external_link: $external_link, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, slug: $slug, stats: $stats, banner_image_url: $banner_image_url, created_at: $created_at, seller_fees: $seller_fees, description: $description, name: $name, payout_address: $payout_address)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      String? description,
      String? name,
      String? payout_address}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, description: $description, name: $name, seller_fees: $seller_fees, payout_address: $payout_address, schema: $schema, type: $type, address: $address, created_at: $created_at, owner: $owner)';
  }
...
class _$CreateRequestTearOff {
  ...
  _CreateRequest call(
      {String? description, String? image, String? name, String? data}) {
...
abstract class $CreateRequestCopyWith<$Res> {
  ...
  $Res call({String? description, String? image, String? name, String? data});
}
...
class _$_CreateRequest implements _CreateRequest {
  const _$_CreateRequest({this.description, this.image, this.name, this.data});
  ...
  @override
  String toString() {
    return 'CreateRequest(description: $description, image: $image, name: $name, data: $data)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, created_at: $created_at, event_type: $event_type)';
  }
...
class _$_Transaction implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(from_account: $from_account, id: $id, timestamp: $timestamp, to_account: $to_account, transaction_hash: $transaction_hash, transaction_index: $transaction_index, block_hash: $block_hash, block_number: $block_number)';
  }
...
abstract class _Transaction implements Transaction {
  const factory _Transaction(
      ...
      String? transaction_index,
      String? block_hash,
      String? block_number}) = _$_Transaction;
...
class _$UserTearOff {
  ...
  _User call({String? profile_url, String? username, String? address}) {
    return _User(
...
abstract class $UserCopyWith<$Res> {
  ...
  $Res call({String? profile_url, String? username, String? address});
}
...
class _$_User implements _User {
  const _$_User({this.profile_url, this.username, this.address});
  ...
  @override
  String toString() {
    return 'User(profile_url: $profile_url, username: $username, address: $address)';
  }
...
abstract class _User implements User {
  const factory _User(
      {String? profile_url, String? username, String? address}) = _$_User;
