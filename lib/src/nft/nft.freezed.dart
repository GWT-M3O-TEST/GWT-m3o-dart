...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, image_url: $image_url, permalink: $permalink, presale: $presale, contract: $contract, creator: $creator, name: $name, sales: $sales, traits: $traits, last_sale: $last_sale, listing_date: $listing_date, owner: $owner, collection: $collection, id: $id, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, external_link: $external_link, image_url: $image_url, payout_address: $payout_address, stats: $stats, banner_image_url: $banner_image_url, safelist_request_status: $safelist_request_status, slug: $slug, description: $description, name: $name, seller_fees: $seller_fees, traits: $traits, created_at: $created_at, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      String? created_at,
      List<Token>? payment_tokens,
      List<Contract>? primary_asset_contracts}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, description: $description, name: $name, seller_fees: $seller_fees, type: $type, created_at: $created_at, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, quantity: $quantity, asset_decimals: $asset_decimals)';
  }
