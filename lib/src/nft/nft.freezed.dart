...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, image_url: $image_url, traits: $traits, permalink: $permalink, sales: $sales, creator: $creator, description: $description, id: $id, listing_date: $listing_date, collection: $collection, last_sale: $last_sale, owner: $owner, token_id: $token_id, name: $name, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, stats: $stats, traits: $traits, description: $description, editors: $editors, external_link: $external_link, name: $name, payout_address: $payout_address, seller_fees: $seller_fees, banner_image_url: $banner_image_url, created_at: $created_at, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, type: $type, description: $description, name: $name, owner: $owner, address: $address, created_at: $created_at, symbol: $symbol)';
  }
