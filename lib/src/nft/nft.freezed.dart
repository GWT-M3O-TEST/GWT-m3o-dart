...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(name: $name, collection: $collection, description: $description, id: $id, last_sale: $last_sale, creator: $creator, owner: $owner, sales: $sales, traits: $traits, contract: $contract, permalink: $permalink, presale: $presale, token_id: $token_id, image_url: $image_url, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, external_link: $external_link, safelist_request_status: $safelist_request_status, traits: $traits, banner_image_url: $banner_image_url, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug, payout_address: $payout_address, stats: $stats, payment_tokens: $payment_tokens, editors: $editors, image_url: $image_url, name: $name, created_at: $created_at)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, description: $description, name: $name, payout_address: $payout_address, schema: $schema, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at)';
  }
