...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(permalink: $permalink, token_id: $token_id, collection: $collection, name: $name, owner: $owner, presale: $presale, description: $description, id: $id, traits: $traits, contract: $contract, creator: $creator, listing_date: $listing_date, sales: $sales, image_url: $image_url, last_sale: $last_sale)';
  }
...
class _$_AssetsRequest implements _AssetsRequest {
  const _$_AssetsRequest(
      {this.order_by, this.collection, this.limit, this.offset, this.order});
  ...
  @override
  String toString() {
    return 'AssetsRequest(order_by: $order_by, collection: $collection, limit: $limit, offset: $offset, order: $order)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(payment_tokens: $payment_tokens, payout_address: $payout_address, traits: $traits, external_link: $external_link, name: $name, slug: $slug, description: $description, primary_asset_contracts: $primary_asset_contracts, editors: $editors, seller_fees: $seller_fees, image_url: $image_url, safelist_request_status: $safelist_request_status, stats: $stats, banner_image_url: $banner_image_url, created_at: $created_at)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      Map<String, dynamic>? stats,
      String? banner_image_url,
      String? created_at}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, type: $type, description: $description, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, transaction: $transaction)';
  }
...
class _$_Token implements _Token {
  ...
  @override
  String toString() {
    return 'Token(address: $address, decimals: $decimals, eth_price: $eth_price, id: $id, image_url: $image_url, name: $name, symbol: $symbol, usd_price: $usd_price)';
  }
...
abstract class _Transaction implements Transaction {
  const factory _Transaction(
      ...
      String? timestamp,
      User? to_account,
      String? transaction_hash}) = _$_Transaction;
