...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, sales: $sales, token_id: $token_id, collection: $collection, id: $id, permalink: $permalink, creator: $creator, image_url: $image_url, presale: $presale, owner: $owner, traits: $traits, contract: $contract, last_sale: $last_sale, listing_date: $listing_date, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(traits: $traits, created_at: $created_at, name: $name, payment_tokens: $payment_tokens, seller_fees: $seller_fees, image_url: $image_url, editors: $editors, payout_address: $payout_address, slug: $slug, safelist_request_status: $safelist_request_status, stats: $stats, banner_image_url: $banner_image_url, description: $description, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, name: $name, payout_address: $payout_address, symbol: $symbol, type: $type, description: $description, owner: $owner, schema: $schema, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, quantity: $quantity, total_price: $total_price, transaction: $transaction, created_at: $created_at, event_timestamp: $event_timestamp)';
  }
