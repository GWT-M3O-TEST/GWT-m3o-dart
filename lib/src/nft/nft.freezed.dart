...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(last_sale: $last_sale, token_id: $token_id, traits: $traits, collection: $collection, description: $description, id: $id, listing_date: $listing_date, presale: $presale, image_url: $image_url, contract: $contract, creator: $creator, name: $name, owner: $owner, permalink: $permalink, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, description: $description, image_url: $image_url, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, slug: $slug, stats: $stats, editors: $editors, name: $name)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, type: $type, created_at: $created_at, description: $description, name: $name, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, quantity: $quantity)';
  }
...
class _$_Token implements _Token {
  ...
  @override
  String toString() {
    return 'Token(name: $name, symbol: $symbol, usd_price: $usd_price, address: $address, decimals: $decimals, eth_price: $eth_price, id: $id, image_url: $image_url)';
  }
...
class _$_Transaction implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(transaction_hash: $transaction_hash, transaction_index: $transaction_index, block_hash: $block_hash, block_number: $block_number, from_account: $from_account, id: $id, timestamp: $timestamp, to_account: $to_account)';
  }
...
abstract class _Transaction implements Transaction {
  const factory _Transaction(
      ...
      int? id,
      String? timestamp,
      User? to_account}) = _$_Transaction;
