...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(listing_date: $listing_date, name: $name, owner: $owner, creator: $creator, image_url: $image_url, last_sale: $last_sale, presale: $presale, sales: $sales, permalink: $permalink, collection: $collection, contract: $contract, description: $description, id: $id, token_id: $token_id, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, payment_tokens: $payment_tokens, traits: $traits, banner_image_url: $banner_image_url, description: $description, external_link: $external_link, name: $name, safelist_request_status: $safelist_request_status, stats: $stats, created_at: $created_at, seller_fees: $seller_fees, image_url: $image_url, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, created_at: $created_at, description: $description, name: $name, payout_address: $payout_address, schema: $schema, symbol: $symbol, address: $address, owner: $owner, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, created_at: $created_at, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id)';
  }
