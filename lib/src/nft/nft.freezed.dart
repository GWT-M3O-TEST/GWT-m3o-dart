...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(name: $name, permalink: $permalink, presale: $presale, sales: $sales, token_id: $token_id, description: $description, id: $id, listing_date: $listing_date, creator: $creator, contract: $contract, image_url: $image_url, collection: $collection, owner: $owner, last_sale: $last_sale)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, name: $name, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, description: $description, owner: $owner, schema: $schema, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, event_type: $event_type, quantity: $quantity, event_timestamp: $event_timestamp)';
  }
