...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, image_url: $image_url, last_sale: $last_sale, owner: $owner, permalink: $permalink, presale: $presale, sales: $sales, token_id: $token_id, creator: $creator, id: $id, collection: $collection, description: $description, listing_date: $listing_date, name: $name, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(primary_asset_contracts: $primary_asset_contracts, slug: $slug, description: $description, external_link: $external_link, payment_tokens: $payment_tokens, payout_address: $payout_address, image_url: $image_url, safelist_request_status: $safelist_request_status, stats: $stats, traits: $traits, banner_image_url: $banner_image_url, created_at: $created_at, name: $name, seller_fees: $seller_fees, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, name: $name, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, address: $address, owner: $owner, schema: $schema, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, asset_decimals: $asset_decimals, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction)';
  }
