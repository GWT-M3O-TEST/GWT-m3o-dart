...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, image_url: $image_url, sales: $sales, id: $id, presale: $presale, token_id: $token_id, collection: $collection, contract: $contract, traits: $traits, name: $name, owner: $owner, permalink: $permalink, creator: $creator, last_sale: $last_sale, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(safelist_request_status: $safelist_request_status, external_link: $external_link, seller_fees: $seller_fees, payout_address: $payout_address, editors: $editors, name: $name, primary_asset_contracts: $primary_asset_contracts, stats: $stats, traits: $traits, description: $description, created_at: $created_at, image_url: $image_url, payment_tokens: $payment_tokens, slug: $slug, banner_image_url: $banner_image_url)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, description: $description, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol, address: $address, created_at: $created_at, name: $name, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, quantity: $quantity, total_price: $total_price, transaction: $transaction, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token)';
  }
