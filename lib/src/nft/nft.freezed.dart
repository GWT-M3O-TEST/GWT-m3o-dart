...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, id: $id, last_sale: $last_sale, owner: $owner, token_id: $token_id, collection: $collection, contract: $contract, permalink: $permalink, name: $name, presale: $presale, creator: $creator, image_url: $image_url, listing_date: $listing_date, sales: $sales, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(slug: $slug, stats: $stats, created_at: $created_at, payment_tokens: $payment_tokens, payout_address: $payout_address, safelist_request_status: $safelist_request_status, description: $description, editors: $editors, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, name: $name, traits: $traits, banner_image_url: $banner_image_url, external_link: $external_link, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type, description: $description, name: $name, owner: $owner, seller_fees: $seller_fees)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, total_price: $total_price, created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id)';
  }
