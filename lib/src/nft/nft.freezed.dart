...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, presale: $presale, token_id: $token_id, description: $description, last_sale: $last_sale, permalink: $permalink, traits: $traits, id: $id, image_url: $image_url, listing_date: $listing_date, owner: $owner, sales: $sales, collection: $collection, creator: $creator, name: $name)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, banner_image_url: $banner_image_url, created_at: $created_at, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, stats: $stats, external_link: $external_link, name: $name, safelist_request_status: $safelist_request_status, traits: $traits, payout_address: $payout_address, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(schema: $schema, seller_fees: $seller_fees, type: $type, address: $address, description: $description, name: $name, owner: $owner, payout_address: $payout_address, symbol: $symbol, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price)';
  }
