...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, name: $name, token_id: $token_id, creator: $creator, image_url: $image_url, listing_date: $listing_date, presale: $presale, sales: $sales, traits: $traits, collection: $collection, description: $description, id: $id, last_sale: $last_sale, owner: $owner, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, stats: $stats, created_at: $created_at, description: $description, external_link: $external_link, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, editors: $editors, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, slug: $slug, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, name: $name, owner: $owner, schema: $schema, type: $type, address: $address, description: $description, payout_address: $payout_address, seller_fees: $seller_fees, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, transaction: $transaction)';
  }
