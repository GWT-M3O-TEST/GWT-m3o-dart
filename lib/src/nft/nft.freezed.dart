...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, description: $description, traits: $traits, creator: $creator, image_url: $image_url, last_sale: $last_sale, listing_date: $listing_date, owner: $owner, presale: $presale, sales: $sales, token_id: $token_id, contract: $contract, id: $id, name: $name, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(name: $name, stats: $stats, traits: $traits, external_link: $external_link, image_url: $image_url, created_at: $created_at, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, editors: $editors, primary_asset_contracts: $primary_asset_contracts, payment_tokens: $payment_tokens, payout_address: $payout_address, slug: $slug, banner_image_url: $banner_image_url, description: $description)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, type: $type, address: $address, name: $name, owner: $owner, symbol: $symbol, created_at: $created_at, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, transaction: $transaction)';
  }
