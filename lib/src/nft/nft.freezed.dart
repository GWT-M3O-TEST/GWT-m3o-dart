...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(listing_date: $listing_date, owner: $owner, presale: $presale, contract: $contract, creator: $creator, description: $description, image_url: $image_url, id: $id, sales: $sales, token_id: $token_id, traits: $traits, collection: $collection, last_sale: $last_sale, name: $name, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, payment_tokens: $payment_tokens, payout_address: $payout_address, banner_image_url: $banner_image_url, created_at: $created_at, safelist_request_status: $safelist_request_status, stats: $stats, image_url: $image_url, name: $name, slug: $slug, editors: $editors, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, owner: $owner, created_at: $created_at, description: $description, name: $name, type: $type, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, transaction: $transaction, asset_token_id: $asset_token_id)';
  }
