...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(name: $name, listing_date: $listing_date, image_url: $image_url, permalink: $permalink, presale: $presale, traits: $traits, contract: $contract, creator: $creator, description: $description, owner: $owner, sales: $sales, token_id: $token_id, collection: $collection, last_sale: $last_sale, id: $id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(image_url: $image_url, seller_fees: $seller_fees, traits: $traits, stats: $stats, created_at: $created_at, editors: $editors, name: $name, slug: $slug, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, payment_tokens: $payment_tokens, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, description: $description, external_link: $external_link)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      Contract? primary_asset_contracts,
      String? description,
      String? external_link}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, description: $description, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, total_price: $total_price, transaction: $transaction, event_timestamp: $event_timestamp, payment_token: $payment_token, created_at: $created_at, event_type: $event_type, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id)';
  }
