...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, description: $description, image_url: $image_url, last_sale: $last_sale, owner: $owner, creator: $creator, collection: $collection, token_id: $token_id, id: $id, listing_date: $listing_date, name: $name, permalink: $permalink, presale: $presale, sales: $sales, traits: $traits)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, image_url: $image_url, safelist_request_status: $safelist_request_status, created_at: $created_at, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, banner_image_url: $banner_image_url, editors: $editors, external_link: $external_link, payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, name: $name, slug: $slug, traits: $traits)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, schema: $schema, address: $address, created_at: $created_at, description: $description, name: $name, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_token_id: $asset_token_id, created_at: $created_at, transaction: $transaction, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp)';
  }
