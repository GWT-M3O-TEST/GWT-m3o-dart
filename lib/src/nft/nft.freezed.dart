...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, creator: $creator, description: $description, last_sale: $last_sale, token_id: $token_id, traits: $traits, image_url: $image_url, name: $name, presale: $presale, sales: $sales, owner: $owner, permalink: $permalink, collection: $collection, id: $id, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(external_link: $external_link, image_url: $image_url, name: $name, stats: $stats, traits: $traits, banner_image_url: $banner_image_url, editors: $editors, safelist_request_status: $safelist_request_status, created_at: $created_at, payout_address: $payout_address, description: $description, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, owner: $owner, symbol: $symbol, type: $type, address: $address, created_at: $created_at, description: $description, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees)';
  }
