...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, last_sale: $last_sale, name: $name, presale: $presale, token_id: $token_id, description: $description, id: $id, owner: $owner, sales: $sales, creator: $creator, listing_date: $listing_date, traits: $traits, collection: $collection, image_url: $image_url, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, seller_fees: $seller_fees, stats: $stats, created_at: $created_at, description: $description, image_url: $image_url, name: $name, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, banner_image_url: $banner_image_url, external_link: $external_link, slug: $slug, traits: $traits, payment_tokens: $payment_tokens)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      String? slug,
      Map<String, dynamic>? traits,
      Token? payment_tokens}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, symbol: $symbol, address: $address, owner: $owner, payout_address: $payout_address, schema: $schema, created_at: $created_at, description: $description, name: $name, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, transaction: $transaction)';
  }
