...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, listing_date: $listing_date, sales: $sales, id: $id, owner: $owner, creator: $creator, description: $description, image_url: $image_url, name: $name, presale: $presale, traits: $traits, collection: $collection, last_sale: $last_sale, permalink: $permalink, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, slug: $slug, banner_image_url: $banner_image_url, created_at: $created_at, safelist_request_status: $safelist_request_status, traits: $traits, image_url: $image_url, payment_tokens: $payment_tokens, seller_fees: $seller_fees, stats: $stats, description: $description, name: $name, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, description: $description, name: $name, owner: $owner, payout_address: $payout_address, seller_fees: $seller_fees, address: $address, created_at: $created_at, schema: $schema, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, quantity: $quantity, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_type: $event_type, payment_token: $payment_token, total_price: $total_price)';
  }
