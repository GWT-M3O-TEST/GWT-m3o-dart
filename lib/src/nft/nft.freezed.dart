...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, id: $id, last_sale: $last_sale, owner: $owner, presale: $presale, contract: $contract, name: $name, token_id: $token_id, traits: $traits, permalink: $permalink, creator: $creator, description: $description, image_url: $image_url, listing_date: $listing_date, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(image_url: $image_url, payment_tokens: $payment_tokens, banner_image_url: $banner_image_url, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, editors: $editors, name: $name, slug: $slug, stats: $stats, traits: $traits, external_link: $external_link, description: $description, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, created_at: $created_at)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, symbol: $symbol, type: $type, description: $description, name: $name, owner: $owner, payout_address: $payout_address, address: $address, created_at: $created_at, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(payment_token: $payment_token, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, total_price: $total_price, transaction: $transaction, created_at: $created_at, event_type: $event_type, quantity: $quantity)';
  }
