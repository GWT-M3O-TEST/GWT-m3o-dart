...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(sales: $sales, creator: $creator, presale: $presale, last_sale: $last_sale, name: $name, owner: $owner, contract: $contract, image_url: $image_url, traits: $traits, id: $id, listing_date: $listing_date, permalink: $permalink, token_id: $token_id, collection: $collection, description: $description)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, created_at: $created_at, primary_asset_contracts: $primary_asset_contracts, slug: $slug, stats: $stats, traits: $traits, editors: $editors, external_link: $external_link, name: $name, payout_address: $payout_address, safelist_request_status: $safelist_request_status, description: $description, image_url: $image_url, payment_tokens: $payment_tokens, seller_fees: $seller_fees)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, payout_address: $payout_address, name: $name, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, created_at: $created_at, description: $description)';
  }
...
abstract class _Contract implements Contract {
  const factory _Contract(
      ...
      String? address,
      String? created_at,
      String? description}) = _$_Contract;
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, transaction: $transaction, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, payment_token: $payment_token, total_price: $total_price, asset_decimals: $asset_decimals, created_at: $created_at, event_type: $event_type)';
  }
