...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, id: $id, listing_date: $listing_date, name: $name, description: $description, owner: $owner, sales: $sales, creator: $creator, image_url: $image_url, permalink: $permalink, token_id: $token_id, traits: $traits, collection: $collection, last_sale: $last_sale, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, external_link: $external_link, name: $name, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, slug: $slug, created_at: $created_at, payment_tokens: $payment_tokens, payout_address: $payout_address, traits: $traits, banner_image_url: $banner_image_url, editors: $editors, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, stats: $stats)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      String? image_url,
      Contract? primary_asset_contracts,
      Map<String, dynamic>? stats}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, name: $name, owner: $owner, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, payout_address: $payout_address, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, payment_token: $payment_token, total_price: $total_price, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, quantity: $quantity, transaction: $transaction)';
  }
