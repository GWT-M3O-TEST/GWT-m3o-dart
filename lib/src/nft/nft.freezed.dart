...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(name: $name, owner: $owner, collection: $collection, image_url: $image_url, last_sale: $last_sale, permalink: $permalink, traits: $traits, contract: $contract, creator: $creator, id: $id, description: $description, listing_date: $listing_date, presale: $presale, sales: $sales, token_id: $token_id)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, payment_tokens: $payment_tokens, payout_address: $payout_address, slug: $slug, traits: $traits, seller_fees: $seller_fees, created_at: $created_at, external_link: $external_link, image_url: $image_url, name: $name, safelist_request_status: $safelist_request_status, stats: $stats, banner_image_url: $banner_image_url, editors: $editors, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type, address: $address, owner: $owner, name: $name, seller_fees: $seller_fees, created_at: $created_at, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, quantity: $quantity)';
  }
