...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, image_url: $image_url, last_sale: $last_sale, name: $name, permalink: $permalink, sales: $sales, collection: $collection, contract: $contract, token_id: $token_id, id: $id, listing_date: $listing_date, owner: $owner, presale: $presale, traits: $traits, description: $description)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, external_link: $external_link, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, description: $description, safelist_request_status: $safelist_request_status, editors: $editors, image_url: $image_url, payment_tokens: $payment_tokens, stats: $stats, traits: $traits, banner_image_url: $banner_image_url, name: $name, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(payout_address: $payout_address, seller_fees: $seller_fees, name: $name, created_at: $created_at, description: $description, owner: $owner, schema: $schema, symbol: $symbol, type: $type, address: $address)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, asset_token_id: $asset_token_id, created_at: $created_at, total_price: $total_price, transaction: $transaction)';
  }
