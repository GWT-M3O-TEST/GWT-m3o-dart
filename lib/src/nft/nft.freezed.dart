...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, presale: $presale, traits: $traits, listing_date: $listing_date, name: $name, contract: $contract, description: $description, image_url: $image_url, sales: $sales, token_id: $token_id, last_sale: $last_sale, owner: $owner, permalink: $permalink, collection: $collection, creator: $creator)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(created_at: $created_at, payout_address: $payout_address, traits: $traits, banner_image_url: $banner_image_url, seller_fees: $seller_fees, slug: $slug, name: $name, image_url: $image_url, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, description: $description, external_link: $external_link, payment_tokens: $payment_tokens, stats: $stats, editors: $editors)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(type: $type, created_at: $created_at, payout_address: $payout_address, seller_fees: $seller_fees, owner: $owner, schema: $schema, symbol: $symbol, address: $address, description: $description, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_timestamp: $event_timestamp, event_type: $event_type, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, created_at: $created_at, payment_token: $payment_token, quantity: $quantity)';
  }
