...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, owner: $owner, permalink: $permalink, presale: $presale, contract: $contract, description: $description, name: $name, creator: $creator, last_sale: $last_sale, token_id: $token_id, image_url: $image_url, listing_date: $listing_date, sales: $sales, traits: $traits, collection: $collection)';
  }
...
abstract class _Asset implements Asset {
  const factory _Asset(
      ...
      int? sales,
      List<Map<String, dynamic>>? traits,
      Collection? collection}) = _$_Asset;
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, slug: $slug, primary_asset_contracts: $primary_asset_contracts, external_link: $external_link, created_at: $created_at, image_url: $image_url, safelist_request_status: $safelist_request_status, stats: $stats, description: $description, editors: $editors, name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, traits: $traits, banner_image_url: $banner_image_url)';
  }
...
abstract class _Collection implements Collection {
  const factory _Collection(
      ...
      String? payout_address,
      Map<String, dynamic>? traits,
      String? banner_image_url}) = _$_Collection;
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, description: $description, name: $name, owner: $owner, payout_address: $payout_address, address: $address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, created_at: $created_at, total_price: $total_price, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type)';
  }
