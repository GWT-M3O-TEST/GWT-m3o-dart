...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, description: $description, name: $name, presale: $presale, token_id: $token_id, collection: $collection, contract: $contract, id: $id, last_sale: $last_sale, owner: $owner, image_url: $image_url, permalink: $permalink, sales: $sales, traits: $traits, listing_date: $listing_date)';
  }
...
class _$_AssetsRequest implements _AssetsRequest {
  ...
  @override
  String toString() {
    return 'AssetsRequest(collection: $collection, cursor: $cursor, limit: $limit, offset: $offset, order: $order, order_by: $order_by)';
  }
...
class _$AssetsResponseTearOff {
  ...
  AssetsResponseData call(
      {String? next, String? previous, List<Asset>? assets}) {
...
mixin _$AssetsResponse {
  @optionalTypeArgs
  TResult when<TResult extends Object?>(
    TResult Function(String? next, String? previous, List<Asset>? assets)
        $default, {
    required TResult Function(Map<String, dynamic>? body) Merr,
  }) =>
      throw _privateConstructorUsedError;
...
abstract class $AssetsResponseDataCopyWith<$Res> {
  ...
  $Res call({String? next, String? previous, List<Asset>? assets});
}
...
class _$AssetsResponseData implements AssetsResponseData {
  const _$AssetsResponseData(
      {this.next, this.previous, this.assets, String? $type})
      : $type = $type ?? 'default';
  ...
  @override
  String toString() {
    return 'AssetsResponse(next: $next, previous: $previous, assets: $assets)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(next, previous, assets);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(next, previous, assets);
  }
...
abstract class AssetsResponseData implements AssetsResponse {
  const factory AssetsResponseData(
      {String? next,
      String? previous,
      List<Asset>? assets}) = _$AssetsResponseData;
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(seller_fees: $seller_fees, editors: $editors, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, stats: $stats, description: $description, name: $name, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, slug: $slug, banner_image_url: $banner_image_url, created_at: $created_at, traits: $traits, image_url: $image_url, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, name: $name, seller_fees: $seller_fees, description: $description, owner: $owner, payout_address: $payout_address, schema: $schema, type: $type, address: $address, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, total_price: $total_price, asset_decimals: $asset_decimals, transaction: $transaction, asset_token_id: $asset_token_id)';
  }
