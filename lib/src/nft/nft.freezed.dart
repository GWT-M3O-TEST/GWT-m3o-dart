...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, description: $description, last_sale: $last_sale, owner: $owner, token_id: $token_id, id: $id, listing_date: $listing_date, name: $name, presale: $presale, collection: $collection, contract: $contract, image_url: $image_url, permalink: $permalink, sales: $sales, traits: $traits)';
  }
...
abstract class _Asset implements Asset {
  const factory _Asset(
      ...
      String? permalink,
      int? sales,
      List<Map<String, dynamic>>? traits}) = _$_Asset;
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, editors: $editors, external_link: $external_link, name: $name, banner_image_url: $banner_image_url, created_at: $created_at, primary_asset_contracts: $primary_asset_contracts, payout_address: $payout_address, seller_fees: $seller_fees, stats: $stats, traits: $traits, image_url: $image_url, payment_tokens: $payment_tokens, safelist_request_status: $safelist_request_status, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(seller_fees: $seller_fees, symbol: $symbol, created_at: $created_at, owner: $owner, name: $name, payout_address: $payout_address, schema: $schema, type: $type, address: $address, description: $description)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, created_at: $created_at, payment_token: $payment_token, quantity: $quantity, transaction: $transaction, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, total_price: $total_price)';
  }
