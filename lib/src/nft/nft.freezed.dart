...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, image_url: $image_url, permalink: $permalink, presale: $presale, token_id: $token_id, traits: $traits, name: $name, owner: $owner, collection: $collection, creator: $creator, description: $description, listing_date: $listing_date, contract: $contract, last_sale: $last_sale, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(stats: $stats, image_url: $image_url, name: $name, slug: $slug, created_at: $created_at, description: $description, external_link: $external_link, payout_address: $payout_address, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, traits: $traits, banner_image_url: $banner_image_url, editors: $editors, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, name: $name, owner: $owner, seller_fees: $seller_fees, symbol: $symbol, type: $type, created_at: $created_at, description: $description, payout_address: $payout_address, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, quantity: $quantity, transaction: $transaction)';
  }
