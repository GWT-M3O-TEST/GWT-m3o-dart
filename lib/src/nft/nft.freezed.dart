...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(creator: $creator, id: $id, listing_date: $listing_date, sales: $sales, traits: $traits, collection: $collection, owner: $owner, presale: $presale, token_id: $token_id, contract: $contract, description: $description, image_url: $image_url, last_sale: $last_sale, name: $name, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(description: $description, external_link: $external_link, name: $name, payment_tokens: $payment_tokens, payout_address: $payout_address, traits: $traits, created_at: $created_at, editors: $editors, image_url: $image_url, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, stats: $stats, banner_image_url: $banner_image_url, primary_asset_contracts: $primary_asset_contracts, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(owner: $owner, payout_address: $payout_address, symbol: $symbol, created_at: $created_at, description: $description, schema: $schema, seller_fees: $seller_fees, type: $type, address: $address, name: $name)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(quantity: $quantity, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, asset_decimals: $asset_decimals, created_at: $created_at)';
  }
