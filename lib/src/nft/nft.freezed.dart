...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(owner: $owner, image_url: $image_url, last_sale: $last_sale, listing_date: $listing_date, name: $name, permalink: $permalink, collection: $collection, creator: $creator, description: $description, presale: $presale, id: $id, token_id: $token_id, traits: $traits, contract: $contract, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, payment_tokens: $payment_tokens, payout_address: $payout_address, seller_fees: $seller_fees, traits: $traits, created_at: $created_at, description: $description, name: $name, stats: $stats, editors: $editors, primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, external_link: $external_link, image_url: $image_url, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(description: $description, owner: $owner, schema: $schema, seller_fees: $seller_fees, type: $type, address: $address, created_at: $created_at, name: $name, payout_address: $payout_address, symbol: $symbol)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, payment_token: $payment_token, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, quantity: $quantity, total_price: $total_price)';
  }
