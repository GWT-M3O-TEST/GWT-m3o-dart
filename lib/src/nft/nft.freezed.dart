...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(contract: $contract, creator: $creator, last_sale: $last_sale, owner: $owner, presale: $presale, description: $description, sales: $sales, token_id: $token_id, traits: $traits, collection: $collection, listing_date: $listing_date, id: $id, image_url: $image_url, name: $name, permalink: $permalink)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, description: $description, payout_address: $payout_address, safelist_request_status: $safelist_request_status, created_at: $created_at, external_link: $external_link, primary_asset_contracts: $primary_asset_contracts, seller_fees: $seller_fees, stats: $stats, traits: $traits, editors: $editors, image_url: $image_url, name: $name, payment_tokens: $payment_tokens, slug: $slug)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(created_at: $created_at, owner: $owner, payout_address: $payout_address, symbol: $symbol, seller_fees: $seller_fees, type: $type, address: $address, description: $description, name: $name, schema: $schema)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp)';
  }
