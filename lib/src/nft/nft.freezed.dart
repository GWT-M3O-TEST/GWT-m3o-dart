...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(id: $id, listing_date: $listing_date, token_id: $token_id, owner: $owner, sales: $sales, traits: $traits, description: $description, permalink: $permalink, collection: $collection, contract: $contract, creator: $creator, image_url: $image_url, last_sale: $last_sale, name: $name, presale: $presale)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(primary_asset_contracts: $primary_asset_contracts, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, traits: $traits, created_at: $created_at, external_link: $external_link, payment_tokens: $payment_tokens, payout_address: $payout_address, slug: $slug, editors: $editors, image_url: $image_url, banner_image_url: $banner_image_url, description: $description, name: $name, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, name: $name, description: $description, owner: $owner, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(event_type: $event_type, quantity: $quantity, asset_token_id: $asset_token_id, created_at: $created_at, event_timestamp: $event_timestamp, payment_token: $payment_token, total_price: $total_price, transaction: $transaction, asset_decimals: $asset_decimals)';
  }
