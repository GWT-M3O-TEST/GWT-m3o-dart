...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, creator: $creator, id: $id, listing_date: $listing_date, description: $description, presale: $presale, last_sale: $last_sale, name: $name, permalink: $permalink, token_id: $token_id, traits: $traits, contract: $contract, image_url: $image_url, owner: $owner, sales: $sales)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(banner_image_url: $banner_image_url, name: $name, payment_tokens: $payment_tokens, seller_fees: $seller_fees, editors: $editors, external_link: $external_link, image_url: $image_url, safelist_request_status: $safelist_request_status, created_at: $created_at, slug: $slug, traits: $traits, description: $description, payout_address: $payout_address, primary_asset_contracts: $primary_asset_contracts, stats: $stats)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(address: $address, created_at: $created_at, description: $description, seller_fees: $seller_fees, name: $name, owner: $owner, payout_address: $payout_address, schema: $schema, symbol: $symbol, type: $type)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_token_id: $asset_token_id, quantity: $quantity, total_price: $total_price, payment_token: $payment_token, transaction: $transaction, asset_decimals: $asset_decimals, created_at: $created_at, event_timestamp: $event_timestamp, event_type: $event_type)';
  }
