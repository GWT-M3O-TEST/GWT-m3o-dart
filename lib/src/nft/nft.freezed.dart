...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(description: $description, owner: $owner, presale: $presale, creator: $creator, name: $name, token_id: $token_id, listing_date: $listing_date, collection: $collection, contract: $contract, id: $id, image_url: $image_url, last_sale: $last_sale, permalink: $permalink, sales: $sales)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(symbol: $symbol, type: $type, name: $name, owner: $owner, description: $description, payout_address: $payout_address, schema: $schema, seller_fees: $seller_fees, address: $address, created_at: $created_at)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(total_price: $total_price, asset_decimals: $asset_decimals, asset_token_id: $asset_token_id, event_timestamp: $event_timestamp, event_type: $event_type, payment_token: $payment_token, quantity: $quantity, created_at: $created_at, transaction: $transaction)';
  }
