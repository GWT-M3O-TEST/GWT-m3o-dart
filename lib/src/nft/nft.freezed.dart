...
class _$_Asset implements _Asset {
  ...
  @override
  String toString() {
    return 'Asset(collection: $collection, id: $id, last_sale: $last_sale, owner: $owner, token_id: $token_id, sales: $sales, contract: $contract, description: $description, image_url: $image_url, name: $name, presale: $presale, creator: $creator, permalink: $permalink, traits: $traits, listing_date: $listing_date)';
  }
...
class _$_Collection implements _Collection {
  ...
  @override
  String toString() {
    return 'Collection(editors: $editors, external_link: $external_link, slug: $slug, banner_image_url: $banner_image_url, created_at: $created_at, safelist_request_status: $safelist_request_status, seller_fees: $seller_fees, traits: $traits, image_url: $image_url, payment_tokens: $payment_tokens, primary_asset_contracts: $primary_asset_contracts, stats: $stats, description: $description, name: $name, payout_address: $payout_address)';
  }
...
class _$_Contract implements _Contract {
  ...
  @override
  String toString() {
    return 'Contract(name: $name, schema: $schema, seller_fees: $seller_fees, symbol: $symbol, type: $type, address: $address, created_at: $created_at, payout_address: $payout_address, description: $description, owner: $owner)';
  }
...
class _$_Sale implements _Sale {
  ...
  @override
  String toString() {
    return 'Sale(asset_decimals: $asset_decimals, event_timestamp: $event_timestamp, total_price: $total_price, transaction: $transaction, asset_token_id: $asset_token_id, created_at: $created_at, event_type: $event_type, payment_token: $payment_token, quantity: $quantity)';
  }
