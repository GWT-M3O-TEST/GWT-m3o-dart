...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, dst: $dst, latitude: $latitude, longitude: $longitude, offset: $offset, timezone: $timezone, abbreviation: $abbreviation, location: $location, region: $region, localtime: $localtime)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, dst, latitude, longitude, offset, timezone,
        abbreviation, location, region, localtime);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, dst, latitude, longitude, offset, timezone,
        abbreviation, location, region, localtime);
  }
