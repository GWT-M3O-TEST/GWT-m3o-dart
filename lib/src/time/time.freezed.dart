...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, dst: $dst, location: $location, longitude: $longitude, offset: $offset, timezone: $timezone, country: $country, latitude: $latitude, localtime: $localtime, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, dst, location, longitude, offset, timezone,
        country, latitude, localtime, region);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, dst, location, longitude, offset,
        timezone, country, latitude, localtime, region);
  }
...
abstract class ZoneResponseData implements ZoneResponse {
  const factory ZoneResponseData(
      ...
      double? latitude,
      String? localtime,
      String? region}) = _$ZoneResponseData;
