...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(offset: $offset, region: $region, timezone: $timezone, abbreviation: $abbreviation, country: $country, dst: $dst, latitude: $latitude, localtime: $localtime, location: $location, longitude: $longitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(offset, region, timezone, abbreviation, country, dst,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(offset, region, timezone, abbreviation, country, dst,
        latitude, localtime, location, longitude);
  }
