...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(location: $location, longitude: $longitude, offset: $offset, abbreviation: $abbreviation, dst: $dst, localtime: $localtime, region: $region, timezone: $timezone, country: $country, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(location, longitude, offset, abbreviation, dst, localtime,
        region, timezone, country, latitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(location, longitude, offset, abbreviation, dst,
        localtime, region, timezone, country, latitude);
  }
...
abstract class ZoneResponseData implements ZoneResponse {
  const factory ZoneResponseData(
      ...
      String? timezone,
      String? country,
      double? latitude}) = _$ZoneResponseData;
