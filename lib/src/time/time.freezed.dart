...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, longitude: $longitude, timezone: $timezone, offset: $offset, region: $region, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, localtime: $localtime, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, longitude, timezone, offset, region, abbreviation,
        dst, latitude, localtime, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, longitude, timezone, offset, region,
        abbreviation, dst, latitude, localtime, location);
  }
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    if ($default != null) {
      return $default(country, longitude, timezone, offset, region,
          abbreviation, dst, latitude, localtime, location);
    }
    return orElse();
  }
