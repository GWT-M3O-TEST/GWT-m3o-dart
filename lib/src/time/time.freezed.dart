...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(localtime: $localtime, longitude: $longitude, region: $region, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, location: $location, timezone: $timezone, country: $country)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(localtime, longitude, region, abbreviation, dst, latitude,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(localtime, longitude, region, abbreviation, dst,
        latitude, location, timezone, country);
  }
...
abstract class ZoneResponseData implements ZoneResponse {
  const factory ZoneResponseData(
      ...
      String? location,
      String? timezone,
      String? country}) = _$ZoneResponseData;
