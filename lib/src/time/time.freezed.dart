...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, location: $location, longitude: $longitude, region: $region, timezone: $timezone, abbreviation: $abbreviation, dst: $dst, latitude: $latitude, localtime: $localtime)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, location, longitude, region, timezone,
        abbreviation, dst, latitude, localtime);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, location, longitude, region, timezone,
        abbreviation, dst, latitude, localtime);
  }
