...
mixin _$NowResponse {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String? timestamp, String? timezone, int? unix,
            String? localtime, String? location)
        $default, {
...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, dst: $dst, longitude: $longitude, timezone: $timezone, abbreviation: $abbreviation, latitude: $latitude, localtime: $localtime, location: $location, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, dst, longitude, timezone, abbreviation, latitude,
        localtime, location, region);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, dst, longitude, timezone, abbreviation,
        latitude, localtime, location, region);
  }
