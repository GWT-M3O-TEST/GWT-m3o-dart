...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, dst: $dst, localtime: $localtime, timezone: $timezone, country: $country, latitude: $latitude, location: $location, longitude: $longitude, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, dst, localtime, timezone, country, latitude,
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, dst, localtime, timezone, country,
        latitude, location, longitude, region);
  }
