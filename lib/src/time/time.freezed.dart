...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, dst: $dst, location: $location, timezone: $timezone, country: $country, latitude: $latitude, localtime: $localtime, longitude: $longitude, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, dst, location, timezone, country, latitude,
        localtime, longitude, region);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, dst, location, timezone, country,
        latitude, localtime, longitude, region);
  }
