...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, abbreviation: $abbreviation, country: $country, dst: $dst, region: $region, timezone: $timezone, localtime: $localtime, location: $location, longitude: $longitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, abbreviation, country, dst, region, timezone,
        localtime, location, longitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, abbreviation, country, dst, region,
        timezone, localtime, location, longitude);
  }
