...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, offset: $offset, location: $location, longitude: $longitude, region: $region, timezone: $timezone, abbreviation: $abbreviation, country: $country, dst: $dst, localtime: $localtime)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, offset, location, longitude, region, timezone,
        abbreviation, country, dst, localtime);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, offset, location, longitude, region,
        timezone, abbreviation, country, dst, localtime);
  }
