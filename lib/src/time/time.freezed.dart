...
mixin _$NowResponse {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String? localtime, String? location, String? timestamp,
            String? timezone, int? unix)
        $default, {
...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, localtime: $localtime, longitude: $longitude, region: $region, abbreviation: $abbreviation, country: $country, latitude: $latitude, location: $location, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, localtime, longitude, region, abbreviation, country,
        latitude, location, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, localtime, longitude, region, abbreviation,
        country, latitude, location, timezone);
  }
