...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(offset: $offset, abbreviation: $abbreviation, dst: $dst, localtime: $localtime, longitude: $longitude, region: $region, timezone: $timezone, country: $country, latitude: $latitude, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(offset, abbreviation, dst, localtime, longitude, region,
        timezone, country, latitude, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(offset, abbreviation, dst, localtime, longitude,
        region, timezone, country, latitude, location);
  }
