...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, dst: $dst, latitude: $latitude, localtime: $localtime, longitude: $longitude, region: $region, abbreviation: $abbreviation, location: $location, offset: $offset, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, dst, latitude, localtime, longitude, region,
        abbreviation, location, offset, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, dst, latitude, localtime, longitude, region,
        abbreviation, location, offset, timezone);
  }
