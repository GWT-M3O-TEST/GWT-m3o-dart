...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, localtime: $localtime, offset: $offset, region: $region, abbreviation: $abbreviation, country: $country, latitude: $latitude, location: $location, longitude: $longitude, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, localtime, offset, region, abbreviation, country,
        latitude, location, longitude, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, localtime, offset, region, abbreviation, country,
        latitude, location, longitude, timezone);
  }
