...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(localtime: $localtime, location: $location, longitude: $longitude, region: $region, abbreviation: $abbreviation, country: $country, latitude: $latitude, dst: $dst, offset: $offset, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(localtime, location, longitude, region, abbreviation,
        country, latitude, dst, offset, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(localtime, location, longitude, region, abbreviation,
        country, latitude, dst, offset, timezone);
  }
