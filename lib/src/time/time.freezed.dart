...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, localtime: $localtime, longitude: $longitude, region: $region, timezone: $timezone, country: $country, dst: $dst, abbreviation: $abbreviation, location: $location)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, localtime, longitude, region, timezone, country,
        dst, abbreviation, location);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, localtime, longitude, region, timezone,
        country, dst, abbreviation, location);
  }
...
abstract class ZoneResponseData implements ZoneResponse {
  const factory ZoneResponseData(
      ...
      bool? dst,
      String? abbreviation,
      String? location}) = _$ZoneResponseData;
