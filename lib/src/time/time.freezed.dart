...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(dst: $dst, latitude: $latitude, localtime: $localtime, location: $location, longitude: $longitude, offset: $offset, abbreviation: $abbreviation, country: $country, region: $region, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(dst, latitude, localtime, location, longitude, offset,
        abbreviation, country, region, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(dst, latitude, localtime, location, longitude, offset,
        abbreviation, country, region, timezone);
  }
