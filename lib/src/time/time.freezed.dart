...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(latitude: $latitude, localtime: $localtime, location: $location, longitude: $longitude, timezone: $timezone, abbreviation: $abbreviation, country: $country, dst: $dst, offset: $offset, region: $region)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(latitude, localtime, location, longitude, timezone,
        abbreviation, country, dst, offset, region);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(latitude, localtime, location, longitude, timezone,
        abbreviation, country, dst, offset, region);
  }
