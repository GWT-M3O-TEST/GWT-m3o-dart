...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(country: $country, latitude: $latitude, localtime: $localtime, location: $location, longitude: $longitude, region: $region, timezone: $timezone, abbreviation: $abbreviation, offset: $offset, dst: $dst)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(country, latitude, localtime, location, longitude, region,
        timezone, abbreviation, offset, dst);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(country, latitude, localtime, location, longitude,
        region, timezone, abbreviation, offset, dst);
  }
