...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(offset: $offset, timezone: $timezone, country: $country, latitude: $latitude, longitude: $longitude, location: $location, region: $region, abbreviation: $abbreviation, dst: $dst, localtime: $localtime)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(offset, timezone, country, latitude, longitude, location,
        region, abbreviation, dst, localtime);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(offset, timezone, country, latitude, longitude,
        location, region, abbreviation, dst, localtime);
  }
...
abstract class ZoneResponseData implements ZoneResponse {
  const factory ZoneResponseData(
      ...
      String? abbreviation,
      bool? dst,
      String? localtime}) = _$ZoneResponseData;
