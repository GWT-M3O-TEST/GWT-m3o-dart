...
mixin _$NowResponse {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String? location, String? timestamp, String? timezone,
            int? unix, String? localtime)
        $default, {
...
class _$NowResponseData implements NowResponseData {
  ...
  @override
  String toString() {
    return 'NowResponse(location: $location, timestamp: $timestamp, timezone: $timezone, unix: $unix, localtime: $localtime)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(location, timestamp, timezone, unix, localtime);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(location, timestamp, timezone, unix, localtime);
  }
...
abstract class NowResponseData implements NowResponse {
  const factory NowResponseData(
      ...
      String? timezone,
      int? unix,
      String? localtime}) = _$NowResponseData;
...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(abbreviation: $abbreviation, dst: $dst, latitude: $latitude, longitude: $longitude, region: $region, country: $country, localtime: $localtime, location: $location, timezone: $timezone)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(abbreviation, dst, latitude, longitude, region, country,
        localtime, location, timezone);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(abbreviation, dst, latitude, longitude, region,
        country, localtime, location, timezone);
  }
...
abstract class ZoneResponseData implements ZoneResponse {
  const factory ZoneResponseData(
      ...
      String? localtime,
      String? location,
      String? timezone}) = _$ZoneResponseData;
