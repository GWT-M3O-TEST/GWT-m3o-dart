...
class _$ZoneResponseData implements ZoneResponseData {
  ...
  @override
  String toString() {
    return 'ZoneResponse(longitude: $longitude, offset: $offset, localtime: $localtime, location: $location, region: $region, timezone: $timezone, abbreviation: $abbreviation, country: $country, dst: $dst, latitude: $latitude)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(longitude, offset, localtime, location, region, timezone,
        abbreviation, country, dst, latitude);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(longitude, offset, localtime, location, region,
        timezone, abbreviation, country, dst, latitude);
  }
