...
class _$_Record implements _Record {
  ...
  @override
  String toString() {
    return 'Record(organisation: $organisation, street: $street, summary: $summary, town: $town, county: $county, line_one: $line_one, line_two: $line_two, locality: $locality, postcode: $postcode, premise: $premise, building_name: $building_name)';
  }
...
abstract class _Record implements Record {
  const factory _Record(
      ...
      String? postcode,
      String? premise,
      String? building_name}) = _$_Record;
