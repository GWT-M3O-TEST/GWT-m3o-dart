...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, genre_ids: $genre_ids, original_title: $original_title, poster_path: $poster_path, id: $id, popularity: $popularity, video: $video, backdrop_path: $backdrop_path, overview: $overview, title: $title, vote_count: $vote_count, original_language: $original_language, release_date: $release_date, vote_average: $vote_average)';
  }
