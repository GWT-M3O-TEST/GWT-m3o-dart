...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, poster_path: $poster_path, id: $id, popularity: $popularity, title: $title, vote_average: $vote_average, adult: $adult, genre_ids: $genre_ids, overview: $overview, vote_count: $vote_count, backdrop_path: $backdrop_path, original_title: $original_title, release_date: $release_date, video: $video)';
  }
