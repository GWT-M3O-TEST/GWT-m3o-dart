...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, id: $id, popularity: $popularity, vote_count: $vote_count, genre_ids: $genre_ids, original_language: $original_language, poster_path: $poster_path, backdrop_path: $backdrop_path, original_title: $original_title, overview: $overview, release_date: $release_date, title: $title, video: $video, vote_average: $vote_average)';
  }
...
abstract class _MovieInfo implements MovieInfo {
  const factory _MovieInfo(
      ...
      String? title,
      bool? video,
      double? vote_average}) = _$_MovieInfo;
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      String? language,
      int? page,
      int? primary_release_year}) = _$_SearchRequest;
