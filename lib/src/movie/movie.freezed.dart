...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, popularity: $popularity, video: $video, adult: $adult, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path, id: $id, poster_path: $poster_path, original_language: $original_language, original_title: $original_title, overview: $overview, release_date: $release_date, title: $title)';
  }
