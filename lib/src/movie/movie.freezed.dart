...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, release_date: $release_date, adult: $adult, backdrop_path: $backdrop_path, popularity: $popularity, vote_average: $vote_average, poster_path: $poster_path, title: $title, video: $video, vote_count: $vote_count, genre_ids: $genre_ids, original_language: $original_language, original_title: $original_title, overview: $overview)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(primary_release_year: $primary_release_year, query: $query, region: $region, year: $year, language: $language, page: $page)';
  }
...
mixin _$SearchResponse {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(List<MovieInfo>? results, int? total_pages,
...
class _$SearchResponseData implements SearchResponseData {
  ...
  @override
  String toString() {
    return 'SearchResponse(results: $results, total_pages: $total_pages, total_results: $total_results, page: $page)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(results, total_pages, total_results, page);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(results, total_pages, total_results, page);
  }
