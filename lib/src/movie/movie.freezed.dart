...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(title: $title, poster_path: $poster_path, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path, original_language: $original_language, original_title: $original_title, release_date: $release_date, id: $id, genre_ids: $genre_ids, overview: $overview, popularity: $popularity, video: $video, adult: $adult)';
  }
