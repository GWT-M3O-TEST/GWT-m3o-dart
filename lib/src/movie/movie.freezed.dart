...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, vote_count: $vote_count, original_language: $original_language, release_date: $release_date, video: $video, genre_ids: $genre_ids, overview: $overview, popularity: $popularity, adult: $adult, id: $id, original_title: $original_title, backdrop_path: $backdrop_path, poster_path: $poster_path, title: $title)';
  }
