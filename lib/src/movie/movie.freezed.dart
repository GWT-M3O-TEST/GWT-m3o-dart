...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, genre_ids: $genre_ids, release_date: $release_date, vote_count: $vote_count, adult: $adult, id: $id, original_title: $original_title, overview: $overview, poster_path: $poster_path, video: $video, vote_average: $vote_average, original_language: $original_language, popularity: $popularity, title: $title)';
  }
