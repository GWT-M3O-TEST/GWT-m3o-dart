...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, original_title: $original_title, original_language: $original_language, backdrop_path: $backdrop_path, genre_ids: $genre_ids, poster_path: $poster_path, release_date: $release_date, title: $title, id: $id, overview: $overview, popularity: $popularity, video: $video, vote_average: $vote_average, vote_count: $vote_count)';
  }
