...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, original_language: $original_language, title: $title, adult: $adult, vote_count: $vote_count, id: $id, overview: $overview, poster_path: $poster_path, video: $video, vote_average: $vote_average, backdrop_path: $backdrop_path, original_title: $original_title, popularity: $popularity, release_date: $release_date)';
  }
