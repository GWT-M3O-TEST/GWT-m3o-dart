...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, adult: $adult, original_language: $original_language, title: $title, poster_path: $poster_path, release_date: $release_date, id: $id, original_title: $original_title, overview: $overview, backdrop_path: $backdrop_path, genre_ids: $genre_ids, video: $video, popularity: $popularity, vote_count: $vote_count)';
  }
