...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, popularity: $popularity, release_date: $release_date, original_language: $original_language, backdrop_path: $backdrop_path, genre_ids: $genre_ids, id: $id, original_title: $original_title, overview: $overview, video: $video, poster_path: $poster_path, title: $title, vote_average: $vote_average, vote_count: $vote_count)';
  }
