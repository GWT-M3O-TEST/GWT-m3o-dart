...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, id: $id, adult: $adult, original_language: $original_language, original_title: $original_title, popularity: $popularity, video: $video, vote_count: $vote_count, release_date: $release_date, title: $title, vote_average: $vote_average, genre_ids: $genre_ids, overview: $overview, poster_path: $poster_path)';
  }
...
abstract class _MovieInfo implements MovieInfo {
  const factory _MovieInfo(
      ...
      List<int>? genre_ids,
      String? overview,
      String? poster_path}) = _$_MovieInfo;
