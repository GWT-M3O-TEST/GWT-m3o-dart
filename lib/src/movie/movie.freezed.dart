...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, poster_path: $poster_path, vote_count: $vote_count, adult: $adult, original_title: $original_title, overview: $overview, title: $title, release_date: $release_date, vote_average: $vote_average, genre_ids: $genre_ids, id: $id, original_language: $original_language, popularity: $popularity, video: $video)';
  }
