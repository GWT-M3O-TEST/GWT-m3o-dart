...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, original_language: $original_language, overview: $overview, vote_count: $vote_count, original_title: $original_title, release_date: $release_date, title: $title, video: $video, vote_average: $vote_average, id: $id, popularity: $popularity, poster_path: $poster_path, adult: $adult, backdrop_path: $backdrop_path)';
  }
...
abstract class _MovieInfo implements MovieInfo {
  const factory _MovieInfo(
      ...
      String? poster_path,
      bool? adult,
      String? backdrop_path}) = _$_MovieInfo;
