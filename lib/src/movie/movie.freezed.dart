...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, popularity: $popularity, release_date: $release_date, title: $title, poster_path: $poster_path, adult: $adult, genre_ids: $genre_ids, id: $id, original_language: $original_language, overview: $overview, vote_count: $vote_count, backdrop_path: $backdrop_path, original_title: $original_title, video: $video)';
  }
