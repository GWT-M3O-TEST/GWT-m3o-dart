...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_average: $vote_average, adult: $adult, popularity: $popularity, release_date: $release_date, vote_count: $vote_count, original_title: $original_title, overview: $overview, title: $title, genre_ids: $genre_ids, id: $id, poster_path: $poster_path, backdrop_path: $backdrop_path, original_language: $original_language, video: $video)';
  }
