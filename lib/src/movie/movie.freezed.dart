...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, original_language: $original_language, original_title: $original_title, popularity: $popularity, vote_average: $vote_average, backdrop_path: $backdrop_path, genre_ids: $genre_ids, overview: $overview, poster_path: $poster_path, adult: $adult, title: $title, vote_count: $vote_count, release_date: $release_date, video: $video)';
  }
