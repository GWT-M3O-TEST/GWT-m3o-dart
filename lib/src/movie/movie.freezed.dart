...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(title: $title, vote_count: $vote_count, original_title: $original_title, release_date: $release_date, original_language: $original_language, popularity: $popularity, adult: $adult, id: $id, backdrop_path: $backdrop_path, poster_path: $poster_path, video: $video, vote_average: $vote_average, genre_ids: $genre_ids, overview: $overview)';
  }
