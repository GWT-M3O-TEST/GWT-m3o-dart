...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, adult: $adult, original_language: $original_language, overview: $overview, title: $title, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_title: $original_title, release_date: $release_date, video: $video, id: $id, poster_path: $poster_path)';
  }
