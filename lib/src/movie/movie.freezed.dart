...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, poster_path: $poster_path, video: $video, genre_ids: $genre_ids, original_language: $original_language, overview: $overview, release_date: $release_date, title: $title, adult: $adult, id: $id, vote_count: $vote_count, backdrop_path: $backdrop_path, original_title: $original_title, vote_average: $vote_average)';
  }
