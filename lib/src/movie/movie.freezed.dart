...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, original_language: $original_language, vote_count: $vote_count, title: $title, original_title: $original_title, popularity: $popularity, release_date: $release_date, video: $video, vote_average: $vote_average, overview: $overview, poster_path: $poster_path, adult: $adult, backdrop_path: $backdrop_path, genre_ids: $genre_ids)';
  }
