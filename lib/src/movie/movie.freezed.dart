...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, original_language: $original_language, release_date: $release_date, title: $title, vote_average: $vote_average, genre_ids: $genre_ids, original_title: $original_title, overview: $overview, poster_path: $poster_path, vote_count: $vote_count, backdrop_path: $backdrop_path, id: $id, popularity: $popularity, video: $video)';
  }
