...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, vote_count: $vote_count, popularity: $popularity, backdrop_path: $backdrop_path, original_title: $original_title, poster_path: $poster_path, video: $video, release_date: $release_date, title: $title, vote_average: $vote_average, adult: $adult, genre_ids: $genre_ids, id: $id, original_language: $original_language)';
  }
...
abstract class _MovieInfo implements MovieInfo {
  const factory _MovieInfo(
      ...
      List<int>? genre_ids,
      int? id,
      String? original_language}) = _$_MovieInfo;
