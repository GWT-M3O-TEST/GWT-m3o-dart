...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(original_language: $original_language, popularity: $popularity, poster_path: $poster_path, title: $title, id: $id, genre_ids: $genre_ids, adult: $adult, original_title: $original_title, overview: $overview, release_date: $release_date, video: $video, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path)';
  }
