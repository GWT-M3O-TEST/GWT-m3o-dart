...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, id: $id, original_title: $original_title, popularity: $popularity, vote_average: $vote_average, vote_count: $vote_count, genre_ids: $genre_ids, poster_path: $poster_path, release_date: $release_date, title: $title, video: $video, adult: $adult, original_language: $original_language, overview: $overview)';
  }
