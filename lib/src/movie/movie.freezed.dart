...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(overview: $overview, vote_average: $vote_average, vote_count: $vote_count, genre_ids: $genre_ids, original_title: $original_title, poster_path: $poster_path, release_date: $release_date, adult: $adult, id: $id, title: $title, video: $video, backdrop_path: $backdrop_path, original_language: $original_language, popularity: $popularity)';
  }
