...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(popularity: $popularity, title: $title, adult: $adult, id: $id, poster_path: $poster_path, genre_ids: $genre_ids, overview: $overview, vote_average: $vote_average, vote_count: $vote_count, original_title: $original_title, release_date: $release_date, video: $video, backdrop_path: $backdrop_path, original_language: $original_language)';
  }
