...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, poster_path: $poster_path, video: $video, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_language: $original_language, overview: $overview, release_date: $release_date, title: $title, popularity: $popularity, id: $id, original_title: $original_title)';
  }
