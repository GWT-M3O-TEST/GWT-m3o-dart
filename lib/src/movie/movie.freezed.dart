...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, original_language: $original_language, original_title: $original_title, title: $title, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path, genre_ids: $genre_ids, release_date: $release_date, video: $video, id: $id, overview: $overview, popularity: $popularity, poster_path: $poster_path)';
  }
