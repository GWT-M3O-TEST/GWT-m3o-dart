...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, release_date: $release_date, video: $video, popularity: $popularity, poster_path: $poster_path, title: $title, original_language: $original_language, original_title: $original_title, overview: $overview, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, backdrop_path: $backdrop_path, id: $id)';
  }
