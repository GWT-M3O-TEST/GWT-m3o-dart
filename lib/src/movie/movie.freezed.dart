...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(release_date: $release_date, adult: $adult, id: $id, vote_average: $vote_average, backdrop_path: $backdrop_path, original_title: $original_title, video: $video, overview: $overview, popularity: $popularity, poster_path: $poster_path, title: $title, vote_count: $vote_count, genre_ids: $genre_ids, original_language: $original_language)';
  }
