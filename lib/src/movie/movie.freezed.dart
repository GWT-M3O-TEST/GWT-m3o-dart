...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(adult: $adult, id: $id, original_title: $original_title, vote_count: $vote_count, backdrop_path: $backdrop_path, genre_ids: $genre_ids, overview: $overview, popularity: $popularity, release_date: $release_date, vote_average: $vote_average, original_language: $original_language, poster_path: $poster_path, title: $title, video: $video)';
  }
