...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(video: $video, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_language: $original_language, vote_count: $vote_count, id: $id, poster_path: $poster_path, release_date: $release_date, vote_average: $vote_average, overview: $overview, popularity: $popularity, title: $title, adult: $adult, original_title: $original_title)';
  }
...
abstract class _MovieInfo implements MovieInfo {
  const factory _MovieInfo(
      ...
      String? title,
      bool? adult,
      String? original_title}) = _$_MovieInfo;
