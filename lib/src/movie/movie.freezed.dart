...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, poster_path: $poster_path, title: $title, video: $video, vote_average: $vote_average, vote_count: $vote_count, backdrop_path: $backdrop_path, original_title: $original_title, overview: $overview, popularity: $popularity, adult: $adult, genre_ids: $genre_ids, original_language: $original_language, release_date: $release_date)';
  }
