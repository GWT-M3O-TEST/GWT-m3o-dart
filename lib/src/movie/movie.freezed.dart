...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, id: $id, original_title: $original_title, popularity: $popularity, poster_path: $poster_path, original_language: $original_language, overview: $overview, release_date: $release_date, title: $title, video: $video, adult: $adult, backdrop_path: $backdrop_path, vote_average: $vote_average, vote_count: $vote_count)';
  }
