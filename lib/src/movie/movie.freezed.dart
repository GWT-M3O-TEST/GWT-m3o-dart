...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(video: $video, genre_ids: $genre_ids, title: $title, original_language: $original_language, id: $id, overview: $overview, popularity: $popularity, release_date: $release_date, adult: $adult, backdrop_path: $backdrop_path, vote_average: $vote_average, vote_count: $vote_count, original_title: $original_title, poster_path: $poster_path)';
  }
