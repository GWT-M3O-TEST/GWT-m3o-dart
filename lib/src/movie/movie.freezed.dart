...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_title: $original_title, overview: $overview, adult: $adult, poster_path: $poster_path, title: $title, vote_average: $vote_average, vote_count: $vote_count, original_language: $original_language, release_date: $release_date, video: $video, id: $id, popularity: $popularity)';
  }
