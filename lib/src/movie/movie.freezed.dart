...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, original_language: $original_language, original_title: $original_title, overview: $overview, video: $video, backdrop_path: $backdrop_path, release_date: $release_date, title: $title, vote_count: $vote_count, adult: $adult, popularity: $popularity, poster_path: $poster_path, vote_average: $vote_average, genre_ids: $genre_ids)';
  }
