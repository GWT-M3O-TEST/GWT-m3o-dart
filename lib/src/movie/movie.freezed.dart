...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, overview: $overview, release_date: $release_date, original_language: $original_language, backdrop_path: $backdrop_path, genre_ids: $genre_ids, original_title: $original_title, poster_path: $poster_path, title: $title, vote_count: $vote_count, adult: $adult, popularity: $popularity, video: $video, vote_average: $vote_average)';
  }
