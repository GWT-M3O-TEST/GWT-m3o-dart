...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, title: $title, vote_count: $vote_count, popularity: $popularity, poster_path: $poster_path, release_date: $release_date, overview: $overview, adult: $adult, genre_ids: $genre_ids, original_language: $original_language, original_title: $original_title, id: $id, video: $video, vote_average: $vote_average)';
  }
