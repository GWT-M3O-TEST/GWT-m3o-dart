...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(genre_ids: $genre_ids, vote_average: $vote_average, adult: $adult, original_title: $original_title, video: $video, backdrop_path: $backdrop_path, original_language: $original_language, overview: $overview, poster_path: $poster_path, vote_count: $vote_count, id: $id, popularity: $popularity, release_date: $release_date, title: $title)';
  }
...
abstract class SearchResponseData implements SearchResponse {
  const factory SearchResponseData(
      ...
      int? total_results,
      int? page,
      List<MovieInfo>? results}) = _$SearchResponseData;
