...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, title: $title, vote_average: $vote_average, backdrop_path: $backdrop_path, original_language: $original_language, overview: $overview, release_date: $release_date, vote_count: $vote_count, adult: $adult, popularity: $popularity, poster_path: $poster_path, video: $video, original_title: $original_title, genre_ids: $genre_ids)';
  }
...
abstract class _MovieInfo implements MovieInfo {
  const factory _MovieInfo(
      ...
      bool? video,
      String? original_title,
      List<int>? genre_ids}) = _$_MovieInfo;
