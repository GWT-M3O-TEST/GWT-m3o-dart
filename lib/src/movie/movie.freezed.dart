...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(backdrop_path: $backdrop_path, original_title: $original_title, video: $video, vote_count: $vote_count, genre_ids: $genre_ids, overview: $overview, popularity: $popularity, release_date: $release_date, id: $id, vote_average: $vote_average, adult: $adult, original_language: $original_language, poster_path: $poster_path, title: $title)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  ...
  @override
  String toString() {
    return 'SearchRequest(region: $region, year: $year, language: $language, page: $page, primary_release_year: $primary_release_year, query: $query)';
  }
