...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(id: $id, popularity: $popularity, vote_count: $vote_count, adult: $adult, original_title: $original_title, poster_path: $poster_path, release_date: $release_date, backdrop_path: $backdrop_path, video: $video, vote_average: $vote_average, genre_ids: $genre_ids, original_language: $original_language, overview: $overview, title: $title)';
  }
