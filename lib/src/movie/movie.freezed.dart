...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(vote_count: $vote_count, backdrop_path: $backdrop_path, original_language: $original_language, poster_path: $poster_path, video: $video, adult: $adult, genre_ids: $genre_ids, id: $id, original_title: $original_title, popularity: $popularity, overview: $overview, release_date: $release_date, title: $title, vote_average: $vote_average)';
  }
