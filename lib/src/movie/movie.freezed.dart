...
class _$_MovieInfo implements _MovieInfo {
  ...
  @override
  String toString() {
    return 'MovieInfo(video: $video, original_title: $original_title, overview: $overview, poster_path: $poster_path, release_date: $release_date, genre_ids: $genre_ids, backdrop_path: $backdrop_path, id: $id, original_language: $original_language, vote_average: $vote_average, vote_count: $vote_count, adult: $adult, title: $title, popularity: $popularity)';
  }
