...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(region: $region, repo: $repo, updated: $updated, created: $created, env_vars: $env_vars, port: $port, name: $name, status: $status, url: $url, branch: $branch, custom_domains: $custom_domains, id: $id)';
  }
