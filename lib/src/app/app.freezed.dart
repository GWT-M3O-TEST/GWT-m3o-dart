...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, id: $id, port: $port, region: $region, url: $url, branch: $branch, created: $created, env_vars: $env_vars, name: $name, repo: $repo, status: $status, updated: $updated)';
  }
