...
class _$_RunRequest implements _RunRequest {
  ...
  @override
  String toString() {
    return 'RunRequest(region: $region, repo: $repo, branch: $branch, env_vars: $env_vars, name: $name, port: $port)';
  }
...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, port: $port, status: $status, updated: $updated, branch: $branch, custom_domains: $custom_domains, name: $name, region: $region, repo: $repo, url: $url, created: $created, id: $id)';
  }
