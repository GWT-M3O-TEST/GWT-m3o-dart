...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, region: $region, status: $status, updated: $updated, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, name: $name, port: $port, repo: $repo, url: $url)';
  }
