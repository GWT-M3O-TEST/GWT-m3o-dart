...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(name: $name, status: $status, url: $url, branch: $branch, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, port: $port, region: $region, repo: $repo, updated: $updated)';
  }
