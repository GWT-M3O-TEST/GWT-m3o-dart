...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, created: $created, region: $region, repo: $repo, status: $status, name: $name, port: $port, updated: $updated, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, id: $id)';
  }
