...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(updated: $updated, url: $url, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, port: $port, status: $status, branch: $branch, created: $created, name: $name, region: $region, repo: $repo)';
  }
