...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(port: $port, region: $region, repo: $repo, url: $url, branch: $branch, created: $created, id: $id, status: $status, updated: $updated, custom_domains: $custom_domains, env_vars: $env_vars, name: $name)';
  }
