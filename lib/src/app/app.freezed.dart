...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, created: $created, id: $id, port: $port, region: $region, repo: $repo, url: $url, custom_domains: $custom_domains, env_vars: $env_vars, name: $name, status: $status, updated: $updated)';
  }
