...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, name: $name, port: $port, region: $region, repo: $repo, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, status: $status, url: $url, branch: $branch, updated: $updated)';
  }
