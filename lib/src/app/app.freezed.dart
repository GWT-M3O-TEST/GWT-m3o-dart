...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(id: $id, status: $status, name: $name, port: $port, region: $region, repo: $repo, branch: $branch, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, updated: $updated, url: $url)';
  }
