...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, branch: $branch, id: $id, repo: $repo, name: $name, port: $port, region: $region, status: $status, updated: $updated, created: $created, custom_domains: $custom_domains, env_vars: $env_vars)';
  }
