...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, env_vars: $env_vars, name: $name, status: $status, updated: $updated, created: $created, custom_domains: $custom_domains, id: $id, port: $port, region: $region, repo: $repo, url: $url)';
  }
