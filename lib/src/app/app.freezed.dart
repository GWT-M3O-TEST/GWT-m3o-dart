...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, env_vars: $env_vars, id: $id, port: $port, region: $region, repo: $repo, status: $status, updated: $updated, url: $url, created: $created, custom_domains: $custom_domains, name: $name)';
  }
