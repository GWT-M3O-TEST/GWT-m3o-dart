...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(updated: $updated, branch: $branch, created: $created, env_vars: $env_vars, name: $name, port: $port, region: $region, custom_domains: $custom_domains, id: $id, repo: $repo, status: $status, url: $url)';
  }
