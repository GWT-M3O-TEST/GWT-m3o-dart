...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(region: $region, status: $status, custom_domains: $custom_domains, name: $name, env_vars: $env_vars, id: $id, port: $port, repo: $repo, updated: $updated, url: $url, branch: $branch, created: $created)';
  }
