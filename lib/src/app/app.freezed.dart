...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, region: $region, status: $status, updated: $updated, repo: $repo, url: $url, branch: $branch, created: $created, env_vars: $env_vars, id: $id, name: $name, port: $port)';
  }
