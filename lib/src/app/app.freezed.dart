...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(region: $region, repo: $repo, branch: $branch, created: $created, env_vars: $env_vars, id: $id, name: $name, port: $port, updated: $updated, custom_domains: $custom_domains, status: $status, url: $url)';
  }
