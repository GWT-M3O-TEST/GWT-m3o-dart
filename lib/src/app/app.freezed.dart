...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, id: $id, port: $port, region: $region, repo: $repo, updated: $updated, url: $url, created: $created, env_vars: $env_vars, name: $name, status: $status, branch: $branch)';
  }
