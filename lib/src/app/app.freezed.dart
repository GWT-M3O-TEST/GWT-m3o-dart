...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(custom_domains: $custom_domains, status: $status, updated: $updated, branch: $branch, created: $created, name: $name, port: $port, region: $region, repo: $repo, url: $url, env_vars: $env_vars, id: $id)';
  }
