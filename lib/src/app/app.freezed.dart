...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, id: $id, name: $name, port: $port, region: $region, status: $status, url: $url, branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, repo: $repo, updated: $updated)';
  }
