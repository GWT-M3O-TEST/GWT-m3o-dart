...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, branch: $branch, env_vars: $env_vars, id: $id, name: $name, repo: $repo, updated: $updated, created: $created, custom_domains: $custom_domains, port: $port, region: $region, status: $status)';
  }
