...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(env_vars: $env_vars, port: $port, region: $region, repo: $repo, status: $status, branch: $branch, created: $created, name: $name, updated: $updated, url: $url, custom_domains: $custom_domains, id: $id)';
  }
