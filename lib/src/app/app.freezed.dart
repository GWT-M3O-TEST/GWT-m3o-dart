...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, env_vars: $env_vars, port: $port, updated: $updated, region: $region, repo: $repo, status: $status, url: $url, branch: $branch, custom_domains: $custom_domains, id: $id, name: $name)';
  }
