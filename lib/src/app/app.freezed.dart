...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(port: $port, region: $region, repo: $repo, updated: $updated, branch: $branch, custom_domains: $custom_domains, id: $id, status: $status, url: $url, created: $created, env_vars: $env_vars, name: $name)';
  }
