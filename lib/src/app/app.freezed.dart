...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, custom_domains: $custom_domains, name: $name, updated: $updated, url: $url, repo: $repo, status: $status, branch: $branch, env_vars: $env_vars, id: $id, port: $port, region: $region)';
  }
