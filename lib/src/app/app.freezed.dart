...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, branch: $branch, custom_domains: $custom_domains, port: $port, repo: $repo, updated: $updated, status: $status, created: $created, env_vars: $env_vars, id: $id, name: $name, region: $region)';
  }
