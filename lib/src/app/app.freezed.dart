...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, name: $name, port: $port, updated: $updated, branch: $branch, env_vars: $env_vars, id: $id, region: $region, repo: $repo, status: $status, url: $url, custom_domains: $custom_domains)';
  }
