...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(updated: $updated, branch: $branch, env_vars: $env_vars, id: $id, port: $port, region: $region, repo: $repo, created: $created, custom_domains: $custom_domains, name: $name, status: $status, url: $url)';
  }
