...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(branch: $branch, custom_domains: $custom_domains, env_vars: $env_vars, repo: $repo, status: $status, updated: $updated, url: $url, created: $created, id: $id, name: $name, port: $port, region: $region)';
  }
