...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(status: $status, updated: $updated, branch: $branch, env_vars: $env_vars, port: $port, region: $region, repo: $repo, created: $created, custom_domains: $custom_domains, id: $id, name: $name, url: $url)';
  }
