...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(created: $created, env_vars: $env_vars, id: $id, port: $port, region: $region, repo: $repo, status: $status, branch: $branch, url: $url, updated: $updated, name: $name, custom_domains: $custom_domains)';
  }
...
abstract class _Service implements Service {
  const factory _Service(
      ...
      String? updated,
      String? name,
      List<String>? custom_domains}) = _$_Service;
