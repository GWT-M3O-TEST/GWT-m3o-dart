...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(url: $url, branch: $branch, port: $port, region: $region, repo: $repo, status: $status, updated: $updated, created: $created, custom_domains: $custom_domains, env_vars: $env_vars, id: $id, name: $name)';
  }
