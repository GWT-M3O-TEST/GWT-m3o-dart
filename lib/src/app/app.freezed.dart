...
class _$_Service implements _Service {
  ...
  @override
  String toString() {
    return 'Service(port: $port, repo: $repo, status: $status, updated: $updated, branch: $branch, custom_domains: $custom_domains, id: $id, name: $name, region: $region, url: $url, created: $created, env_vars: $env_vars)';
  }
