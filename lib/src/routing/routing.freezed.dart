...
class _$_Direction implements _Direction {
  ...
  @override
  String toString() {
    return 'Direction(reference: $reference, distance: $distance, duration: $duration, instruction: $instruction, intersections: $intersections, maneuver: $maneuver, name: $name)';
  }
