...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, translated_name: $translated_name, verses: $verses, id: $id, name: $name, pages: $pages, revelation_place: $revelation_place, arabic_name: $arabic_name, complex_name: $complex_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, key: $key, number: $number, page: $page, translated_text: $translated_text, transliteration: $transliteration, id: $id, text: $text, translations: $translations, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, page: $page, text: $text, position: $position, translation: $translation, transliteration: $transliteration, char_type: $char_type, code: $code, line: $line)';
  }
