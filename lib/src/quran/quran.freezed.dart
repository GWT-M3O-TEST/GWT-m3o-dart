...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, id: $id, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, arabic_name: $arabic_name, pages: $pages, prefix_bismillah: $prefix_bismillah, verses: $verses, name: $name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, key: $key, number: $number, page: $page, transliteration: $transliteration, words: $words, interpretations: $interpretations, text: $text, translated_text: $translated_text, translations: $translations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(transliteration: $transliteration, char_type: $char_type, id: $id, text: $text, translation: $translation, code: $code, line: $line, page: $page, position: $position)';
  }
