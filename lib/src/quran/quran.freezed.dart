...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(verses: $verses, complex_name: $complex_name, id: $id, name: $name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, arabic_name: $arabic_name, pages: $pages)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(text: $text, translated_text: $translated_text, interpretations: $interpretations, key: $key, page: $page, transliteration: $transliteration, words: $words, id: $id, number: $number, translations: $translations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, position: $position, text: $text, translation: $translation, transliteration: $transliteration, char_type: $char_type, line: $line, code: $code, id: $id)';
  }
