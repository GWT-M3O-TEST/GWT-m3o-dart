...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(translated_name: $translated_name, complex_name: $complex_name, id: $id, name: $name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, revelation_place: $revelation_place, arabic_name: $arabic_name, pages: $pages, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(text: $text, transliteration: $transliteration, id: $id, interpretations: $interpretations, key: $key, number: $number, page: $page, translated_text: $translated_text, translations: $translations, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, text: $text, translation: $translation, char_type: $char_type, code: $code, line: $line, id: $id, position: $position, transliteration: $transliteration)';
  }
