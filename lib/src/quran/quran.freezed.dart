...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(pages: $pages, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, name: $name, complex_name: $complex_name, id: $id, prefix_bismillah: $prefix_bismillah, arabic_name: $arabic_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(number: $number, text: $text, transliteration: $transliteration, words: $words, key: $key, interpretations: $interpretations, page: $page, translated_text: $translated_text, translations: $translations, id: $id)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, position: $position, translation: $translation, char_type: $char_type, code: $code, id: $id, line: $line, text: $text, transliteration: $transliteration)';
  }
