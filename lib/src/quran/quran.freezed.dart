...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, translated_name: $translated_name, arabic_name: $arabic_name, name: $name, pages: $pages, verses: $verses, complex_name: $complex_name, id: $id, revelation_place: $revelation_place)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, text: $text, translated_text: $translated_text, translations: $translations, transliteration: $transliteration, words: $words, id: $id, key: $key, number: $number, page: $page)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, page: $page, position: $position, text: $text, translation: $translation, transliteration: $transliteration, char_type: $char_type, code: $code, line: $line)';
  }
