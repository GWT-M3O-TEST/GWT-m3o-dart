...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(name: $name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, verses: $verses, arabic_name: $arabic_name, id: $id, translated_name: $translated_name, complex_name: $complex_name, revelation_order: $revelation_order)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(number: $number, page: $page, text: $text, translated_text: $translated_text, words: $words, id: $id, key: $key, transliteration: $transliteration, interpretations: $interpretations, translations: $translations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, page: $page, text: $text, code: $code, id: $id, line: $line, position: $position, translation: $translation, transliteration: $transliteration)';
  }
