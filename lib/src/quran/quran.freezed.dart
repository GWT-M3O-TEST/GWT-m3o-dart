...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(name: $name, pages: $pages, prefix_bismillah: $prefix_bismillah, translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, revelation_order: $revelation_order, revelation_place: $revelation_place)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(text: $text, translated_text: $translated_text, translations: $translations, transliteration: $transliteration, words: $words, page: $page, interpretations: $interpretations, key: $key, number: $number, id: $id)';
  }
...
class _$_VersesRequest implements _VersesRequest {
  ...
  @override
  String toString() {
    return 'VersesRequest(language: $language, limit: $limit, page: $page, translate: $translate, words: $words, chapter: $chapter, interpret: $interpret)';
  }
...
abstract class _VersesRequest implements VersesRequest {
  const factory _VersesRequest(
      ...
      bool? words,
      int? chapter,
      bool? interpret}) = _$_VersesRequest;
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(code: $code, line: $line, page: $page, position: $position, char_type: $char_type, id: $id, text: $text, translation: $translation, transliteration: $transliteration)';
  }
