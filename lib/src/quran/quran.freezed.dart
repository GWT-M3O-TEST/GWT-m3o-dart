...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, id: $id, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, complex_name: $complex_name, name: $name, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(key: $key, text: $text, translated_text: $translated_text, transliteration: $transliteration, interpretations: $interpretations, number: $number, page: $page, translations: $translations, words: $words, id: $id)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(translation: $translation, text: $text, code: $code, id: $id, line: $line, page: $page, position: $position, transliteration: $transliteration, char_type: $char_type)';
  }
