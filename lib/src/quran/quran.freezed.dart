...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, pages: $pages, revelation_order: $revelation_order, id: $id, name: $name, prefix_bismillah: $prefix_bismillah, arabic_name: $arabic_name, complex_name: $complex_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(key: $key, page: $page, words: $words, transliteration: $transliteration, id: $id, interpretations: $interpretations, number: $number, text: $text, translated_text: $translated_text, translations: $translations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, code: $code, line: $line, page: $page, position: $position, transliteration: $transliteration, id: $id, text: $text, translation: $translation)';
  }
