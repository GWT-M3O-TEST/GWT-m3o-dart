...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(prefix_bismillah: $prefix_bismillah, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, revelation_place: $revelation_place, translated_name: $translated_name, name: $name, pages: $pages, revelation_order: $revelation_order)';
  }
...
abstract class _Chapter implements Chapter {
  const factory _Chapter(
      ...
      String? name,
      List<int>? pages,
      int? revelation_order}) = _$_Chapter;
...
class _$_Result implements _Result {
  const _$_Result(
      {this.translations, this.verse_id, this.verse_key, this.text});
  ...
  @override
  String toString() {
    return 'Result(translations: $translations, verse_id: $verse_id, verse_key: $verse_key, text: $text)';
  }
...
class _$TranslationTearOff {
  ...
  _Translation call({String? source, String? text, int? id}) {
    return _Translation(
      source: source,
      text: text,
      id: id,
...
abstract class $TranslationCopyWith<$Res> {
  ...
  $Res call({String? source, String? text, int? id});
}
...
class _$_Translation implements _Translation {
  const _$_Translation({this.source, this.text, this.id});
  ...
  @override
  String toString() {
    return 'Translation(source: $source, text: $text, id: $id)';
  }
...
abstract class _Translation implements Translation {
  const factory _Translation({String? source, String? text, int? id}) =
      _$_Translation;
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(text: $text, translated_text: $translated_text, transliteration: $transliteration, words: $words, key: $key, number: $number, page: $page, translations: $translations, id: $id, interpretations: $interpretations)';
  }
...
class _$_VersesRequest implements _VersesRequest {
  ...
  @override
  String toString() {
    return 'VersesRequest(limit: $limit, page: $page, translate: $translate, words: $words, chapter: $chapter, interpret: $interpret, language: $language)';
  }
...
abstract class _VersesRequest implements VersesRequest {
  const factory _VersesRequest(
      ...
      int? chapter,
      bool? interpret,
      String? language}) = _$_VersesRequest;
...
class _$VersesResponseTearOff {
  ...
  VersesResponseData call(
      {int? page, int? total_pages, List<Verse>? verses, int? chapter}) {
...
abstract class $VersesResponseDataCopyWith<$Res> {
  ...
  $Res call({int? page, int? total_pages, List<Verse>? verses, int? chapter});
}
...
class _$VersesResponseData implements VersesResponseData {
  const _$VersesResponseData(
      {this.page, this.total_pages, this.verses, this.chapter, String? $type})
      : $type = $type ?? 'default';
  ...
  @override
  String toString() {
    return 'VersesResponse(page: $page, total_pages: $total_pages, verses: $verses, chapter: $chapter)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(page, total_pages, verses, chapter);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(page, total_pages, verses, chapter);
  }
...
abstract class VersesResponseData implements VersesResponse {
  const factory VersesResponseData(
      ...
      int? total_pages,
      List<Verse>? verses,
      int? chapter}) = _$VersesResponseData;
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(line: $line, page: $page, transliteration: $transliteration, char_type: $char_type, code: $code, text: $text, translation: $translation, id: $id, position: $position)';
  }
