...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, id: $id, pages: $pages, revelation_order: $revelation_order, translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, name: $name, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, interpretations: $interpretations, number: $number, page: $page, text: $text, words: $words, id: $id, key: $key, translations: $translations, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(position: $position, code: $code, id: $id, line: $line, translation: $translation, transliteration: $transliteration, char_type: $char_type, page: $page, text: $text)';
  }
