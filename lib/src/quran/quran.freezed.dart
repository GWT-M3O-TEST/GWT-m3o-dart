...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, name: $name, pages: $pages, revelation_order: $revelation_order)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, translations: $translations, transliteration: $transliteration, interpretations: $interpretations, page: $page, text: $text, words: $words, id: $id, key: $key, number: $number)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(text: $text, translation: $translation, transliteration: $transliteration, char_type: $char_type, id: $id, position: $position, code: $code, line: $line, page: $page)';
  }
