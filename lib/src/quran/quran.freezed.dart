...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(id: $id, pages: $pages, revelation_order: $revelation_order, arabic_name: $arabic_name, complex_name: $complex_name, name: $name, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(page: $page, text: $text, translated_text: $translated_text, translations: $translations, id: $id, key: $key, number: $number, transliteration: $transliteration, words: $words, interpretations: $interpretations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(code: $code, translation: $translation, char_type: $char_type, id: $id, line: $line, page: $page, position: $position, text: $text, transliteration: $transliteration)';
  }
