...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(id: $id, pages: $pages, revelation_order: $revelation_order, arabic_name: $arabic_name, complex_name: $complex_name, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, name: $name, prefix_bismillah: $prefix_bismillah)';
  }
...
class _$SearchRequestTearOff {
  ...
  _SearchRequest call(
      {int? page, String? query, String? language, int? limit}) {
...
abstract class $SearchRequestCopyWith<$Res> {
  ...
  $Res call({int? page, String? query, String? language, int? limit});
}
...
class _$_SearchRequest implements _SearchRequest {
  const _$_SearchRequest({this.page, this.query, this.language, this.limit});
  ...
  @override
  String toString() {
    return 'SearchRequest(page: $page, query: $query, language: $language, limit: $limit)';
  }
...
class _$SummaryRequestTearOff {
  ...
  _SummaryRequest call({String? language, int? chapter}) {
...
abstract class $SummaryRequestCopyWith<$Res> {
  ...
  $Res call({String? language, int? chapter});
}
...
class _$_SummaryRequest implements _SummaryRequest {
  const _$_SummaryRequest({this.language, this.chapter});
  ...
  @override
  String toString() {
    return 'SummaryRequest(language: $language, chapter: $chapter)';
  }
...
abstract class _SummaryRequest implements SummaryRequest {
  const factory _SummaryRequest({String? language, int? chapter}) =
      _$_SummaryRequest;
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, key: $key, text: $text, translated_text: $translated_text, translations: $translations, words: $words, interpretations: $interpretations, number: $number, page: $page, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(translation: $translation, transliteration: $transliteration, text: $text, char_type: $char_type, code: $code, id: $id, line: $line, page: $page, position: $position)';
  }
