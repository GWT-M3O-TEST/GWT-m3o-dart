...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(id: $id, name: $name, translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, revelation_place: $revelation_place)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, transliteration: $transliteration, words: $words, interpretations: $interpretations, text: $text, number: $number, page: $page, translations: $translations, id: $id, key: $key)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, page: $page, position: $position, translation: $translation, transliteration: $transliteration, char_type: $char_type, code: $code, line: $line, text: $text)';
  }
