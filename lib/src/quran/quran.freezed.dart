...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, complex_name: $complex_name, id: $id, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, name: $name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, translations: $translations, words: $words, text: $text, interpretations: $interpretations, key: $key, number: $number, page: $page, transliteration: $transliteration, id: $id)';
  }
