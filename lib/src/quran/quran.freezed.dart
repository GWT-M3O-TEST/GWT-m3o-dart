...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, id: $id, pages: $pages, prefix_bismillah: $prefix_bismillah, verses: $verses, arabic_name: $arabic_name, name: $name, revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, key: $key, translated_text: $translated_text, translations: $translations, interpretations: $interpretations, number: $number, page: $page, text: $text, transliteration: $transliteration, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, position: $position, text: $text, transliteration: $transliteration, code: $code, id: $id, line: $line, page: $page, translation: $translation)';
  }
