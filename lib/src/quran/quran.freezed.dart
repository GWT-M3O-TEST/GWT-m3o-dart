...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_order: $revelation_order, revelation_place: $revelation_place, translated_name: $translated_name, pages: $pages, prefix_bismillah: $prefix_bismillah, verses: $verses, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, name: $name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, number: $number, translations: $translations, transliteration: $transliteration, words: $words, id: $id, key: $key, page: $page, text: $text, translated_text: $translated_text)';
  }
...
abstract class _Verse implements Verse {
  const factory _Verse(
      ...
      int? page,
      String? text,
      String? translated_text}) = _$_Verse;
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, position: $position, text: $text, transliteration: $transliteration, line: $line, code: $code, id: $id, translation: $translation, char_type: $char_type)';
  }
