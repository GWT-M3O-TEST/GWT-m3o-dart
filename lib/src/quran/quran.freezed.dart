...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(verses: $verses, pages: $pages, revelation_place: $revelation_place, translated_name: $translated_name, name: $name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, arabic_name: $arabic_name, complex_name: $complex_name, id: $id)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translations: $translations, words: $words, interpretations: $interpretations, number: $number, translated_text: $translated_text, text: $text, transliteration: $transliteration, id: $id, key: $key, page: $page)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, line: $line, page: $page, position: $position, text: $text, char_type: $char_type, code: $code, translation: $translation, transliteration: $transliteration)';
  }
