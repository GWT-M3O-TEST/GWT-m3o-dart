...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(pages: $pages, revelation_place: $revelation_place, verses: $verses, arabic_name: $arabic_name, name: $name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, translated_name: $translated_name, complex_name: $complex_name, id: $id)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, transliteration: $transliteration, words: $words, page: $page, text: $text, translated_text: $translated_text, translations: $translations, id: $id, key: $key, number: $number)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, code: $code, id: $id, page: $page, position: $position, translation: $translation, transliteration: $transliteration, line: $line, text: $text)';
  }
