...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_place: $revelation_place, verses: $verses, arabic_name: $arabic_name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, pages: $pages, translated_name: $translated_name, complex_name: $complex_name, id: $id, name: $name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, page: $page, translations: $translations, words: $words, translated_text: $translated_text, transliteration: $transliteration, interpretations: $interpretations, key: $key, number: $number, text: $text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, id: $id, line: $line, page: $page, translation: $translation, code: $code, position: $position, text: $text, transliteration: $transliteration)';
  }
