...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, name: $name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, arabic_name: $arabic_name, id: $id, pages: $pages, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, code: $code, line: $line, page: $page, position: $position, text: $text, translation: $translation, transliteration: $transliteration, char_type: $char_type)';
  }
