...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, pages: $pages, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, complex_name: $complex_name, id: $id, name: $name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(number: $number, text: $text, translations: $translations, words: $words, translated_text: $translated_text, transliteration: $transliteration, id: $id, interpretations: $interpretations, key: $key, page: $page)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(code: $code, id: $id, line: $line, page: $page, position: $position, translation: $translation, transliteration: $transliteration, char_type: $char_type, text: $text)';
  }
