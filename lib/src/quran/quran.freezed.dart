...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(pages: $pages, prefix_bismillah: $prefix_bismillah, verses: $verses, translated_name: $translated_name, arabic_name: $arabic_name, complex_name: $complex_name, id: $id, name: $name, revelation_order: $revelation_order, revelation_place: $revelation_place)';
  }
...
class _$_Result implements _Result {
  const _$_Result(
      {this.verse_key, this.text, this.translations, this.verse_id});
  ...
  @override
  String toString() {
    return 'Result(verse_key: $verse_key, text: $text, translations: $translations, verse_id: $verse_id)';
  }
...
class _$SummaryResponseData implements SummaryResponseData {
  const _$SummaryResponseData(
      {this.chapter, this.source, this.summary, this.text, String? $type})
      : $type = $type ?? 'default';
...
abstract class SummaryResponseData implements SummaryResponse {
  const factory SummaryResponseData(
      ...
      String? source,
      String? summary,
      String? text}) = _$SummaryResponseData;
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(words: $words, id: $id, page: $page, text: $text, translated_text: $translated_text, translations: $translations, transliteration: $transliteration, interpretations: $interpretations, key: $key, number: $number)';
  }
...
class _$_VersesRequest implements _VersesRequest {
  ...
  @override
  String toString() {
    return 'VersesRequest(interpret: $interpret, language: $language, limit: $limit, page: $page, translate: $translate, words: $words, chapter: $chapter)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, code: $code, text: $text, translation: $translation, id: $id, line: $line, page: $page, position: $position, transliteration: $transliteration)';
  }
