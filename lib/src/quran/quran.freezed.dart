...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_place: $revelation_place, translated_name: $translated_name, arabic_name: $arabic_name, id: $id, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, complex_name: $complex_name, name: $name, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, text: $text, translated_text: $translated_text, translations: $translations, transliteration: $transliteration, id: $id, key: $key, number: $number, page: $page, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, position: $position, transliteration: $transliteration, char_type: $char_type, line: $line, text: $text, translation: $translation, code: $code, id: $id)';
  }
