...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(id: $id, pages: $pages, revelation_place: $revelation_place, translated_name: $translated_name, complex_name: $complex_name, name: $name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, verses: $verses, arabic_name: $arabic_name)';
  }
...
mixin _$SearchResponse {
  @optionalTypeArgs
  TResult when<TResult extends Object?>(
    TResult Function(int? total_results, int? page, String? query,
            List<Result>? results, int? total_pages)
        $default, {
    required TResult Function(Map<String, dynamic>? body) Merr,
  }) =>
      throw _privateConstructorUsedError;
...
class _$SearchResponseData implements SearchResponseData {
  ...
  @override
  String toString() {
    return 'SearchResponse(total_results: $total_results, page: $page, query: $query, results: $results, total_pages: $total_pages)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(total_results, page, query, results, total_pages);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(total_results, page, query, results, total_pages);
  }
...
abstract class SearchResponseData implements SearchResponse {
  const factory SearchResponseData(
      ...
      String? query,
      List<Result>? results,
      int? total_pages}) = _$SearchResponseData;
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(interpretations: $interpretations, number: $number, text: $text, transliteration: $transliteration, id: $id, key: $key, page: $page, translated_text: $translated_text, translations: $translations, words: $words)';
  }
...
class _$VersesResponseTearOff {
  ...
  VersesResponseData call(
      {int? total_pages, List<Verse>? verses, int? chapter, int? page}) {
...
abstract class $VersesResponseDataCopyWith<$Res> {
  ...
  $Res call({int? total_pages, List<Verse>? verses, int? chapter, int? page});
}
...
class _$VersesResponseData implements VersesResponseData {
  const _$VersesResponseData(
      {this.total_pages, this.verses, this.chapter, this.page, String? $type})
      : $type = $type ?? 'default';
  ...
  @override
  String toString() {
    return 'VersesResponse(total_pages: $total_pages, verses: $verses, chapter: $chapter, page: $page)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(total_pages, verses, chapter, page);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(total_pages, verses, chapter, page);
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(text: $text, char_type: $char_type, code: $code, position: $position, translation: $translation, transliteration: $transliteration, id: $id, line: $line, page: $page)';
  }
