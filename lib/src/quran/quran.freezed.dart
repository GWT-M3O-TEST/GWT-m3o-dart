...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(id: $id, name: $name, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, complex_name: $complex_name, pages: $pages, revelation_order: $revelation_order, arabic_name: $arabic_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(id: $id, interpretations: $interpretations, key: $key, number: $number, words: $words, page: $page, text: $text, translated_text: $translated_text, translations: $translations, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(id: $id, line: $line, position: $position, char_type: $char_type, code: $code, page: $page, text: $text, translation: $translation, transliteration: $transliteration)';
  }
