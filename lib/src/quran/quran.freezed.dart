...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, complex_name: $complex_name, id: $id, name: $name, revelation_order: $revelation_order, translated_name: $translated_name, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, verses: $verses)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(number: $number, page: $page, transliteration: $transliteration, words: $words, id: $id, key: $key, translated_text: $translated_text, translations: $translations, interpretations: $interpretations, text: $text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, position: $position, text: $text, translation: $translation, code: $code, id: $id, line: $line, page: $page, transliteration: $transliteration)';
  }
