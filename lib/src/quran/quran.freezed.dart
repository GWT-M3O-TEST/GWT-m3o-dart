...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, name: $name, revelation_place: $revelation_place, verses: $verses, arabic_name: $arabic_name, id: $id, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, translated_name: $translated_name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(key: $key, number: $number, page: $page, text: $text, translated_text: $translated_text, transliteration: $transliteration, id: $id, interpretations: $interpretations, translations: $translations, words: $words)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(text: $text, transliteration: $transliteration, page: $page, position: $position, translation: $translation, char_type: $char_type, code: $code, id: $id, line: $line)';
  }
