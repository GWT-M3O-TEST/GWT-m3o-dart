...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_order: $revelation_order, translated_name: $translated_name, verses: $verses, complex_name: $complex_name, id: $id, pages: $pages, prefix_bismillah: $prefix_bismillah, revelation_place: $revelation_place, arabic_name: $arabic_name, name: $name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(number: $number, page: $page, text: $text, translations: $translations, transliteration: $transliteration, words: $words, interpretations: $interpretations, key: $key, id: $id, translated_text: $translated_text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(line: $line, text: $text, transliteration: $transliteration, code: $code, id: $id, page: $page, position: $position, translation: $translation, char_type: $char_type)';
  }
