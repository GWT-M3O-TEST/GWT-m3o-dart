...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(pages: $pages, revelation_place: $revelation_place, verses: $verses, arabic_name: $arabic_name, id: $id, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, translated_name: $translated_name, complex_name: $complex_name, name: $name)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(text: $text, translated_text: $translated_text, words: $words, id: $id, key: $key, page: $page, transliteration: $transliteration, interpretations: $interpretations, number: $number, translations: $translations)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, text: $text, id: $id, line: $line, position: $position, translation: $translation, transliteration: $transliteration, char_type: $char_type, code: $code)';
  }
