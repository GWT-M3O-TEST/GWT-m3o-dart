...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(arabic_name: $arabic_name, revelation_place: $revelation_place, translated_name: $translated_name, verses: $verses, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, complex_name: $complex_name, id: $id, name: $name, pages: $pages)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(translated_text: $translated_text, translations: $translations, transliteration: $transliteration, id: $id, interpretations: $interpretations, key: $key, words: $words, number: $number, page: $page, text: $text)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(line: $line, page: $page, position: $position, translation: $translation, transliteration: $transliteration, code: $code, id: $id, text: $text, char_type: $char_type)';
  }
