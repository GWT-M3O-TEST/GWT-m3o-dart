...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(complex_name: $complex_name, name: $name, pages: $pages, translated_name: $translated_name, verses: $verses, arabic_name: $arabic_name, prefix_bismillah: $prefix_bismillah, revelation_order: $revelation_order, revelation_place: $revelation_place, id: $id)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(key: $key, text: $text, translated_text: $translated_text, translations: $translations, words: $words, id: $id, interpretations: $interpretations, number: $number, page: $page, transliteration: $transliteration)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(char_type: $char_type, id: $id, line: $line, position: $position, code: $code, page: $page, text: $text, translation: $translation, transliteration: $transliteration)';
  }
