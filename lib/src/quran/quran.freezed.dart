...
class _$_Chapter implements _Chapter {
  ...
  @override
  String toString() {
    return 'Chapter(revelation_place: $revelation_place, verses: $verses, complex_name: $complex_name, id: $id, revelation_order: $revelation_order, prefix_bismillah: $prefix_bismillah, translated_name: $translated_name, arabic_name: $arabic_name, name: $name, pages: $pages)';
  }
...
class _$_Verse implements _Verse {
  ...
  @override
  String toString() {
    return 'Verse(page: $page, text: $text, translations: $translations, interpretations: $interpretations, key: $key, translated_text: $translated_text, transliteration: $transliteration, words: $words, id: $id, number: $number)';
  }
...
class _$_Word implements _Word {
  ...
  @override
  String toString() {
    return 'Word(page: $page, position: $position, translation: $translation, code: $code, line: $line, text: $text, transliteration: $transliteration, char_type: $char_type, id: $id)';
  }
