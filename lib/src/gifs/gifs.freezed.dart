...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, images: $images, rating: $rating, slug: $slug, id: $id, short_url: $short_url, source: $source, title: $title, url: $url)';
  }
...
class _$_ImageFormat implements _ImageFormat {
  ...
  @override
  String toString() {
    return 'ImageFormat(size: $size, url: $url, webp_size: $webp_size, webp_url: $webp_url, width: $width, height: $height, mp4_size: $mp4_size, mp4_url: $mp4_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(original: $original, downsized_large: $downsized_large, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, preview: $preview, downsized_small: $downsized_small, fixed_width_small_still: $fixed_width_small_still, looping: $looping, original_still: $original_still, preview_gif: $preview_gif, downsized: $downsized, downsized_still: $downsized_still, downsized_medium: $downsized_medium, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still)';
  }
