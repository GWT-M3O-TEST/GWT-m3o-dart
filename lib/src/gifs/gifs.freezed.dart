...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, title: $title, images: $images, id: $id, short_url: $short_url, slug: $slug, source: $source, url: $url, embed_url: $embed_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(preview: $preview, preview_gif: $preview_gif, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still, looping: $looping, downsized_large: $downsized_large, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height_small: $fixed_height_small, original: $original, original_still: $original_still, downsized: $downsized, fixed_height: $fixed_height, fixed_width_still: $fixed_width_still, downsized_medium: $downsized_medium, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small)';
  }
