...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, id: $id, rating: $rating, short_url: $short_url, slug: $slug, images: $images, source: $source, title: $title, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_large: $downsized_large, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, looping: $looping, original_still: $original_still, downsized: $downsized, downsized_small: $downsized_small, fixed_height: $fixed_height, fixed_width: $fixed_width, original: $original, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, downsized_medium: $downsized_medium, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, preview: $preview, preview_gif: $preview_gif)';
  }
