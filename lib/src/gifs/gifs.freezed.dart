...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, id: $id, images: $images, rating: $rating, short_url: $short_url, url: $url, slug: $slug, source: $source, title: $title)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_small_still: $fixed_width_small_still, looping: $looping, preview: $preview, fixed_height: $fixed_height, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, preview_gif: $preview_gif, downsized: $downsized, fixed_width_still: $fixed_width_still, original_still: $original_still, fixed_width_small: $fixed_width_small, original: $original, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height_still: $fixed_height_still)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? downsized_large,
      ImageFormat? downsized_medium,
      ImageFormat? fixed_height_still}) = _$_ImageFormats;
