...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(slug: $slug, source: $source, url: $url, images: $images, rating: $rating, short_url: $short_url, title: $title, embed_url: $embed_url, id: $id)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width: $fixed_width, fixed_width_still: $fixed_width_still, downsized: $downsized, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, original_still: $original_still, preview: $preview, fixed_height_small_still: $fixed_height_small_still, fixed_width_small_still: $fixed_width_small_still, looping: $looping, original: $original, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_width_downsampled: $fixed_width_downsampled, preview_gif: $preview_gif)';
  }
