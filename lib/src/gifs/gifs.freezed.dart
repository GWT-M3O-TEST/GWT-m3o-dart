...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, images: $images, rating: $rating, slug: $slug, source: $source, title: $title, url: $url, embed_url: $embed_url, short_url: $short_url)';
  }
...
abstract class _ImageFormat implements ImageFormat {
  const factory _ImageFormat(
      ...
      String? url,
      int? webp_size,
      String? webp_url}) = _$_ImageFormat;
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized: $downsized, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, looping: $looping, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, original: $original, preview_gif: $preview_gif, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_width_small_still: $fixed_width_small_still, original_still: $original_still, preview: $preview)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? fixed_width_small_still,
      ImageFormat? original_still,
      ImageFormat? preview}) = _$_ImageFormats;
