...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, slug: $slug, title: $title, url: $url, id: $id, images: $images, source: $source, embed_url: $embed_url, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, downsized_large: $downsized_large, downsized_medium: $downsized_medium, original_still: $original_still, preview: $preview, preview_gif: $preview_gif, fixed_height_downsampled: $fixed_height_downsampled, looping: $looping, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, original: $original, downsized: $downsized, fixed_height_small_still: $fixed_height_small_still, downsized_small: $downsized_small, downsized_still: $downsized_still)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? fixed_height_small_still,
      ImageFormat? downsized_small,
      ImageFormat? downsized_still}) = _$_ImageFormats;
