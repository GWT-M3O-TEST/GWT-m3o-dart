...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, images: $images, rating: $rating, id: $id, short_url: $short_url, slug: $slug, source: $source, title: $title, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, preview_gif: $preview_gif, downsized: $downsized, fixed_height_small: $fixed_height_small, fixed_width_still: $fixed_width_still, looping: $looping, original_still: $original_still, downsized_medium: $downsized_medium, fixed_height: $fixed_height, fixed_width_downsampled: $fixed_width_downsampled, original: $original, preview: $preview, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? fixed_height_still,
      ImageFormat? fixed_width_small,
      ImageFormat? fixed_width_small_still}) = _$_ImageFormats;
