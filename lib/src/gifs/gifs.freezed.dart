...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(url: $url, embed_url: $embed_url, id: $id, short_url: $short_url, slug: $slug, source: $source, title: $title, images: $images, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, downsized_still: $downsized_still, looping: $looping, preview: $preview, downsized_large: $downsized_large, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, original_still: $original_still, downsized: $downsized, fixed_height: $fixed_height, original: $original, preview_gif: $preview_gif)';
  }
