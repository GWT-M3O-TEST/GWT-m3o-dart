...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, short_url: $short_url, slug: $slug, title: $title, url: $url, embed_url: $embed_url, id: $id, images: $images, source: $source)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized: $downsized, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, fixed_width: $fixed_width, original: $original, downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, downsized_medium: $downsized_medium, fixed_height: $fixed_height, original_still: $original_still, preview_gif: $preview_gif, downsized_still: $downsized_still, fixed_height_small: $fixed_height_small, fixed_width_small_still: $fixed_width_small_still, looping: $looping, preview: $preview)';
  }
