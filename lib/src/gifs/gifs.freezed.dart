...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, slug: $slug, title: $title, id: $id, rating: $rating, source: $source, url: $url, embed_url: $embed_url, images: $images)';
  }
...
class _$_ImageFormat implements _ImageFormat {
  ...
  @override
  String toString() {
    return 'ImageFormat(webp_size: $webp_size, webp_url: $webp_url, width: $width, height: $height, mp4_size: $mp4_size, mp4_url: $mp4_url, size: $size, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized: $downsized, downsized_large: $downsized_large, fixed_height_small_still: $fixed_height_small_still, preview: $preview, preview_gif: $preview_gif, fixed_height: $fixed_height, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, original_still: $original_still, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, looping: $looping, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, original: $original, downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? downsized_small,
      ImageFormat? fixed_width_downsampled,
      ImageFormat? fixed_width_small}) = _$_ImageFormats;
