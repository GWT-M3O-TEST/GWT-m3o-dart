...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, images: $images, rating: $rating, title: $title, embed_url: $embed_url, short_url: $short_url, slug: $slug, source: $source, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized: $downsized, fixed_width_downsampled: $fixed_width_downsampled, original_still: $original_still, preview_gif: $preview_gif, fixed_width: $fixed_width, original: $original, preview: $preview, downsized_large: $downsized_large, downsized_medium: $downsized_medium, downsized_still: $downsized_still, fixed_height_small_still: $fixed_height_small_still, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, looping: $looping, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, downsized_small: $downsized_small, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_small: $fixed_width_small)';
  }
