...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, url: $url, embed_url: $embed_url, id: $id, images: $images, rating: $rating, slug: $slug, source: $source, title: $title)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still, original_still: $original_still, preview: $preview, downsized: $downsized, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, looping: $looping, preview_gif: $preview_gif, downsized_large: $downsized_large, fixed_height_still: $fixed_height_still, original: $original, downsized_small: $downsized_small, fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, fixed_height_small: $fixed_height_small)';
  }
