...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, rating: $rating, short_url: $short_url, source: $source, title: $title, url: $url, embed_url: $embed_url, slug: $slug, images: $images)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_downsampled: $fixed_height_downsampled, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, original: $original, preview_gif: $preview_gif, downsized_medium: $downsized_medium, downsized_still: $downsized_still, fixed_width_still: $fixed_width_still, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, looping: $looping, original_still: $original_still, downsized_small: $downsized_small, fixed_height_small: $fixed_height_small, fixed_width_small_still: $fixed_width_small_still, preview: $preview, downsized: $downsized, downsized_large: $downsized_large)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? preview,
      ImageFormat? downsized,
      ImageFormat? downsized_large}) = _$_ImageFormats;
