...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, original: $original, downsized: $downsized, downsized_large: $downsized_large, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small, original_still: $original_still, preview_gif: $preview_gif, downsized_medium: $downsized_medium, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_width_still: $fixed_width_still, looping: $looping, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, preview: $preview)';
  }
