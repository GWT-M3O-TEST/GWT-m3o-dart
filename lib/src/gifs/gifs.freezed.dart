...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, slug: $slug, source: $source, title: $title, url: $url, id: $id, images: $images, rating: $rating, short_url: $short_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width_downsampled: $fixed_width_downsampled, original_still: $original_still, preview: $preview, downsized_still: $downsized_still, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, original: $original, preview_gif: $preview_gif, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height: $fixed_height, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, downsized: $downsized, fixed_width: $fixed_width, looping: $looping)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? downsized,
      ImageFormat? fixed_width,
      ImageFormat? looping}) = _$_ImageFormats;
