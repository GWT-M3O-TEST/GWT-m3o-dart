...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(url: $url, id: $id, short_url: $short_url, source: $source, title: $title, embed_url: $embed_url, images: $images, rating: $rating, slug: $slug)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, original: $original, preview: $preview, downsized: $downsized, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, looping: $looping, original_still: $original_still, preview_gif: $preview_gif, fixed_height: $fixed_height, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, downsized_still: $downsized_still)';
  }
