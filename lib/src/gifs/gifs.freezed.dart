...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, id: $id, images: $images, rating: $rating, slug: $slug, source: $source, short_url: $short_url, title: $title, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, looping: $looping, downsized: $downsized, downsized_medium: $downsized_medium, downsized_still: $downsized_still, fixed_width_still: $fixed_width_still, preview: $preview, preview_gif: $preview_gif, downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, original_still: $original_still, fixed_width_small_still: $fixed_width_small_still, original: $original)';
  }
