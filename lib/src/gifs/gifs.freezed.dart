...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(slug: $slug, source: $source, id: $id, images: $images, short_url: $short_url, url: $url, embed_url: $embed_url, rating: $rating, title: $title)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(looping: $looping, preview: $preview, preview_gif: $preview_gif, downsized_large: $downsized_large, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_still: $fixed_height_still, original_still: $original_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, original: $original, downsized_medium: $downsized_medium, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_width_small: $fixed_width_small, downsized: $downsized, downsized_small: $downsized_small, fixed_height_small_still: $fixed_height_small_still)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? downsized,
      ImageFormat? downsized_small,
      ImageFormat? fixed_height_small_still}) = _$_ImageFormats;
...
class _$PaginationTearOff {
  ...
  _Pagination call({int? offset, int? total_count, int? count}) {
    return _Pagination(
      offset: offset,
...
abstract class $PaginationCopyWith<$Res> {
  ...
  $Res call({int? offset, int? total_count, int? count});
}
...
class _$_Pagination implements _Pagination {
  const _$_Pagination({this.offset, this.total_count, this.count});
  ...
  @override
  String toString() {
    return 'Pagination(offset: $offset, total_count: $total_count, count: $count)';
  }
...
abstract class _Pagination implements Pagination {
  const factory _Pagination({int? offset, int? total_count, int? count}) =
      _$_Pagination;
...
class _$SearchResponseTearOff {
  ...
  SearchResponseData call({Pagination? pagination, List<Gif>? data}) {
...
mixin _$SearchResponse {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(Pagination? pagination, List<Gif>? data) $default, {
...
abstract class $SearchResponseDataCopyWith<$Res> {
  ...
  $Res call({Pagination? pagination, List<Gif>? data});
...
class _$SearchResponseData implements SearchResponseData {
  const _$SearchResponseData({this.pagination, this.data, String? $type})
      : $type = $type ?? 'default';
  ...
  @override
  String toString() {
    return 'SearchResponse(pagination: $pagination, data: $data)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(pagination, data);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(pagination, data);
  }
...
abstract class SearchResponseData implements SearchResponse {
  const factory SearchResponseData({Pagination? pagination, List<Gif>? data}) =
