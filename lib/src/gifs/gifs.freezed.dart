...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, short_url: $short_url, slug: $slug, source: $source, title: $title, id: $id, images: $images, embed_url: $embed_url, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_height_small_still: $fixed_height_small_still, original_still: $original_still, preview: $preview, downsized: $downsized, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, original: $original, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, downsized_medium: $downsized_medium, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, looping: $looping, preview_gif: $preview_gif)';
  }
