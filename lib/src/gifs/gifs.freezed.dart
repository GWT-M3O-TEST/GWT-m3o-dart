...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, images: $images, slug: $slug, source: $source, url: $url, embed_url: $embed_url, short_url: $short_url, title: $title, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, original_still: $original_still, preview: $preview, preview_gif: $preview_gif, downsized_large: $downsized_large, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, original: $original, downsized: $downsized, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, looping: $looping)';
  }
