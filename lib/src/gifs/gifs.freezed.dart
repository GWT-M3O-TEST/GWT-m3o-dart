...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(title: $title, url: $url, embed_url: $embed_url, id: $id, rating: $rating, short_url: $short_url, slug: $slug, images: $images, source: $source)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(original: $original, downsized: $downsized, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, fixed_height: $fixed_height, fixed_width_small: $fixed_width_small, preview_gif: $preview_gif, fixed_height_downsampled: $fixed_height_downsampled, looping: $looping, original_still: $original_still, preview: $preview, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still)';
  }
