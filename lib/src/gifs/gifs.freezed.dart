...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, source: $source, title: $title, url: $url, embed_url: $embed_url, id: $id, images: $images, rating: $rating, slug: $slug)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_large: $downsized_large, fixed_width_downsampled: $fixed_width_downsampled, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_width_still: $fixed_width_still, original_still: $original_still, downsized_small: $downsized_small, fixed_height: $fixed_height, fixed_width: $fixed_width, preview_gif: $preview_gif, downsized_still: $downsized_still, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, looping: $looping, original: $original, preview: $preview, downsized: $downsized, downsized_medium: $downsized_medium)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? preview,
      ImageFormat? downsized,
      ImageFormat? downsized_medium}) = _$_ImageFormats;
