...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, images: $images, slug: $slug, source: $source, url: $url, embed_url: $embed_url, rating: $rating, short_url: $short_url, title: $title)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_still: $fixed_height_still, preview_gif: $preview_gif, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, downsized_large: $downsized_large, downsized_medium: $downsized_medium, downsized_small: $downsized_small, original: $original, preview: $preview, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, looping: $looping, downsized: $downsized, fixed_height_downsampled: $fixed_height_downsampled, original_still: $original_still, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small)';
  }
