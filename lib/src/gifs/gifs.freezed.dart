...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, images: $images, source: $source, embed_url: $embed_url, rating: $rating, short_url: $short_url, slug: $slug, title: $title, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_width_downsampled: $fixed_width_downsampled, looping: $looping, preview: $preview, downsized_large: $downsized_large, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_still: $fixed_width_still, downsized_still: $downsized_still, fixed_height_small: $fixed_height_small, fixed_width_small: $fixed_width_small, original: $original, original_still: $original_still, downsized: $downsized, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, preview_gif: $preview_gif, fixed_height_downsampled: $fixed_height_downsampled)';
  }
