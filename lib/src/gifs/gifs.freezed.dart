...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(title: $title, url: $url, images: $images, rating: $rating, short_url: $short_url, slug: $slug, source: $source, embed_url: $embed_url, id: $id)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_still: $fixed_height_still, original_still: $original_still, preview: $preview, preview_gif: $preview_gif, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, downsized: $downsized, downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, looping: $looping, original: $original, downsized_large: $downsized_large, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, downsized_still: $downsized_still)';
  }
