...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, rating: $rating, url: $url, title: $title, embed_url: $embed_url, images: $images, short_url: $short_url, slug: $slug, source: $source)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(looping: $looping, preview_gif: $preview_gif, downsized_large: $downsized_large, fixed_height: $fixed_height, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, downsized_medium: $downsized_medium, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height_small: $fixed_height_small, downsized: $downsized, fixed_height_downsampled: $fixed_height_downsampled, original: $original, original_still: $original_still, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, preview: $preview)';
  }
