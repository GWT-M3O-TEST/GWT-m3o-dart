...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, short_url: $short_url, slug: $slug, source: $source, title: $title, embed_url: $embed_url, id: $id, images: $images, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small_still: $fixed_width_small_still, preview: $preview, downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width_still: $fixed_width_still, original: $original, preview_gif: $preview_gif, downsized: $downsized, downsized_still: $downsized_still, fixed_height_small_still: $fixed_height_small_still, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, original_still: $original_still, downsized_medium: $downsized_medium, fixed_width_small: $fixed_width_small, looping: $looping)';
  }
