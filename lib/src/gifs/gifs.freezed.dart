...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, id: $id, slug: $slug, url: $url, images: $images, rating: $rating, short_url: $short_url, source: $source, title: $title)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_small: $fixed_height_small, original_still: $original_still, preview_gif: $preview_gif, downsized_still: $downsized_still, fixed_height: $fixed_height, downsized_small: $downsized_small, fixed_width: $fixed_width, fixed_width_small: $fixed_width_small, looping: $looping, downsized: $downsized, downsized_large: $downsized_large, fixed_width_still: $fixed_width_still, original: $original, fixed_height_small_still: $fixed_height_small_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, preview: $preview, downsized_medium: $downsized_medium, fixed_height_downsampled: $fixed_height_downsampled)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? preview,
      ImageFormat? downsized_medium,
      ImageFormat? fixed_height_downsampled}) = _$_ImageFormats;
