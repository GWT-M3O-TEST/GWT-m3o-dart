...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(source: $source, embed_url: $embed_url, id: $id, images: $images, rating: $rating, slug: $slug, short_url: $short_url, title: $title, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(preview: $preview, fixed_height_still: $fixed_height_still, looping: $looping, fixed_height_small: $fixed_height_small, fixed_width_still: $fixed_width_still, original: $original, downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_height: $fixed_height, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, original_still: $original_still, preview_gif: $preview_gif, downsized: $downsized, fixed_height_downsampled: $fixed_height_downsampled)';
  }
