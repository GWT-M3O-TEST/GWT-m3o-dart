...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(url: $url, embed_url: $embed_url, rating: $rating, source: $source, title: $title, id: $id, images: $images, short_url: $short_url, slug: $slug)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(looping: $looping, preview: $preview, preview_gif: $preview_gif, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, original_still: $original_still, downsized: $downsized, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height_still: $fixed_height_still, original: $original, fixed_height_downsampled: $fixed_height_downsampled, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, downsized_small: $downsized_small, fixed_height_small: $fixed_height_small, fixed_width_small_still: $fixed_width_small_still)';
  }
