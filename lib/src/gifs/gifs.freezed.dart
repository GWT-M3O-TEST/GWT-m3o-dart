...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, images: $images, rating: $rating, slug: $slug, source: $source, embed_url: $embed_url, short_url: $short_url, title: $title, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_large: $downsized_large, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_width_small: $fixed_width_small, downsized_medium: $downsized_medium, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, looping: $looping, original: $original, downsized: $downsized, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, original_still: $original_still, preview: $preview, preview_gif: $preview_gif, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still)';
  }
