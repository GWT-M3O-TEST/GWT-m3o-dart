...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(images: $images, slug: $slug, title: $title, embed_url: $embed_url, rating: $rating, short_url: $short_url, source: $source, url: $url, id: $id)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_width_small: $fixed_width_small, preview_gif: $preview_gif, fixed_height: $fixed_height, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, original: $original, original_still: $original_still, downsized_large: $downsized_large, fixed_height_small: $fixed_height_small, fixed_width: $fixed_width, looping: $looping, downsized: $downsized, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, preview: $preview)';
  }
