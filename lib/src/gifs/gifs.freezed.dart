...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, short_url: $short_url, slug: $slug, source: $source, title: $title, url: $url, embed_url: $embed_url, images: $images, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width_small_still: $fixed_width_small_still, looping: $looping, downsized: $downsized, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, preview: $preview, original: $original, original_still: $original_still, preview_gif: $preview_gif, downsized_medium: $downsized_medium, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_still: $fixed_width_still)';
  }
