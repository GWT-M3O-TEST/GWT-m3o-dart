...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(source: $source, title: $title, url: $url, embed_url: $embed_url, id: $id, images: $images, rating: $rating, short_url: $short_url, slug: $slug)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, preview_gif: $preview_gif, downsized_medium: $downsized_medium, original_still: $original_still, fixed_width_small: $fixed_width_small, downsized_large: $downsized_large, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_width_downsampled: $fixed_width_downsampled, original: $original, downsized: $downsized, downsized_still: $downsized_still, looping: $looping, preview: $preview, downsized_small: $downsized_small)';
  }
