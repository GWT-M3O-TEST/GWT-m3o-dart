...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, short_url: $short_url, slug: $slug, title: $title, embed_url: $embed_url, images: $images, rating: $rating, source: $source, url: $url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_small: $downsized_small, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, downsized: $downsized, downsized_medium: $downsized_medium, fixed_height_small: $fixed_height_small, original_still: $original_still, preview: $preview, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, looping: $looping, downsized_large: $downsized_large, downsized_still: $downsized_still, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, original: $original, preview_gif: $preview_gif)';
  }
