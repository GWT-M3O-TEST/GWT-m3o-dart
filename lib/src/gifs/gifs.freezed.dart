...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(short_url: $short_url, slug: $slug, source: $source, title: $title, url: $url, id: $id, images: $images, embed_url: $embed_url, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized: $downsized, downsized_small: $downsized_small, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, preview: $preview, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, looping: $looping, original_still: $original_still, preview_gif: $preview_gif, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, original: $original)';
  }
