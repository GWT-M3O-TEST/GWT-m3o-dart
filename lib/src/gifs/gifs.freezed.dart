...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(images: $images, rating: $rating, short_url: $short_url, source: $source, url: $url, embed_url: $embed_url, id: $id, slug: $slug, title: $title)';
  }
...
class _$_ImageFormat implements _ImageFormat {
  ...
  @override
  String toString() {
    return 'ImageFormat(mp4_size: $mp4_size, mp4_url: $mp4_url, size: $size, url: $url, webp_size: $webp_size, webp_url: $webp_url, width: $width, height: $height)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, downsized: $downsized, downsized_still: $downsized_still, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width_small_still: $fixed_width_small_still, preview_gif: $preview_gif, downsized_large: $downsized_large, fixed_width_small: $fixed_width_small, looping: $looping, original: $original, original_still: $original_still, preview: $preview, fixed_height_small_still: $fixed_height_small_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, fixed_width: $fixed_width)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? fixed_width_downsampled,
      ImageFormat? fixed_width_still,
      ImageFormat? fixed_width}) = _$_ImageFormats;
