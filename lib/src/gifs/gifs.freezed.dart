...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, slug: $slug, url: $url, title: $title, id: $id, images: $images, rating: $rating, short_url: $short_url, source: $source)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_downsampled: $fixed_height_downsampled, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, looping: $looping, downsized_medium: $downsized_medium, downsized_still: $downsized_still, fixed_height: $fixed_height, preview: $preview, preview_gif: $preview_gif, downsized_large: $downsized_large, fixed_height_still: $fixed_height_still, original_still: $original_still, fixed_height_small_still: $fixed_height_small_still, original: $original, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, downsized: $downsized, downsized_small: $downsized_small, fixed_height_small: $fixed_height_small)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? downsized,
      ImageFormat? downsized_small,
      ImageFormat? fixed_height_small}) = _$_ImageFormats;
