...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, url: $url, id: $id, images: $images, rating: $rating, short_url: $short_url, slug: $slug, source: $source, title: $title)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_medium: $downsized_medium, original: $original, original_still: $original_still, preview: $preview, preview_gif: $preview_gif, downsized_small: $downsized_small, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, looping: $looping, downsized: $downsized, downsized_large: $downsized_large, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, fixed_width_small_still: $fixed_width_small_still)';
  }
