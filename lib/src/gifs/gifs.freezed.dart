...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(rating: $rating, short_url: $short_url, source: $source, url: $url, embed_url: $embed_url, id: $id, title: $title, images: $images, slug: $slug)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized_large: $downsized_large, original: $original, downsized: $downsized, downsized_medium: $downsized_medium, fixed_width_small_still: $fixed_width_small_still, looping: $looping, preview: $preview, preview_gif: $preview_gif, downsized_small: $downsized_small, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_small: $fixed_width_small, fixed_width_still: $fixed_width_still, downsized_still: $downsized_still, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, original_still: $original_still)';
  }
