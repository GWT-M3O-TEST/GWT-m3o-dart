...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, rating: $rating, slug: $slug, source: $source, url: $url, embed_url: $embed_url, images: $images, short_url: $short_url, title: $title)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, original: $original, looping: $looping, downsized_medium: $downsized_medium, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, downsized_still: $downsized_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_width: $fixed_width, preview_gif: $preview_gif, preview: $preview, downsized: $downsized, downsized_large: $downsized_large, downsized_small: $downsized_small, fixed_width_downsampled: $fixed_width_downsampled, original_still: $original_still)';
  }
