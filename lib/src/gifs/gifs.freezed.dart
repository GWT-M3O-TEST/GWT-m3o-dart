...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(embed_url: $embed_url, images: $images, short_url: $short_url, title: $title, url: $url, id: $id, rating: $rating, slug: $slug, source: $source)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_height_still: $fixed_height_still, fixed_width_still: $fixed_width_still, original: $original, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, downsized: $downsized, downsized_large: $downsized_large, downsized_medium: $downsized_medium, downsized_small: $downsized_small, fixed_height: $fixed_height, fixed_height_small: $fixed_height_small, looping: $looping, downsized_still: $downsized_still, fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, original_still: $original_still, preview: $preview, preview_gif: $preview_gif)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? original_still,
      ImageFormat? preview,
      ImageFormat? preview_gif}) = _$_ImageFormats;
