...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(slug: $slug, title: $title, source: $source, url: $url, embed_url: $embed_url, id: $id, images: $images, rating: $rating, short_url: $short_url)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(fixed_width: $fixed_width, fixed_width_downsampled: $fixed_width_downsampled, downsized_large: $downsized_large, downsized_medium: $downsized_medium, downsized_still: $downsized_still, original_still: $original_still, preview: $preview, downsized: $downsized, downsized_small: $downsized_small, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width_small: $fixed_width_small, preview_gif: $preview_gif, fixed_height: $fixed_height, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_width_small_still: $fixed_width_small_still, fixed_width_still: $fixed_width_still, looping: $looping, original: $original)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? fixed_width_still,
      ImageFormat? looping,
      ImageFormat? original}) = _$_ImageFormats;
