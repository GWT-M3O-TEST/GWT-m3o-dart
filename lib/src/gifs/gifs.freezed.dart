...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(preview_gif: $preview_gif, downsized: $downsized, fixed_width_small: $fixed_width_small, fixed_height_small: $fixed_height_small, fixed_height_still: $fixed_height_still, fixed_width: $fixed_width, preview: $preview, downsized_large: $downsized_large, downsized_small: $downsized_small, original_still: $original_still, downsized_medium: $downsized_medium, fixed_width_small_still: $fixed_width_small_still, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small_still: $fixed_height_small_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, looping: $looping, original: $original, downsized_still: $downsized_still, fixed_height: $fixed_height)';
  }
...
abstract class _ImageFormats implements ImageFormats {
  const factory _ImageFormats(
      ...
      ImageFormat? original,
      ImageFormat? downsized_still,
      ImageFormat? fixed_height}) = _$_ImageFormats;
