...
class _$_Gif implements _Gif {
  ...
  @override
  String toString() {
    return 'Gif(id: $id, images: $images, short_url: $short_url, slug: $slug, url: $url, embed_url: $embed_url, source: $source, title: $title, rating: $rating)';
  }
...
class _$_ImageFormats implements _ImageFormats {
  ...
  @override
  String toString() {
    return 'ImageFormats(downsized: $downsized, fixed_height_downsampled: $fixed_height_downsampled, fixed_height_small: $fixed_height_small, fixed_height_small_still: $fixed_height_small_still, fixed_width: $fixed_width, fixed_height: $fixed_height, fixed_width_small: $fixed_width_small, fixed_width_small_still: $fixed_width_small_still, downsized_large: $downsized_large, downsized_medium: $downsized_medium, fixed_height_still: $fixed_height_still, fixed_width_downsampled: $fixed_width_downsampled, fixed_width_still: $fixed_width_still, original_still: $original_still, preview: $preview, preview_gif: $preview_gif, downsized_small: $downsized_small, downsized_still: $downsized_still, looping: $looping, original: $original)';
  }
