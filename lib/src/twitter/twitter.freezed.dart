...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, location: $location, private: $private, verified: $verified, created_at: $created_at, followers: $followers, id: $id, image_url: $image_url, name: $name, username: $username)';
  }
