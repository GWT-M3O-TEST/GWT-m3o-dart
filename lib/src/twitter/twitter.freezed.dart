...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(verified: $verified, description: $description, followers: $followers, id: $id, location: $location, name: $name, username: $username, created_at: $created_at, image_url: $image_url, private: $private)';
  }
