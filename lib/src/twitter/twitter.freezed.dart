...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, id: $id, image_url: $image_url, location: $location, created_at: $created_at, name: $name, private: $private, username: $username, verified: $verified)';
  }
