...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, description: $description, followers: $followers, id: $id, username: $username, verified: $verified, image_url: $image_url, location: $location, name: $name, private: $private)';
  }
