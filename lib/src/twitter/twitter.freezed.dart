...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(location: $location, name: $name, verified: $verified, followers: $followers, id: $id, image_url: $image_url, private: $private, username: $username, created_at: $created_at, description: $description)';
  }
