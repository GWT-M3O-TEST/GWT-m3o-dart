...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(name: $name, username: $username, id: $id, description: $description, followers: $followers, image_url: $image_url, location: $location, private: $private, verified: $verified, created_at: $created_at)';
  }
