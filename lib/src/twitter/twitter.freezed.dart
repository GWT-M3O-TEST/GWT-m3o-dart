...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(verified: $verified, created_at: $created_at, followers: $followers, id: $id, image_url: $image_url, location: $location, private: $private, description: $description, name: $name, username: $username)';
  }
