...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, id: $id, image_url: $image_url, name: $name, private: $private, username: $username, created_at: $created_at, description: $description, location: $location, verified: $verified)';
  }
