...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(image_url: $image_url, name: $name, username: $username, verified: $verified, followers: $followers, description: $description, id: $id, location: $location, private: $private, created_at: $created_at)';
  }
