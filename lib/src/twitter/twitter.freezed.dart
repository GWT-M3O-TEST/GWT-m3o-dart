...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, image_url: $image_url, username: $username, created_at: $created_at, followers: $followers, name: $name, private: $private, verified: $verified, description: $description, location: $location)';
  }
