...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, id: $id, verified: $verified, location: $location, name: $name, private: $private, username: $username, created_at: $created_at, followers: $followers, image_url: $image_url)';
  }
