...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, image_url: $image_url, username: $username, verified: $verified, created_at: $created_at, id: $id, location: $location, name: $name, private: $private)';
  }
