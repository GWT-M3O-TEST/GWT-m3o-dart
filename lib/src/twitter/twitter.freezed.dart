...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, image_url: $image_url, name: $name, private: $private, verified: $verified, created_at: $created_at, description: $description, followers: $followers, location: $location, username: $username)';
  }
