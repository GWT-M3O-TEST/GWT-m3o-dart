...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, location: $location, name: $name, private: $private, verified: $verified, created_at: $created_at, id: $id, image_url: $image_url, username: $username)';
  }
