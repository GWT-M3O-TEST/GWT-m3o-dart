...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, id: $id, username: $username, verified: $verified, created_at: $created_at, image_url: $image_url, location: $location, name: $name, private: $private)';
  }
