...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, name: $name, image_url: $image_url, location: $location, private: $private, username: $username, verified: $verified, created_at: $created_at, description: $description, id: $id)';
  }
