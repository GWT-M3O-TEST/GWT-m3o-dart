...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(image_url: $image_url, location: $location, username: $username, verified: $verified, created_at: $created_at, description: $description, followers: $followers, id: $id, name: $name, private: $private)';
  }
