...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, name: $name, private: $private, username: $username, verified: $verified, created_at: $created_at, description: $description, id: $id, image_url: $image_url, location: $location)';
  }
