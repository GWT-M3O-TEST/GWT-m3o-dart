...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(location: $location, name: $name, username: $username, verified: $verified, created_at: $created_at, description: $description, followers: $followers, id: $id, image_url: $image_url, private: $private)';
  }
