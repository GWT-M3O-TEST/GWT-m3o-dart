...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, description: $description, location: $location, name: $name, verified: $verified, followers: $followers, id: $id, image_url: $image_url, private: $private, username: $username)';
  }
