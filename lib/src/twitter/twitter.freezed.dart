...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(private: $private, username: $username, description: $description, image_url: $image_url, location: $location, name: $name, created_at: $created_at, followers: $followers, id: $id, verified: $verified)';
  }
