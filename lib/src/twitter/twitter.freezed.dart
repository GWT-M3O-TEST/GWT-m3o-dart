...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, name: $name, verified: $verified, created_at: $created_at, followers: $followers, id: $id, image_url: $image_url, location: $location, private: $private, username: $username)';
  }
