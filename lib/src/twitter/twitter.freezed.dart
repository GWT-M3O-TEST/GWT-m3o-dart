...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, id: $id, name: $name, username: $username, created_at: $created_at, description: $description, image_url: $image_url, location: $location, private: $private, verified: $verified)';
  }
