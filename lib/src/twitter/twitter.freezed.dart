...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, id: $id, image_url: $image_url, verified: $verified, created_at: $created_at, followers: $followers, location: $location, name: $name, private: $private, username: $username)';
  }
