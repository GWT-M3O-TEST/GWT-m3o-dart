...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(name: $name, username: $username, verified: $verified, created_at: $created_at, description: $description, followers: $followers, location: $location, id: $id, image_url: $image_url, private: $private)';
  }
