...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, description: $description, id: $id, location: $location, name: $name, private: $private, followers: $followers, image_url: $image_url, username: $username, verified: $verified)';
  }
