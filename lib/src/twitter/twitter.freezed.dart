...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, location: $location, name: $name, private: $private, created_at: $created_at, image_url: $image_url, username: $username, verified: $verified, id: $id)';
  }
