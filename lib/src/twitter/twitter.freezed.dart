...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, id: $id, name: $name, verified: $verified, description: $description, followers: $followers, image_url: $image_url, location: $location, private: $private, username: $username)';
  }
