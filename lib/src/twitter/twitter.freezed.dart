...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(location: $location, name: $name, private: $private, username: $username, created_at: $created_at, id: $id, image_url: $image_url, description: $description, followers: $followers, verified: $verified)';
  }
