...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(location: $location, private: $private, description: $description, id: $id, image_url: $image_url, name: $name, username: $username, verified: $verified, created_at: $created_at, followers: $followers)';
  }
...
class _$_Tweet implements _Tweet {
  ...
  @override
  String toString() {
    return 'Tweet(favourited_count: $favourited_count, id: $id, retweeted_count: $retweeted_count, text: $text, username: $username, created_at: $created_at)';
  }
