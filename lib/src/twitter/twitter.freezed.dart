...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, followers: $followers, location: $location, name: $name, username: $username, verified: $verified, description: $description, id: $id, image_url: $image_url, private: $private)';
  }
