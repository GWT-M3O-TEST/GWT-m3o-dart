...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, id: $id, image_url: $image_url, location: $location, username: $username, verified: $verified, created_at: $created_at, private: $private, name: $name)';
  }
