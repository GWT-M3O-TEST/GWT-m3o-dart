...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(username: $username, description: $description, image_url: $image_url, location: $location, private: $private, verified: $verified, created_at: $created_at, followers: $followers, id: $id, name: $name)';
  }
