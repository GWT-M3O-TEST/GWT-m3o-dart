...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(username: $username, created_at: $created_at, description: $description, followers: $followers, image_url: $image_url, location: $location, name: $name, private: $private, id: $id, verified: $verified)';
  }
