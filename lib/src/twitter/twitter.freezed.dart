...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, name: $name, username: $username, created_at: $created_at, id: $id, image_url: $image_url, location: $location, private: $private, verified: $verified)';
  }
