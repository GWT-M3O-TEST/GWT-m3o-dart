...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(image_url: $image_url, private: $private, verified: $verified, created_at: $created_at, description: $description, followers: $followers, id: $id, location: $location, name: $name, username: $username)';
  }
