...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, id: $id, username: $username, location: $location, name: $name, private: $private, verified: $verified, created_at: $created_at, description: $description, image_url: $image_url)';
  }
