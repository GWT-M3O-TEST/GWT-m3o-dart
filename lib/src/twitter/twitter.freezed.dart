...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(created_at: $created_at, description: $description, image_url: $image_url, location: $location, name: $name, followers: $followers, id: $id, private: $private, username: $username, verified: $verified)';
  }
