...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, location: $location, name: $name, description: $description, followers: $followers, private: $private, username: $username, verified: $verified, created_at: $created_at, image_url: $image_url)';
  }
