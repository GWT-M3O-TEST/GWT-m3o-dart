...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(description: $description, followers: $followers, image_url: $image_url, name: $name, private: $private, username: $username, created_at: $created_at, location: $location, verified: $verified, id: $id)';
  }
