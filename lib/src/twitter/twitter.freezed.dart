...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(username: $username, verified: $verified, followers: $followers, id: $id, location: $location, private: $private, created_at: $created_at, description: $description, image_url: $image_url, name: $name)';
  }
