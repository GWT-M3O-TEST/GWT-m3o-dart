...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(followers: $followers, id: $id, location: $location, name: $name, verified: $verified, created_at: $created_at, description: $description, username: $username, image_url: $image_url, private: $private)';
  }
