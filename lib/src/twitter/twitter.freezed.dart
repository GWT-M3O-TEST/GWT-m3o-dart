...
class _$_Profile implements _Profile {
  ...
  @override
  String toString() {
    return 'Profile(id: $id, verified: $verified, name: $name, private: $private, username: $username, created_at: $created_at, description: $description, followers: $followers, image_url: $image_url, location: $location)';
  }
