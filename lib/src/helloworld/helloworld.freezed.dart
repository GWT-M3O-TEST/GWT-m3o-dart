...
class _$StreamRequestTearOff {
  ...
  _StreamRequest call({String? name, int? messages}) {
...
abstract class $StreamRequestCopyWith<$Res> {
  ...
  $Res call({String? name, int? messages});
}
...
class _$_StreamRequest implements _StreamRequest {
  const _$_StreamRequest({this.name, this.messages});
...
abstract class _StreamRequest implements StreamRequest {
  const factory _StreamRequest({String? name, int? messages}) =
      _$_StreamRequest;
