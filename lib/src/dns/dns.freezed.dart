...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(AD: $AD, CD: $CD, RA: $RA, question: $question, status: $status, RD: $RD, TC: $TC, answer: $answer, provider: $provider)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(AD, CD, RA, question, status, RD, TC, answer, provider);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        AD, CD, RA, question, status, RD, TC, answer, provider);
  }
