...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(AD: $AD, CD: $CD, RA: $RA, TC: $TC, provider: $provider, question: $question, status: $status, RD: $RD, answer: $answer)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(AD, CD, RA, TC, provider, question, status, RD, answer);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        AD, CD, RA, TC, provider, question, status, RD, answer);
  }
