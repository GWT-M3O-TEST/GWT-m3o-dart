...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(RD: $RD, TC: $TC, provider: $provider, AD: $AD, CD: $CD, RA: $RA, answer: $answer, question: $question, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(RD, TC, provider, AD, CD, RA, answer, question, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        RD, TC, provider, AD, CD, RA, answer, question, status);
  }
