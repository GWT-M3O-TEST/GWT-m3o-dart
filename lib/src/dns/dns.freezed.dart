...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(question: $question, status: $status, TC: $TC, CD: $CD, RA: $RA, RD: $RD, answer: $answer, provider: $provider, AD: $AD)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(question, status, TC, CD, RA, RD, answer, provider, AD);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        question, status, TC, CD, RA, RD, answer, provider, AD);
  }
