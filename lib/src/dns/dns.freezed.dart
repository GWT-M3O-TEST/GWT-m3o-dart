...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(CD: $CD, RA: $RA, status: $status, AD: $AD, RD: $RD, TC: $TC, answer: $answer, provider: $provider, question: $question)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(CD, RA, status, AD, RD, TC, answer, provider, question);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        CD, RA, status, AD, RD, TC, answer, provider, question);
  }
