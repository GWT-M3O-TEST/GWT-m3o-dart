...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(CD: $CD, RD: $RD, question: $question, status: $status, AD: $AD, RA: $RA, TC: $TC, answer: $answer, provider: $provider)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(CD, RD, question, status, AD, RA, TC, answer, provider);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        CD, RD, question, status, AD, RA, TC, answer, provider);
  }
