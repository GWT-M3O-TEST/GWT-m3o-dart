...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(AD: $AD, CD: $CD, TC: $TC, question: $question, RA: $RA, RD: $RD, answer: $answer, provider: $provider, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(AD, CD, TC, question, RA, RD, answer, provider, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        AD, CD, TC, question, RA, RD, answer, provider, status);
  }
