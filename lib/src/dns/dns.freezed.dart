...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(AD: $AD, RA: $RA, TC: $TC, answer: $answer, provider: $provider, question: $question, CD: $CD, RD: $RD, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(AD, RA, TC, answer, provider, question, CD, RD, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        AD, RA, TC, answer, provider, question, CD, RD, status);
  }
