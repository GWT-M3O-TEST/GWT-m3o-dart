...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(CD: $CD, RA: $RA, RD: $RD, TC: $TC, answer: $answer, provider: $provider, status: $status, AD: $AD, question: $question)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(CD, RA, RD, TC, answer, provider, status, AD, question);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        CD, RA, RD, TC, answer, provider, status, AD, question);
  }
