...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(AD: $AD, CD: $CD, RD: $RD, answer: $answer, provider: $provider, RA: $RA, TC: $TC, question: $question, status: $status)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(AD, CD, RD, answer, provider, RA, TC, question, status);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        AD, CD, RD, answer, provider, RA, TC, question, status);
  }
