...
class _$QueryResponseData implements QueryResponseData {
  ...
  @override
  String toString() {
    return 'QueryResponse(question: $question, CD: $CD, RA: $RA, RD: $RD, TC: $TC, answer: $answer, provider: $provider, status: $status, AD: $AD)';
  }
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(question, CD, RA, RD, TC, answer, provider, status, AD);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(
        question, CD, RA, RD, TC, answer, provider, status, AD);
  }
