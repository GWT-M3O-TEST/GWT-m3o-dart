...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, categories: $categories, language: $language, image_url: $image_url, keywords: $keywords, published_at: $published_at, snippet: $snippet, source: $source, title: $title, description: $description, id: $id, url: $url)';
  }
