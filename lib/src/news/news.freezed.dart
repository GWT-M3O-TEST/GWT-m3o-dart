...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, id: $id, language: $language, title: $title, snippet: $snippet, source: $source, url: $url, description: $description, image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at)';
  }
