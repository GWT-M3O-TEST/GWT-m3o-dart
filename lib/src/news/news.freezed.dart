...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, image_url: $image_url, language: $language, title: $title, categories: $categories, keywords: $keywords, locale: $locale, published_at: $published_at, snippet: $snippet, source: $source, url: $url, description: $description)';
  }
