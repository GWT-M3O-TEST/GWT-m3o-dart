...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, id: $id, keywords: $keywords, snippet: $snippet, source: $source, title: $title, image_url: $image_url, language: $language, locale: $locale, published_at: $published_at, url: $url)';
  }
