...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, published_at: $published_at, snippet: $snippet, title: $title, url: $url, image_url: $image_url, keywords: $keywords, id: $id, language: $language, source: $source, categories: $categories, description: $description)';
  }
