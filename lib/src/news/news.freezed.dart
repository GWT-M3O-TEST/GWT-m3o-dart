...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, published_at: $published_at, source: $source, description: $description, id: $id, image_url: $image_url, language: $language, url: $url, categories: $categories, keywords: $keywords, snippet: $snippet, title: $title)';
  }
