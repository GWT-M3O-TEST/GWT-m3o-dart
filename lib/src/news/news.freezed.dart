...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, source: $source, url: $url, categories: $categories, id: $id, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, title: $title, description: $description, keywords: $keywords)';
  }
