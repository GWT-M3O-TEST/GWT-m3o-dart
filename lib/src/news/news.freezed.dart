...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, language: $language, locale: $locale, source: $source, description: $description, image_url: $image_url, published_at: $published_at, snippet: $snippet, title: $title, url: $url, categories: $categories, id: $id)';
  }
