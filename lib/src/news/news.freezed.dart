...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, image_url: $image_url, source: $source, url: $url, categories: $categories, id: $id, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, title: $title)';
  }
