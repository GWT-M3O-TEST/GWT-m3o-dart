...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, description: $description, id: $id, image_url: $image_url, keywords: $keywords, language: $language, source: $source, categories: $categories, locale: $locale, published_at: $published_at, snippet: $snippet, title: $title)';
  }
