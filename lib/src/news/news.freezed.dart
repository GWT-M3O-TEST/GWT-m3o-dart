...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, published_at: $published_at, snippet: $snippet, source: $source, locale: $locale, title: $title, url: $url, description: $description, id: $id, image_url: $image_url, keywords: $keywords, language: $language)';
  }
