...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, source: $source, description: $description, id: $id, keywords: $keywords, language: $language, title: $title, url: $url, categories: $categories, image_url: $image_url, locale: $locale, published_at: $published_at)';
  }
