...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, image_url: $image_url, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, url: $url, categories: $categories, description: $description, id: $id, keywords: $keywords, title: $title)';
  }
