...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, keywords: $keywords, language: $language, snippet: $snippet, url: $url, source: $source, title: $title, categories: $categories, id: $id, image_url: $image_url, locale: $locale, published_at: $published_at)';
  }
