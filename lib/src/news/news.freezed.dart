...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, title: $title, image_url: $image_url, description: $description, id: $id, keywords: $keywords, source: $source, url: $url, categories: $categories)';
  }
