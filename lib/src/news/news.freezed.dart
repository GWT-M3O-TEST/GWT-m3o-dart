...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, url: $url, categories: $categories, description: $description, id: $id, image_url: $image_url, snippet: $snippet, source: $source, title: $title)';
  }
