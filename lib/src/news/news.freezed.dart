...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, language: $language, published_at: $published_at, source: $source, title: $title, categories: $categories, description: $description, id: $id, url: $url, keywords: $keywords, locale: $locale, snippet: $snippet)';
  }
