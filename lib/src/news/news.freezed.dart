...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, id: $id, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, categories: $categories, source: $source, title: $title, url: $url, snippet: $snippet)';
  }
