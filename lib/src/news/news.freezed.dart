...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, title: $title, description: $description, id: $id, image_url: $image_url, url: $url, categories: $categories, keywords: $keywords, source: $source)';
  }
