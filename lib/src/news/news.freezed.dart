...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(published_at: $published_at, source: $source, title: $title, url: $url, categories: $categories, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, snippet: $snippet, description: $description, id: $id)';
  }
