...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, url: $url, categories: $categories, keywords: $keywords, language: $language, published_at: $published_at, snippet: $snippet, title: $title, description: $description, id: $id, image_url: $image_url, locale: $locale)';
  }
