...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, description: $description, language: $language, locale: $locale, url: $url, source: $source, title: $title, id: $id, image_url: $image_url, keywords: $keywords, published_at: $published_at, snippet: $snippet)';
  }
