...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, categories: $categories, id: $id, published_at: $published_at, language: $language, locale: $locale, snippet: $snippet, source: $source, url: $url, description: $description, image_url: $image_url, keywords: $keywords)';
  }
