...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, categories: $categories, image_url: $image_url, keywords: $keywords, language: $language, published_at: $published_at, url: $url, description: $description, id: $id, locale: $locale, source: $source, title: $title)';
  }
