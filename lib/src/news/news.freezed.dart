...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, snippet: $snippet, source: $source, url: $url, categories: $categories, description: $description, id: $id, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, title: $title)';
  }
