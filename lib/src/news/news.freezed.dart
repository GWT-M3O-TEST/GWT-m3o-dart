...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, language: $language, published_at: $published_at, snippet: $snippet, url: $url, description: $description, id: $id, locale: $locale, source: $source, title: $title, categories: $categories, keywords: $keywords)';
  }
