...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, source: $source, title: $title, categories: $categories, id: $id, snippet: $snippet, url: $url, description: $description, published_at: $published_at)';
  }
