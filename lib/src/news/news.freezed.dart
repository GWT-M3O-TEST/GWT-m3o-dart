...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, source: $source, categories: $categories, description: $description, id: $id, language: $language, title: $title, url: $url, image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at)';
  }
