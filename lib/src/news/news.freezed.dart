...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, language: $language, published_at: $published_at, snippet: $snippet, source: $source, description: $description, id: $id, image_url: $image_url, keywords: $keywords, locale: $locale, title: $title, url: $url)';
  }
