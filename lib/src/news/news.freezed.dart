...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, description: $description, id: $id, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, source: $source, categories: $categories, title: $title, url: $url)';
  }
