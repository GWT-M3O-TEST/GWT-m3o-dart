...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, published_at: $published_at, id: $id, image_url: $image_url, keywords: $keywords, snippet: $snippet, source: $source, title: $title, url: $url, categories: $categories, description: $description, locale: $locale)';
  }
