...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, id: $id, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, title: $title, categories: $categories, description: $description, image_url: $image_url, source: $source)';
  }
