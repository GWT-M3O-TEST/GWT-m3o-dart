...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, published_at: $published_at, snippet: $snippet, source: $source, title: $title, url: $url, categories: $categories, description: $description, id: $id, image_url: $image_url, keywords: $keywords, language: $language)';
  }
