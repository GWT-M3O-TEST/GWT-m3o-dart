...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, url: $url, description: $description, id: $id, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, categories: $categories, image_url: $image_url, snippet: $snippet, title: $title)';
  }
