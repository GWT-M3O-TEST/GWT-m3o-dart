...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, url: $url, description: $description, locale: $locale, published_at: $published_at, source: $source, language: $language, snippet: $snippet, categories: $categories, id: $id, image_url: $image_url, keywords: $keywords)';
  }
