...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(snippet: $snippet, source: $source, image_url: $image_url, locale: $locale, id: $id, keywords: $keywords, language: $language, published_at: $published_at, title: $title, url: $url, categories: $categories, description: $description)';
  }
