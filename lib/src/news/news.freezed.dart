...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, id: $id, image_url: $image_url, locale: $locale, url: $url, description: $description, keywords: $keywords, language: $language, published_at: $published_at, snippet: $snippet, source: $source, title: $title)';
  }
