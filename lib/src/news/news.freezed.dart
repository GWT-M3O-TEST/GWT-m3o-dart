...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(id: $id, image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at, snippet: $snippet, source: $source, categories: $categories, description: $description, language: $language, title: $title, url: $url)';
  }
