...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(url: $url, id: $id, image_url: $image_url, keywords: $keywords, snippet: $snippet, source: $source, title: $title, categories: $categories, description: $description, language: $language, locale: $locale, published_at: $published_at)';
  }
