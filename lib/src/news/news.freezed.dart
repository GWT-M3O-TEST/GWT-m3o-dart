...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(title: $title, url: $url, categories: $categories, description: $description, id: $id, language: $language, published_at: $published_at, source: $source, image_url: $image_url, keywords: $keywords, locale: $locale, snippet: $snippet)';
  }
