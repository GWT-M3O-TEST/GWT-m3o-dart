...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(locale: $locale, published_at: $published_at, snippet: $snippet, source: $source, url: $url, description: $description, id: $id, keywords: $keywords, language: $language, title: $title, categories: $categories, image_url: $image_url)';
  }
