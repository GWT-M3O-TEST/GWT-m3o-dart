...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(source: $source, url: $url, image_url: $image_url, keywords: $keywords, locale: $locale, published_at: $published_at, snippet: $snippet, title: $title, categories: $categories, description: $description, id: $id, language: $language)';
  }
