...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(published_at: $published_at, snippet: $snippet, image_url: $image_url, language: $language, locale: $locale, keywords: $keywords, source: $source, title: $title, url: $url, categories: $categories, description: $description, id: $id)';
  }
