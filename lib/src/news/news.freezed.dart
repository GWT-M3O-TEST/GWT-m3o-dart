...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(categories: $categories, id: $id, image_url: $image_url, keywords: $keywords, language: $language, locale: $locale, published_at: $published_at, snippet: $snippet, source: $source, title: $title, description: $description, url: $url)';
  }
