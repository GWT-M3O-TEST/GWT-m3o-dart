...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(description: $description, id: $id, locale: $locale, snippet: $snippet, source: $source, title: $title, url: $url, categories: $categories, image_url: $image_url, keywords: $keywords, language: $language, published_at: $published_at)';
  }
...
abstract class _Article implements Article {
  const factory _Article(
      ...
      String? keywords,
      String? language,
      String? published_at}) = _$_Article;
