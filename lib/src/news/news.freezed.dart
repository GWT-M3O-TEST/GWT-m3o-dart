...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(keywords: $keywords, language: $language, locale: $locale, snippet: $snippet, title: $title, url: $url, categories: $categories, description: $description, id: $id, image_url: $image_url, published_at: $published_at, source: $source)';
  }
