...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(language: $language, locale: $locale, snippet: $snippet, url: $url, title: $title, categories: $categories, description: $description, id: $id, image_url: $image_url, keywords: $keywords, published_at: $published_at, source: $source)';
  }
