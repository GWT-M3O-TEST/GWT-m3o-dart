...
class _$_Article implements _Article {
  ...
  @override
  String toString() {
    return 'Article(published_at: $published_at, source: $source, categories: $categories, description: $description, id: $id, keywords: $keywords, locale: $locale, image_url: $image_url, language: $language, snippet: $snippet, title: $title, url: $url)';
  }
