...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(open_now: $open_now, type: $type, vicinity: $vicinity, address: $address, location: $location, name: $name, opening_hours: $opening_hours, rating: $rating, types: $types, icon_url: $icon_url)';
  }
