...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(vicinity: $vicinity, address: $address, icon_url: $icon_url, name: $name, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, location: $location, type: $type, types: $types)';
  }
