...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(rating: $rating, type: $type, types: $types, vicinity: $vicinity, address: $address, icon_url: $icon_url, name: $name, location: $location, open_now: $open_now, opening_hours: $opening_hours)';
  }
