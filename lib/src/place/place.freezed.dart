...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, location: $location, name: $name, open_now: $open_now, rating: $rating, icon_url: $icon_url, opening_hours: $opening_hours, type: $type, types: $types, vicinity: $vicinity)';
  }
