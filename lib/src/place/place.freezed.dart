...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(name: $name, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, types: $types, vicinity: $vicinity, address: $address, icon_url: $icon_url, location: $location, type: $type)';
  }
