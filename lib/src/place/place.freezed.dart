...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(icon_url: $icon_url, opening_hours: $opening_hours, name: $name, open_now: $open_now, rating: $rating, type: $type, types: $types, vicinity: $vicinity, address: $address, location: $location)';
  }
