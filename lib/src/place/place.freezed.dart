...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(location: $location, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, type: $type, vicinity: $vicinity, address: $address, icon_url: $icon_url, name: $name, types: $types)';
  }
