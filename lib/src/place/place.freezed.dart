...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, opening_hours: $opening_hours, vicinity: $vicinity, icon_url: $icon_url, location: $location, name: $name, open_now: $open_now, rating: $rating, type: $type, types: $types)';
  }
