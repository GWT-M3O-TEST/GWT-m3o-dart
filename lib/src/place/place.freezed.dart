...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(type: $type, types: $types, address: $address, icon_url: $icon_url, name: $name, open_now: $open_now, location: $location, opening_hours: $opening_hours, rating: $rating, vicinity: $vicinity)';
  }
