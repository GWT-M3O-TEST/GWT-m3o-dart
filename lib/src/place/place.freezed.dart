...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(location: $location, name: $name, opening_hours: $opening_hours, rating: $rating, type: $type, types: $types, address: $address, icon_url: $icon_url, open_now: $open_now, vicinity: $vicinity)';
  }
