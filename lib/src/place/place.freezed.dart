...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(open_now: $open_now, opening_hours: $opening_hours, rating: $rating, type: $type, types: $types, vicinity: $vicinity, address: $address, location: $location, name: $name, icon_url: $icon_url)';
  }
