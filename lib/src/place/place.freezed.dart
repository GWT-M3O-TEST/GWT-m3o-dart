...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(vicinity: $vicinity, address: $address, opening_hours: $opening_hours, rating: $rating, type: $type, types: $types, icon_url: $icon_url, location: $location, name: $name, open_now: $open_now)';
  }
