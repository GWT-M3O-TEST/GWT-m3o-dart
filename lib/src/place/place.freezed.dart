...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(icon_url: $icon_url, name: $name, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, types: $types, vicinity: $vicinity, address: $address, location: $location, type: $type)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      String? type,
      String? location,
      bool? open_now}) = _$_SearchRequest;
