...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(vicinity: $vicinity, location: $location, opening_hours: $opening_hours, types: $types, open_now: $open_now, rating: $rating, type: $type, address: $address, icon_url: $icon_url, name: $name)';
  }
