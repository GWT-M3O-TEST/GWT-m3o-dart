...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, rating: $rating, type: $type, types: $types, icon_url: $icon_url, location: $location, name: $name, open_now: $open_now, opening_hours: $opening_hours, vicinity: $vicinity)';
  }
