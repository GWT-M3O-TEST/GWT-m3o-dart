...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(vicinity: $vicinity, location: $location, name: $name, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, type: $type, types: $types, address: $address, icon_url: $icon_url)';
  }
