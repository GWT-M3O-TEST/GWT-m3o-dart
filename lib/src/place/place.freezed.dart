...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, types: $types, address: $address, icon_url: $icon_url, location: $location, open_now: $open_now, name: $name, rating: $rating, type: $type, vicinity: $vicinity)';
  }
