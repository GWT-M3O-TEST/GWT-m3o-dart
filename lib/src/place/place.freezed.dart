...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, location: $location, vicinity: $vicinity, type: $type, types: $types, icon_url: $icon_url, name: $name, open_now: $open_now, opening_hours: $opening_hours, rating: $rating)';
  }
