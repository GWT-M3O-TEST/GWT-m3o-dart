...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(icon_url: $icon_url, rating: $rating, type: $type, types: $types, address: $address, location: $location, name: $name, open_now: $open_now, opening_hours: $opening_hours, vicinity: $vicinity)';
  }
