...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, location: $location, name: $name, open_now: $open_now, type: $type, icon_url: $icon_url, opening_hours: $opening_hours, rating: $rating, types: $types, vicinity: $vicinity)';
  }
