...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, location: $location, rating: $rating, type: $type, types: $types, icon_url: $icon_url, name: $name, open_now: $open_now, opening_hours: $opening_hours, vicinity: $vicinity)';
  }
