...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(type: $type, types: $types, vicinity: $vicinity, address: $address, name: $name, open_now: $open_now, opening_hours: $opening_hours, rating: $rating, icon_url: $icon_url, location: $location)';
  }
