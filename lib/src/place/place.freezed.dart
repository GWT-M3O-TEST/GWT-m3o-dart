...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(types: $types, address: $address, location: $location, open_now: $open_now, rating: $rating, type: $type, icon_url: $icon_url, name: $name, opening_hours: $opening_hours, vicinity: $vicinity)';
  }
