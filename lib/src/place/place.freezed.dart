...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, rating: $rating, type: $type, address: $address, icon_url: $icon_url, location: $location, name: $name, open_now: $open_now, vicinity: $vicinity, types: $types)';
  }
