...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, type: $type, types: $types, vicinity: $vicinity, address: $address, icon_url: $icon_url, name: $name, open_now: $open_now, location: $location, rating: $rating)';
  }
