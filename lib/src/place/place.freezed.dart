...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(name: $name, opening_hours: $opening_hours, type: $type, location: $location, icon_url: $icon_url, open_now: $open_now, rating: $rating, types: $types, vicinity: $vicinity, address: $address)';
  }
