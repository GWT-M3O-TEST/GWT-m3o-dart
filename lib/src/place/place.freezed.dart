...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, open_now: $open_now, icon_url: $icon_url, location: $location, name: $name, rating: $rating, type: $type, types: $types, vicinity: $vicinity, address: $address)';
  }
...
class _$_SearchRequest implements _SearchRequest {
  const _$_SearchRequest(
      {this.open_now, this.query, this.radius, this.type, this.location});
  ...
  @override
  String toString() {
    return 'SearchRequest(open_now: $open_now, query: $query, radius: $radius, type: $type, location: $location)';
  }
...
abstract class _SearchRequest implements SearchRequest {
  const factory _SearchRequest(
      ...
      int? radius,
      String? type,
      String? location}) = _$_SearchRequest;
