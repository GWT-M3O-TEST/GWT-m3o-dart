...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, icon_url: $icon_url, location: $location, name: $name, rating: $rating, type: $type, types: $types, open_now: $open_now, opening_hours: $opening_hours, vicinity: $vicinity)';
  }
