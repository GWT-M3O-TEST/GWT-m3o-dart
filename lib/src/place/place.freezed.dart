...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, icon_url: $icon_url, location: $location, name: $name, open_now: $open_now, rating: $rating, types: $types, vicinity: $vicinity, opening_hours: $opening_hours, type: $type)';
  }
