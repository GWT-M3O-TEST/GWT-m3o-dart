...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, open_now: $open_now, opening_hours: $opening_hours, type: $type, vicinity: $vicinity, icon_url: $icon_url, location: $location, name: $name, rating: $rating, types: $types)';
  }
