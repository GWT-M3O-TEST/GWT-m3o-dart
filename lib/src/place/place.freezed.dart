...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(name: $name, opening_hours: $opening_hours, rating: $rating, types: $types, vicinity: $vicinity, address: $address, icon_url: $icon_url, location: $location, open_now: $open_now, type: $type)';
  }
