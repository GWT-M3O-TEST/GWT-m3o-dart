...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, type: $type, types: $types, vicinity: $vicinity, icon_url: $icon_url, location: $location, open_now: $open_now, address: $address, name: $name, rating: $rating)';
  }
