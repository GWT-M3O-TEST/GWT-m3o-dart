...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(type: $type, vicinity: $vicinity, address: $address, icon_url: $icon_url, name: $name, opening_hours: $opening_hours, rating: $rating, location: $location, open_now: $open_now, types: $types)';
  }
