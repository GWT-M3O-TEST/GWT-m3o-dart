...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(opening_hours: $opening_hours, rating: $rating, types: $types, icon_url: $icon_url, location: $location, open_now: $open_now, vicinity: $vicinity, address: $address, name: $name, type: $type)';
  }
