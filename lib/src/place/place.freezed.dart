...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(types: $types, address: $address, icon_url: $icon_url, location: $location, rating: $rating, vicinity: $vicinity, name: $name, open_now: $open_now, opening_hours: $opening_hours, type: $type)';
  }
