...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(name: $name, open_now: $open_now, rating: $rating, type: $type, vicinity: $vicinity, address: $address, icon_url: $icon_url, location: $location, opening_hours: $opening_hours, types: $types)';
  }
