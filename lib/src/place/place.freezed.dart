...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(address: $address, icon_url: $icon_url, location: $location, opening_hours: $opening_hours, rating: $rating, type: $type, types: $types, name: $name, open_now: $open_now, vicinity: $vicinity)';
  }
