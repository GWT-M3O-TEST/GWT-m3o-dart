...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(rating: $rating, types: $types, vicinity: $vicinity, address: $address, name: $name, open_now: $open_now, opening_hours: $opening_hours, icon_url: $icon_url, location: $location, type: $type)';
  }
