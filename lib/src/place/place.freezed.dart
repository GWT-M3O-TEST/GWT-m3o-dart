...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(rating: $rating, types: $types, icon_url: $icon_url, name: $name, open_now: $open_now, opening_hours: $opening_hours, address: $address, location: $location, type: $type, vicinity: $vicinity)';
  }
